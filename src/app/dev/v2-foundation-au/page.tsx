...
/**
 * /dev/v2-foundation-au — AU locale showcase.
 *
 * Mirrors the GB showcase at /dev/v2-foundation but renders every v2
 * component with Australian demo data: Sydney city references, AUD
 * pricing (prefixed `A$` to disambiguate from USD), Australian Bureau of
 * Statistics attribution, "Local Sydney Agency" comparator.
 *
 ...
 *
 * Note on currency: locale.json stores `currencySymbol: "$"` (correct for
 * in-locale display in Australia). This showcase prefixes prices with "A"
 * (`A$2K`) for international disambiguation from USD, and uses
 * Australian-conventional K-suffix notation to fit the PricingTiers
 * component's fixed-width price display (filed for M1.d.4.1 / M1.d.5 prep).
 *
...
const locale = resolveLocale('au');

export default function V2FoundationAUPage() {
  return (
    <main className="min-h-screen bg-fj-cream">
      ...
      <div className="mx-auto max-w-[1120px] px-4 pb-8 pt-12 lg:px-6">
        ...
        >
          Same component set as the GB and US showcases, rendering with
          Australian locale data. Prices are prefixed `A$` to disambiguate
          AUD from USD in this side-by-side context.
        </p>
      </div>
      ...
      <BigThreeTrustBlock
        ...
        headline="Results that Sydney businesses trust."
        cityCount={{ value: '320K+', label: 'active businesses in Sydney', source: 'ABS Business Counts' }}
      />
      ...
      <CityContextSection
        ...
        leadParagraphs={[
          "With 5.5 million people and A$528bn in metro GDP, Sydney is one of the planet's most demanding markets.",
          'Buyers in the CBD and the North Sydney financial corridor make snap judgements based on digital presence.',
        ]}
        stats={[
          {
            value: '5.5m',
            label: 'Sydney population (demo)',
            sourceUrl: 'https://www.abs.gov.au/statistics/people/population',
          },
          {
            value: 'A$528bn',
            label: 'Sydney metro GDP (demo)',
            sourceUrl: 'https://www.abs.gov.au/statistics/economy',
          },
          {
            value: 'A$25bn',
            label: 'Sydney tourism revenue (demo)',
      ...
      <FAQ
        ...
        items={[
          ...
          },
          {
            ...
            answer:
              'A$2K–A$20K depending on scope. We tell you on the first call. No proposal-tag, no surprise add-ons.',
          },
          {
      ...
      <PricingTiers
        ...
        lead="Sydney agency rates run two to three times higher for the same scope. Our pricing is the price."
        tiers={[
          {
            name: 'Starter',
            priceRange: 'A$2K–A$4K',
            description:
        ...
        sectors={[
          {
            ...
            description:
              "Sites that signal regulatory credibility before a prospect picks up the phone. Compliance-aware copy, secure forms, and AI-search visibility for high-value clients in Sydney's CBD financial district.",
          },
          {
          ...
          },
          {
            ...
            description:
              'Built in Next.js, the framework your prospects already use. Sub-second loads, clean code, the technical standard the Barangaroo and North Sydney tech corridors expect from their vendors.',
          },
          {
        ...
        rows={[
          {
            ...
            values: ['A$X–A$Y (TODO)', 'A$8K+ avg', 'A$X–A$Y (TODO)'],
          },
          {
            feature: 'Turnaround',
      ...
      <ServiceExplanation
        ...
        lead="Sydney's CBD financial services sector decides whether to engage you in the first 1.5 seconds of looking at your homepage."
        body={
          <>
            <p>
        ...
        rightSlot={
          <div className="rounded-2xl border border-fj-neutral-200 bg-fj-neutral-50 p-8">
            ...
            <p className="mt-3 font-fj-body text-[0.9375rem] leading-[1.55] text-fj-neutral-600">
              people. A$528bn metro GDP.
            </p>
            <p className="mt-3 font-fj-body text-[0.8125rem] text-fj-neutral-400">
              (Buyers in the CBD judge sites in seconds.)
            </p>
          </div>
        }
      />
