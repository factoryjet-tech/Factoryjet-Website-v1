...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: 'https://factoryjet.com/us/best-ecommerce-platforms',
  ...
  alternates: { canonical: 'https://factoryjet.com/us/best-ecommerce-platforms' },
...
const BREADCRUMB_SCHEMA = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 2, name: 'Best Ecommerce Platforms', item: 'https://factoryjet.com/us/best-ecommerce-platforms' },
  ],
};
        ...
        <section className="pp-sec tint" id="cta">
          <div className="pp-wrap">
            ...
            <div style={{ marginTop: '32px', paddingTop: '24px', borderTop: '1px solid var(--pp-line)', fontSize: '13px', color: 'var(--pp-muted)' }}>
              ...
              {[
                { label: 'BigCommerce development', href: '/us/bigcommerce-development' },
                { label: 'B2B ecommerce', href: '/us/b2b-ecommerce' },
                { label: 'Omnichannel commerce', href: '/us/omnichannel-commerce' },
                { label: 'Headless commerce', href: '/us/headless-commerce' },
                { label: 'Ecommerce consulting', href: '/us/ecommerce-consulting' },
              ].map((l, i) => (
                <span key={l.href}>
