    ...
    <>
      ...
      <main className="bg-fj-cream">
        ...
        <ComparisonTable
          ...
          lead={"Cleveland's local agency market includes Agency Creative, Tiller Digital, and even accounting firms like Skoda Minotti that offer web services. None publish a 7-day delivery commitment or a complete public price list. FactoryJet Growth ($3,999) delivers 10–15 pages, blog CMS, lead capture, GA4, and Next.js — at a fixed, published price for the same scope, with a guaranteed timeline and a codebase you own outright."}
