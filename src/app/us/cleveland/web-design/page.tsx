        ...
        <FAQ
          ...
          items={[
            ...
            },
            {
              ...
              "answer": "Branded searches (your business name) usually rank within one to two weeks of launch. Service plus location queries like 'web design Cleveland' typically take three to six months for a new domain. The work that compresses this timeline — schema, internal linking, content depth, technical performance — is built into every FactoryJet project, not sold as an add-on after launch."
            },
            {
              "question": "We're a vendor or supplier in the Cleveland Clinic ecosystem — can you build HIPAA-aware B2B websites for healthcare?",
              "answer": "Yes. Healthcare is one of our most common client profiles in Cleveland. Cleveland Clinic is the world's #2 hospital, and the vendors, suppliers, and professional services firms in its ecosystem need sites that communicate technical depth, compliance awareness, and verifiable case study evidence to institutional procurement buyers. We build sites structured for those longer B2B due-diligence cycles — with lead-capture flows designed to route inquiries to the right person fast."
            },
            {
              "question": "We supply Parker Hannifin, Eaton, or other Cleveland manufacturers — what does a manufacturing B2B website need?",
              "answer": "Manufacturing B2B sites need to communicate engineering credibility, production certifications (ISO, AS9100, etc.), capabilities, and case studies to procurement managers who evaluate multiple suppliers simultaneously. We build sites structured around your capabilities and certifications — not generic marketing copy — with downloadable spec sheets, inquiry forms, and content architecture that answers procurement questions before the RFQ stage."
            },
            {
              "question": "I run a law firm in Cleveland — what do I need from a website?",
              "answer": "Law firm sites in Cleveland need clear practice area pages, attorney bios with credentials, case result summaries (where permitted by Ohio bar rules), and a lead-capture flow that routes inquiries to the right attorney by practice area. We also handle local SEO targeting Cleveland's legal search queries — which are highly competitive and highly valuable. Schema markup for law firms is included in every project."
            },
            {
              "question": "I own a restaurant or bar near West Side Market or East 4th Street — what does a good website need?",
              "answer": "For Cleveland's food and beverage scene, the essentials are: a fast-loading mobile menu, a reservation or waitlist integration (OpenTable, Resy, or custom flow), event calendar support for live entertainment nights, and Google Maps / Apple Maps schema so you show up correctly in local search. We also build private dining or buyout inquiry forms, which drive significant additional revenue for venues that don't surface them properly."
            },
            {
              "question": "I'm in real estate or development in Ohio City, Tremont, or Detroit Shoreway — what do I need from a site?",
              "answer": "Cleveland's real estate boom in Ohio City, Tremont, and Detroit Shoreway has created a highly competitive online market. Real estate and development sites need project portfolio galleries, neighborhood-specific landing pages, lead-capture forms that route inquiries immediately, and local SEO targeting Cleveland's high-demand submarkets. For developers, a project pipeline page with renderings and status updates can significantly reduce inbound inquiry load on your team."
            },
            {
              "question": "We're in financial services — KeyBank or Progressive Insurance ecosystem vendors. What does our website need?",
              "answer": "Financial services and insurance ecosystem firms need sites that project credibility to sophisticated corporate buyers — with clear service pages, team credentials, case study structures, and compliance-aware messaging. We also build lead-capture flows optimized for longer B2B sales cycles, where the goal is a booked call rather than an immediate transaction. GA4 is wired up from day one so you know which pages are converting."
            },
            {
              "question": "We're a tech startup based in University Circle or MidTown Cleveland. What do we need from a launch website?",
              "answer": "Tech startup sites need to communicate product differentiation quickly, build credibility with investors and early customers, and generate either inbound leads or user signups. We build with Next.js for maximum performance, include structured data for AI search crawlers, and design conversion flows around your specific acquisition goal — whether that's a demo request, a waitlist signup, or a direct trial conversion."
            },
            {
              "question": "How does FactoryJet compare to Cleveland agencies like Agency Creative or Tiller Digital?",
              "answer": "Agency Creative and Tiller Digital are established Cleveland shops. Neither publishes pricing or a delivery timeline publicly. FactoryJet publishes all three tiers upfront, guarantees 7-day delivery in writing, and builds in Next.js rather than WordPress — which means faster load times and no ongoing plugin maintenance costs for your team. You can compare our scope and price against any Cleveland agency before you speak to us."
            },
            {
              "question": "What about Skoda Minotti — they offer web services as part of accounting?",
              "answer": "Skoda Minotti is a respected Cleveland accounting and advisory firm. Web services are a side offering for them. FactoryJet is a dedicated web design and development team — web is our entire focus, not something bolted onto another service line. That focus means faster delivery, deeper technical expertise, and a support structure built specifically for web projects."
            },
            {
            ...
            {
              "question": "What tech stack do you build on, and why does it matter for my Cleveland business?",
              "answer": "We build on Next.js deployed to Cloudflare Pages, with a headless CMS for content editing. Next.js produces static pages that load significantly faster than WordPress — typically under 1.5 seconds on mobile — which directly affects Google rankings and visitor bounce rates. For Cleveland businesses competing on local search in high-value sectors like healthcare and manufacturing, that performance gap over a WordPress competitor is a real and measurable advantage."
            },
            {
              "question": "Can you add e-commerce to a Cleveland business website?",
              "answer": "Yes. Whether you need a simple product catalog with Stripe checkout, a full Shopify integration, or a custom e-commerce build, we handle it at the Custom tier ($7,500+). Cleveland retail businesses — particularly in Ohio City, Tremont, and the broader Greater Cleveland area — frequently need both a physical store presence and an online sales channel in one site. We architect that so it doesn't feel bolted on."
            },
            {
              "question": "Can you build a Shopify store for a Cleveland retail or DTC brand?",
              "answer": "Yes. Shopify builds for Cleveland retail and DTC brands are part of our standard service offering. We handle theme customization, product migration, payment setup, shipping configuration, and local SEO for Shopify stores. For brands that need both a Shopify storefront and a content-heavy marketing site, we build both and connect them cleanly."
            },
            {
              "question": "What AI features can you add to a Cleveland business website?",
              "answer": "Common AI integrations include site-search powered by vector embeddings, AI chat assistants trained on your services and FAQs, and AI-assisted content tools for blog or product descriptions. These are typically part of Custom tier projects. For Cleveland's healthcare IT vendors and manufacturing B2B firms, AI-assisted knowledge bases and spec-search tools are particularly strong fits for complex technical products."
            },
            {
              "question": "How does my site perform on mobile? Cleveland visitors search on their phones constantly.",
            ...
            {
              "question": "How does Cleveland local SEO work and what do you include?",
            ...
            },
            {
              ...
              "answer": "GA4 is Google's current analytics platform — it replaced Universal Analytics in 2023 and tracks who visits your site, which pages they read, and whether they fill out your contact form. Every FactoryJet project includes GA4 wired up before launch, with the key conversion events already configured. You get a plain-English walkthrough in the handover session so you know what you're looking at without needing to be a data analyst."
            },
            {
              "question": "What hosting does FactoryJet use and is it included?",
              "answer": "We deploy to Cloudflare Pages, which provides enterprise-grade CDN performance at no monthly cost for most projects. Cloudflare's global edge network means your Cleveland site loads fast whether your visitor is in Ohio City, Columbus, Chicago, or anywhere else in the US. Hosting setup, DNS configuration, and SSL are included in every project — there is no separate hosting invoice at launch."
            }
          ]}
        />
        <FinalCTA
