...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: 'https://factoryjet.com/us/tampa/ecommerce-development',
    images: [
      {
  ...
  alternates: {
    canonical: 'https://factoryjet.com/us/tampa/ecommerce-development',
          ...
          rows={[
            {
              ...
              values: [
                '$7,500–$20,000 (brand strategy + marketing focus, not Shopify specialists)',
        ...
        <FAQ
          ...
          items={[
            ...
            },
            {
              ...
              answer:
                'Shopify stores start at $2,999 at FactoryJet — compared to $7,500–$20,000 at established Tampa agencies. WooCommerce stores start at $3,499, and custom headless e-commerce builds start at $5,999. Every project includes custom design, full development, Florida sales tax configuration (7.5% for Tampa/Hillsborough County), product catalog setup, mobile-first responsive design, and 30 days of post-launch support. No hidden fees, no Phase 2 upsells.',
            },
            {
              category: 'pricing',
            ...
            },
            {
              ...
              answer: "Yes — FactoryJet offers post-launch support built around Tampa Bay's seasonal commerce calendar. Every build includes a 30-day support window. Ongoing options: monthly retainer from $299/month (4 hours development, same-day bug priority), seasonal campaign builds (Gasparilla Pirate Festival merchandise in January, Super Bowl fan merchandise when Tampa hosts, Stanley Cup playoff gear), and quarterly performance reviews. Tampa Bay sports brands in particular need on-call support — a Lightning playoff run or a Buccaneers Super Bowl creates instant merchandise demand spikes that require same-day inventory and promotional updates. FactoryJet retainer clients get priority response for championship moments and high-traffic events.",
            },
          ]}
        />
