...
const CANONICAL = 'https://factoryjet.com/us/tampa/seo';

export const metadata: Metadata = {
  title: 'Tampa SEO Company | Local SEO Services in Tampa, FL | FactoryJet',
  description:
    'FactoryJet is a Tampa SEO company that gets local businesses into the Google Map Pack and "near me" results. Local SEO from $499/month, month-to-month, free audit. Built by senior engineers.',
  alternates: { canonical: CANONICAL },
  openGraph: {
    title: 'Tampa SEO Company | Local SEO Services in Tampa, FL | FactoryJet',
    description:
      'Tampa SEO company that gets you into the Google Map Pack. Local SEO from $499/mo, month-to-month, free audit. Senior team, founder-led.',
    url: CANONICAL,
    siteName: 'FactoryJet',
    locale: 'en_US',
    type: 'website',
...
const FAQ_GROUPS: ReadonlyArray<FaqGroup> = [
  {
    ...
    items: [
      { q: 'How much does local SEO cost in Tampa?', a: "FactoryJet's Tampa local SEO starts at $499/month, billed month-to-month. Across the US, local SEO typically runs $500–$3,000/month depending on competition and number of locations. Your audit is free, and there's no setup fee or long-term contract." },
    ...
    <>
      ...
      <div className="tseo">
          ...
          <div className="wrap hero-grid">
            <div>
              ...
              <div className="cta-row rise d4">
                <ModalCTAButton label="Get your free Tampa SEO audit" region="us" btnVariant="primary-light" />
        ...
        <section style={{ padding: '0 0 70px' }}>
          <div className="wrap">
            <div className="bluf"><p>FactoryJet is a Tampa SEO company that helps local businesses rank in Google&apos;s Map Pack and &quot;near me&quot; results. We handle Google Business Profile optimization, local citations, reviews, technical SEO, and content, billed month-to-month from $499, with a free audit and no long-term contract. Our Tampa SEO services cover every neighborhood across Tampa Bay, and you work directly with senior SEO experts instead of an account manager.</p></div>
          </div>
        </section>
        ...
        <section className="final">
          <div className="wrap">
            ...
            <p className="fine">Local SEO from $499/month · month-to-month · free audit · no setup fee · <Link href="/us/services/seo">US SEO services</Link></p>
          </div>
        </section>
      </div>
