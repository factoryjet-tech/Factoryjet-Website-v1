...
const CANONICAL = 'https://factoryjet.com/us/sioux-falls/seo';
        ...
        <section className="founder">
          <div className="wrap">
            <div>
              ...
              <p className="fl">Also serving: Brandon · Harrisburg · Tea · explore <Link href="/us/sioux-falls/ecommerce-development">ecommerce development in Sioux Falls</Link> and our <Link href="/us/services/seo">US SEO services</Link></p>
            </div>
            <div className="fcard">
