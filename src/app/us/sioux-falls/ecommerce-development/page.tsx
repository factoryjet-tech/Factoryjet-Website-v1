...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://factoryjet.com/us/sioux-falls/ecommerce-development',
    ...
    <>
      ...
      <main className="bg-fj-cream">
        ...
        <StrategicDarkSection
          ...
          pillars={[
            ...
            },
            {
              ...
              body: "You know exactly what you're paying before you pay anything. No hourly surprises, no scope changes, no \"we need another $2K.\" What we quote is what you pay.",
            },
            {
              icon: 'trending-up',
        ...
        <ComparisonTable
          ...
          rows={[
            { feature: 'Starting Price', values: ['$10K–$25K', '$8K–$20K', '$6K–$15K', 'From $2,999'] },
