...
const CANONICAL = 'https://factoryjet.com/us/huntington-beach/seo';
    ...
    },
    {
      ...
      breadcrumb: {
        ...
        itemListElement: [
          ...
          { '@type': 'ListItem', position: 3, name: 'Huntington Beach', item: 'https://factoryjet.com/us/huntington-beach' },
