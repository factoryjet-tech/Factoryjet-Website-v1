...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://factoryjet.com/us/website-cost', languages: websiteCostAlternates },
        ...
        <section className="border-t border-[#E7DED6] bg-[#FFF8F5]">
          <div className="mx-auto max-w-[1180px] px-5 py-16 md:py-20">
            ...
            <p className="mt-8 text-[14px] text-[#6E635A]">
              More on{' '}
              <Link href="/us/pricing" className="font-semibold text-[#C94A1A] underline">how we scope and price commerce work</Link> and our{' '}
