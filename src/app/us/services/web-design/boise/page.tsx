...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: 'https://factoryjet.com/us/services/web-design/boise',
    images: [
      {
  ...
  alternates: {
    canonical: 'https://factoryjet.com/us/services/web-design/boise',
    languages: webDesignCityAlternatesUS['boise'],
  },
  robots: {
    index: true,
    follow: true,
  ...
  return (
    <>
      <BreadcrumbSchema items={[
        ...
        { name: 'Boise', url: 'https://factoryjet.com/us/services/web-design/boise' },
      ]} />
      <Script
        id="json-ld-boise"
