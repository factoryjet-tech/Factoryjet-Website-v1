...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'AI Agency', item: 'https://factoryjet.com/us/services/ai-agency' },
  ],
};
...
const AI_SERVICES: Array<{
  ...
  },
  {
    ...
    linkHref: '/us/services/ai-chatbot-development',
  },
  {
    ...
    linkHref: '/us/services/ai-integration-services',
  },
  {
    ...
    linkHref: '/us/services/ai-workflow-automation',
  },
  {
...
const COMPARISON_ROWS = [
  {
    ...
    values: ['$5,000', '$40,000–$150,000', '$7,500–$40,000', '$500–$2,000/yr (you build it)'],
  },
  {
...
const PRICING_TIERS = [
  {
    ...
    features: [
      ...
      'Full codebase and API key ownership on day one',
    ],
...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer:
      'The math typically works like this: a customer support agent at $15,000 that handles 70% of tickets saves 8 to 15 staff hours per week. At $25/hour fully loaded labor cost, that\'s $10,000 to $19,500 in annual savings — and the agent works nights, weekends, and peak periods without overtime. A sales AI that responds to every lead within 60 seconds typically increases conversion rates 20 to 35%, because response speed is the single biggest driver of lead close rates. Most clients recover full investment within 3 to 6 months.',
  },
  {
    category: 'pricing',
    question: 'Are there ongoing fees after the AI is built?',
    answer:
      'Two types. First, API usage costs paid directly to model providers like Anthropic (Claude) or OpenAI (GPT-4o) — typically $50 to $300/month for most SMB use cases depending on volume. We don\'t mark these up. Second, if you want ongoing optimization or new feature development, we offer optional monthly retainers. Many clients self-manage after handover because the management dashboard is designed for non-technical operators. We\'ll tell you honestly when a retainer isn\'t needed for your use case.',
  },
  {
    category: 'pricing',
          ...
          rightSlot={
            <div className="w-full overflow-hidden rounded-2xl border border-fj-neutral-200 bg-white shadow-sm">
              ...
              <div className="divide-y divide-fj-neutral-100">
                {[
                  { service: 'AI Agents', desc: 'Autonomous workflows running 24/7', from: 'From $5,000' },
                  { service: 'AI Automation', desc: 'Connect tools, kill manual steps', from: 'From $3,000' },
                  { service: 'AI Chatbots', desc: 'Conversational AI for web, app & phone', from: 'From $4,000' },
                  { service: 'AI Integration', desc: 'Add AI to software you already use', from: 'From $5,000' },
                  { service: 'AI-Native Software', desc: 'New apps built AI-first', from: 'From $15,000' },
                  { service: 'AI Workflow Automation', desc: 'End-to-end internal process automation', from: 'From $3,500' },
        ...
        <ServiceExplanation
          ...
          body={
            <>
              ...
              <p>
                The businesses that hire us aren't buying AI because it's trendy. They ran the math: a $12,000 Growth AI platform that saves 20 staff hours per week pays for itself in under 12 weeks — and keeps paying every week after that, without raises, turnover, or sick leave.
              </p>
            </>
          }
          rightSlot={
        ...
        <StrategicDarkSection
          ...
          pillars={[
            ...
            },
            {
              ...
              body: 'US AI agencies built their pricing models around Fortune 500 clients with six-figure AI budgets and nine-month procurement cycles. A small business quoted $80,000 for an AI project that should cost $12,000 either overpays dramatically or abandons AI entirely. Neither outcome is good. FactoryJet was built specifically to deliver enterprise-quality AI systems at prices that make sense for businesses under $10M in revenue.',
            },
            {
