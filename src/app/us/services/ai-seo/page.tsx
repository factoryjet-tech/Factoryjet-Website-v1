...
/* ─────────────────────────────────────────────────────────────────────────────
   ...
   Pricing:   $2,499 audit + 3 monthly retainer tiers (Growth, Scale, Enterprise).
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://factoryjet.com/us/services/ai-seo',
...
const FAQ_ITEMS: ReadonlyArray<FAQItem> = [
  ...
  {
    category: 'method',
    question: 'What is included in the $2,499 audit?',
    answer:
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 3,
      name: 'AI SEO',
      item: 'https://factoryjet.com/us/services/ai-seo',
    },
  ],
};
  ...
  return (
    <>
      ...
      <ComparisonTable
        ...
        rows={[
          {
            feature: 'Starting retainer / month',
            values: ['from $1,999', '~$1,500', '~$3,500', 'varies'],
          },
          {
