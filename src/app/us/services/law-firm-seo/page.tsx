...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://factoryjet.com/us/services/law-firm-seo',
  },
  openGraph: {
    url: 'https://factoryjet.com/us/services/law-firm-seo',
    siteName: 'FactoryJet',
    locale: 'en_US',
    type: 'website',
    title: 'Law Firm SEO Agency | Legal SEO Services for Attorneys | FactoryJet',
...
const schemaBreadcrumb = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Law Firm SEO', item: 'https://factoryjet.com/us/services/law-firm-seo' },
  ],
};
  ...
  mainEntity: [
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Law firm SEO is the process of earning organic search rankings for legal queries. PPC costs $80 to $200 per click in most legal markets. A top organic ranking costs nothing per click and compounds value over time. Attorneys who rank organically consistently report the lowest cost per retained client across all channels.',
      },
    },
    {
      '@type': 'Question',
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Rankings.io starts at $8,000 per month for a single practice area campaign. Consultwebs locks you into long-term contracts. We offer senior-level legal SEO strategy with full transparency, no lock-in contracts, and the ability to cover multiple practice areas simultaneously.',
      },
    },
  ],
};
          ...
          <div className="stats-grid">
            ...
            <div className="stat-card reveal reveal-delay-1">
              <div className="stat-number-wrap">
                ...
                <span className="stat-num" data-target="141">0</span>
              </div>
              <p className="stat-label">average CPC for top legal terms</p>
            </div>
        ...
        <div className="container">
          ...
          <div className="bento-grid">
            ...
            <div className="bento-card bento-pi span-row card-magnetic reveal">
              ...
              <p className="bento-desc">The most competitive legal niche in search. Average CPC above $130 means a single organic #1 position saves six figures a year in ad spend. We&apos;ve built first-page authority for PI firms in Nashville, Tampa, and Charlotte.</p>
            ...
            <div>
              ...
              <div className="faq-section reveal" id="faq-basics">
                ...
                <details>
                  ...
                  <div className="faq-answer">Law firm SEO is the process of earning organic search rankings for legal queries, &quot;personal injury lawyer Dallas,&quot; &quot;criminal defense attorney near me,&quot; and hundreds of related terms. PPC puts you in front of searchers but costs $80 to $200 per click in most legal markets. A top organic ranking costs nothing per click and compounds value over time. Attorneys who rank organically consistently report the lowest cost per retained client across all channels.</div>
                </details>
