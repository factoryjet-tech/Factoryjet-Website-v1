...
const howToSchema = {
  '@context': 'https://schema.org',
  '@type': 'HowTo',
  name: 'How FactoryJet builds your WooCommerce store in 7 days',
  description: 'Our proven 7-day process for delivering professional, high-performance WooCommerce stores for US businesses.',
  totalTime: 'P7D',
  step: [
    {
      '@type': 'HowToStep',
