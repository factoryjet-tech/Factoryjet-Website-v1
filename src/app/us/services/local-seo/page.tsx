    ...
    items: [
      {
        ...
        a: 'Most local SEO runs between $500 and $3,000 a month, depending on how competitive your market is and how many locations you have. We scope every engagement to the work that will actually move your map-pack rankings and calls, then give you the number on a short call. The simplest way to get a real figure is to start with a free local SEO audit.',
      },
      {
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://factoryjet.com/us/services/local-seo',
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 4, name: 'Local SEO', item: 'https://factoryjet.com/us/services/local-seo' },
  ],
};
          ...
          <div className="wrap hero-grid">
            <div>
              ...
              <div className="cta-row rise d4">
                <ModalCTAButton label="Get a free local SEO audit" region="us" btnVariant="primary-light" />
