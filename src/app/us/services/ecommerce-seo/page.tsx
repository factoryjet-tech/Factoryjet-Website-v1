    ...
    items: [
      {
        ...
        a: 'Most ecommerce SEO runs between $1,500 and $6,000 a month, depending on catalog size, platform, and how competitive your category is. We scope every engagement to the work that will actually move revenue, then give you the number on a short call. The simplest way to get a real figure is to start with a free ecommerce SEO audit.',
      },
      {
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://factoryjet.com/us/services/ecommerce-seo',
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 4, name: 'Ecommerce SEO', item: 'https://factoryjet.com/us/services/ecommerce-seo' },
  ],
};
