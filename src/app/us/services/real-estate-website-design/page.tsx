  ...
  mainEntity: [
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: "A real estate agent website from FactoryJet starts at $2,499 for a custom 8-page site with IDX integration, neighborhood pages, lead capture, and mobile optimization. Brokerage websites start at $4,500. Property management company sites with tenant/owner portals start at $6,500. US real estate web agencies typically charge $8,000–$30,000 for comparable work.",
      },
    },
    {
      '@type': 'Question',
...
const USE_CASES = [
  {
    ...
    description: 'Custom agent sites with IDX, neighborhood pages, home valuation lead capture, and personal branding. Starting at $2,499.',
  ...
  },
  {
    ...
    example: 'Team sites typically run $3,500–$5,000 depending on team size.',
  },
  {
    name: 'Brokerages',
    ...
    example: 'Brokerage sites start at $4,500 and include team management features.',
    linkLabel: 'Get started',
    linkHref: '/contact',
  },
  {
    ...
    example: 'Property management platforms start at $6,500 — includes both portals.',
  ...
  },
  {
    ...
    example: 'Commercial sites from $3,500. Typically 10–15 pages with property showcase.',
  },
  {
    ...
    example: 'Development project sites from $4,000. Includes waitlist capture and floor plan gallery.',
...
const COMPARISON_ROWS = [
  { feature: 'Starting Price', values: ['$2,499 (one-time)', '$500–$1,500/mo', '$8,000+', '$16–$49/mo'] },
  {
...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer: "A custom real estate agent website from FactoryJet starts at $2,499 — that's a custom 8-page site with IDX integration, up to 5 neighborhood pages, lead capture forms, mobile optimization, and on-page SEO setup. US real estate web agencies typically charge $8,000–$20,000 for comparable work. Brokerage sites start at $4,500. Property management sites with tenant/owner portals start at $6,500.",
  },
  {
    category: 'basics',
...
const MARKET_STATS = [
  {
    value: '$2,499',
    label: 'starting price for a custom agent site with IDX — vs. $8,000–$20,000 at US real estate web agencies',
  ...
  },
  {
    ...
    sourceUrl: 'https://factoryjet.com/us/services/real-estate-website-design',
    ...
    <>
      ...
      <ServiceHeroImageBand
        ...
        stats={[
          ...
          { value: 'From $2,499', label: 'Fixed Price, IDX Included' },
      ...
      <BigThreeTrustBlock
        eyebrow="REAL ESTATE WEBSITE DESIGN"
        headline="$2,499 agent site. IDX included. 7-day delivery. Lighthouse 90+. No ongoing platform fee."
      />
      ...
      <StrategicDarkSection
        ...
        pillars={[
          ...
          },
          {
            ...
            body: "Platform subscriptions range from $500–$1,500/month. Over 3 years, that's $18,000–$54,000 in fees — for a site you can't take with you if you switch brokerages, and that disappears the moment you stop paying. A FactoryJet site is built once, owned forever.",
          },
          {
      ...
      <ComparisonTable
        ...
        footer="Real Geeks, kvCORE, and BoomTown monthly fees are recurring and typically increase over time. FactoryJet is a one-time build fee — hosting costs ($0–$80/month) go directly to your host."
      />
