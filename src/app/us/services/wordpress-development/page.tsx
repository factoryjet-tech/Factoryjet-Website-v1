  ...
  offers: [
    {
      ...
      price: '1999',
      priceCurrency: 'USD',
      description: 'Up to 10-page custom WordPress business website with custom theme, no page builders, and full SEO setup.',
    },
    {
      '@type': 'Offer',
      ...
      price: '3500',
      priceCurrency: 'USD',
      description: '15–30 page custom WordPress site with custom post types, advanced functionality, and full SEO and analytics setup.',
    },
    {
      '@type': 'Offer',
      ...
      price: '4999',
      priceCurrency: 'USD',
      description: 'Custom WooCommerce store design and development with product pages, checkout optimization, and full payment integration.',
    },
  ],
};
...
const WP_SERVICES = [
  ...
  },
  {
    ...
    description:
      'WooCommerce is the most flexible e-commerce platform on WordPress — and the most commonly under-optimized. We design and build WooCommerce stores with custom product pages, mobile-first checkout, cart abandonment recovery, and performance optimization that doesn\'t require a $500/month hosting plan to achieve decent load times.',
    example: 'Optimized WooCommerce stores convert at 2–3% vs. 0.5–1% for default theme builds.',
    linkLabel: 'See WooCommerce pricing',
    linkHref: '#pricing',
  },
  {
...
const COMPARISON_ROWS = [
  {
    ...
    values: ['$1,999', '$8,000–$40,000', '$1,000–$3,000', '$2,500–$10,000'],
  },
  {
...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer:
      'Yes — hosting ($20–$150/month depending on traffic), domain renewal ($15–$20/year), and security/maintenance (premium security plugin: $100/year; backup solution: $50–$100/year). These are platform-level costs that exist regardless of who builds your site. Optional ongoing: a maintenance retainer ($200–$500/month) for WordPress core and plugin updates, security monitoring, and content changes. Most clients with small teams choose a maintenance retainer; larger teams with internal technical staff often self-manage after handover.',
  },
  ...
  /* ── Technical Details ── */
  {
    ...
    answer:
      'For most small businesses we recommend managed WordPress hosting: WP Engine, Kinsta, or Flywheel for businesses where reliability is critical ($30–$100/month). For budget-conscious builds, SiteGround or Cloudways on DigitalOcean offer a good balance of performance and cost ($20–$40/month). We avoid shared hosting — it\'s the single biggest source of slow WordPress sites. We configure the hosting environment as part of every project, not just hand you the code and leave you to figure it out.',
  },
  {
    category: 'technical',
