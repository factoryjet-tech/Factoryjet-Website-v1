...
/* ─────────────────────────────────────────────────────────────────────────────
   ...
   claims only (4.9/150, 500+, month-to-month, 7-day/Lighthouse 100); growth card
    ...
    items: [
      {
        ...
        a: `Most small business SEO runs between $500 and $2,500 a month, depending on your market and how fast you want to move. We scope every plan to the work that actually brings customers, then give you the number on a short call. The simplest way to get a real figure is to start with a free SEO audit.`,
      },
      {
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: 'https://factoryjet.com/us/services/small-business-seo',
  ...
  alternates: {
    canonical: 'https://factoryjet.com/us/services/small-business-seo',
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 4, name: 'Small Business SEO', item: 'https://factoryjet.com/us/services/small-business-seo' },
  ],
};
          ...
          <div className="wrap team-grid">
            ...
            <div>
              ...
              <ul className="feat-list">
                ...
                <li><span className="fi"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M20 6L9 17l-5-5" /></svg></span><div>500+ businesses served<small>4.9 / 5 from 150 reviews</small></div></li>
              </ul>
