...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: 'https://factoryjet.com/us/services/shopify-seo',
    images: [
      {
  ...
  alternates: {
    canonical: 'https://factoryjet.com/us/services/shopify-seo',
  },
  robots: {
    index: true,
    follow: true,
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 3,
      name: 'Shopify SEO',
      item: 'https://factoryjet.com/us/services/shopify-seo',
    },
  ],
};
        ...
        body={
          <>
            ...
            >
              ...
              <Link href="/us/services/shopify-development" className="text-[#F05A28] font-medium underline underline-offset-2">build Shopify stores</Link>, we fix performance and theme issues at the code level, not with another plugin.
            </p>
            <p
            ...
            >
              ...
              <Link href="/us/services/ecommerce-seo" className="text-[#F05A28] font-medium underline underline-offset-2">ecommerce SEO service</Link>{' '}
