...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: 'https://factoryjet.com/us/services/seo-audit',
  ...
  alternates: {
    canonical: 'https://factoryjet.com/us/services/seo-audit',
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 4, name: 'SEO Audit', item: 'https://factoryjet.com/us/services/seo-audit' },
  ],
};
          ...
          <div className="wrap team-grid">
            ...
            <div>
              ...
              <ul className="feat-list" data-reveal>
                ...
                <li><span className="fi"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M20 6L9 17l-5-5" /></svg></span><div>500+ sites audited &amp; built<small>4.9 / 5 from 150 reviews</small></div></li>
              </ul>
