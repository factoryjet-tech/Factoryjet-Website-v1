...
export const metadata: Metadata = {
  title: 'AI Agent Development Services USA | Custom AI Agents for Business | FactoryJet',
  description:
    'FactoryJet builds custom AI agents, AI automation, and AI-native software for US small businesses. Cut 60–70% of manual work. Delivered in weeks, not months. Starting at $5,000. Free AI strategy call.',
  openGraph: {
    type: 'website',
    siteName: 'FactoryJet',
    title: 'AI Agent Development Services USA | FactoryJet',
    description:
      'Custom AI agents, automation workflows, and AI-powered apps for US businesses. 60–70% cheaper than a US AI agency. Delivered fast.',
  ...
  twitter: {
    ...
    title: 'AI Agent Development Services USA | FactoryJet',
    description:
      'Custom AI agents and automation for US small businesses. 60–70% cheaper. Fast delivery. Free AI strategy call.',
    images: ['https://factoryjet.com/logo.png'],
  },
  alternates: {
    canonical: 'https://factoryjet.com/us/services/ai-agents',
...
const faqSchema = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'FactoryJet\'s AI agents start at $5,000 for a focused single-workflow agent (Starter tier). Most small businesses need the Growth tier at $15,000, which covers multiple interconnected agents, CRM integrations, a management dashboard, and a 30-day support window. Enterprise platforms with multi-agent orchestration start at $25,000. All prices are 60–70% lower than comparable US AI agencies.',
      },
    },
    {
      '@type': 'Question',
      name: 'Why is FactoryJet 60–70% cheaper than US AI agencies?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Our engineering team is based in India. Same quality of architecture, code, and delivery at dramatically lower labor costs. We don\'t have layers of account management, project managers, and sales reps inflating your invoice. You brief an engineer; that engineer builds it.',
      },
    },
    {
      '@type': 'Question',
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'The most common return comes from labor hours recovered. A customer support agent handling 70% of tickets at $15,000 replaces hundreds of hours of manual work per month. A lead qualification agent that responds within 60 seconds typically increases conversion rates by 20–35%. Most clients see payback within 3–6 months of launch.',
      },
    },
    {
      '@type': 'Question',
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes, two types: API usage costs (typically $50–$300/month for most SMB use cases — go directly to model providers, not marked up by FactoryJet) and optionally a FactoryJet retainer for ongoing optimization. The retainer is optional; many clients self-manage after the handoff.',
      },
    },
    {
      '@type': 'Question',
...
const FAQ_ITEMS = [
  ...
  {
    category: 'pricing',
    question: 'Why is FactoryJet 60–70% cheaper than US AI agencies?',
    answer:
      'Our engineering team is based in India. That\'s it — no complicated explanation. The same quality of architecture, code, and delivery at dramatically lower labor costs. We don\'t have layers of account management, project managers, and sales reps inflating your invoice. You brief an engineer; that engineer builds it. That structure lets us pass the savings directly to you.',
  },
  {
    category: 'pricing',
    question: 'What is the typical ROI on an AI agent investment?',
    answer:
      'The most common return comes from labor hours recovered. A customer support agent handling 70% of tickets at $15,000 replaces hundreds of hours of manual work per month. A lead qualification agent that responds to every inbound lead within 60 seconds typically increases conversion rates by 20–35% — response speed is the single biggest driver of lead close rates. Most clients see payback within 3–6 months of launch.',
  },
  {
    category: 'pricing',
    question: 'Are there ongoing costs after the build is complete?',
    answer:
      'Yes, two types: API usage costs (the AI model fees, typically $50–$300/month for most SMB use cases depending on volume — these go directly to model providers, we don\'t mark them up) and optionally a FactoryJet retainer if you want ongoing optimization or new feature development. The retainer is optional; many clients self-manage after the handoff.',
  },
      ...
      <main className="bg-fj-cream">
        ...
        <CityContextSection
          ...
          leadParagraphs={[
            ...
            "The businesses we build for aren't buying AI because it's trendy. They're buying it because they ran the math: a $15,000 Growth AI platform that saves 25 staff hours per week pays for itself in under 12 weeks — and keeps paying forever.",
          ]}
          bodySlot={
            <>
        ...
        <ComparisonTable
          ...
          pullQuote={{
            stat: '60–70%',
            caption: 'cheaper than a comparable US AI agency — same engineering quality.',
          }}
