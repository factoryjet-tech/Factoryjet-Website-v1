...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: 'https://factoryjet.com/us/services/ecommerce-development/shopify-development',
    images: [
      {
  ...
  alternates: {
    canonical: 'https://factoryjet.com/us/services/ecommerce-development/shopify-development',
    languages: {
