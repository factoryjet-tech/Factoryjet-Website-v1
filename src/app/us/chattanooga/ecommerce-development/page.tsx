...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://factoryjet.com/us/chattanooga/ecommerce-development',
      ...
      <main className="bg-fj-cream">
        ...
        <StrategicDarkSection
          ...
          pillars={[
            ...
            {
              title: 'Transparent',
              body: "Fixed pricing on the first call. Shopify from $2,999, WooCommerce from $3,499, headless from $5,999. No discovery fees, no 'it depends' quotes, no phase-2 invoices. Unlike Growisto and WebCitz who publish zero pricing, you know your exact number before we start.",
            },
            {
              title: 'Guaranteed',
          ...
          rows={[
            {
              ...
              values: [
                '$8,000–$25,000 (full-service digital agency, WordPress-focused, no published Shopify-specific pricing)',
            ...
            },
            {
              feature: 'JLB Works',
              values: [
                '$5,000–$20,000 (800+ clients, WordPress-focused general web design, 6–12 week timelines)',
        ...
        <TestimonialsSection
          ...
          headline="4.9/5 across 150+ reviews from Chattanooga and beyond."
        />
        ...
        <FAQ
          ...
          items={[
            ...
            },
            {
              ...
              answer:
                "Yes — CO.LAB startups and GIGTANK alumni are one of our sweet spots in Chattanooga. Early-stage companies need e-commerce infrastructure that launches fast, scales as you grow, and fits a startup budget. FactoryJet's $2,999 Shopify build gives CO.LAB founders enterprise-quality stores at pre-seed pricing. We've built stores for founders at every stage — from pre-launch DTC landing pages to full B2B portals for post-seed companies scaling revenue.",
            },
            {
              category: 'included',
            ...
            },
            {
              ...
              answer:
                "Yes — every FactoryJet project includes 30 days of free post-launch support covering bug fixes, minor adjustments, and launch questions. Beyond that, Chattanooga businesses can choose monthly retainer plans starting at $299/month, which includes up to 4 hours of development time and priority support response. We also offer seasonal campaign builds — pre-summer outdoor gear drops, fall tourism season promotions, and holiday gift set launches that are especially important for Chattanooga's tourism-driven economy. Many Chattanooga clients have been on maintenance plans for two-plus years.",
            },
            {
              category: 'included',
...
function SchemaScript() {
  return (
    <script
      ...
      dangerouslySetInnerHTML={{ __html: getEcommerceCitySchema('chattanooga') }}
    />
  );
}
