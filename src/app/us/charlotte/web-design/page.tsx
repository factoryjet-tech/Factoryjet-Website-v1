      ...
      <section className="py-10 bg-[#FAFAF7]">
        <div className="max-w-5xl mx-auto px-6 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            <Link
              href="/us/charlotte/ecommerce-development/"
      ...
      },
      {
        ...
        "mainEntity": [
          ...
          },
          {
            ...
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Neither Idea Kraft nor Bowen publishes pricing or delivery timelines. FactoryJet publishes all three tiers upfront, delivers in 7 days, and builds in Next.js rather than WordPress — faster load times and no ongoing plugin maintenance. At Growth ($3,999), we deliver at a fixed, published price for equivalent scope."
            }
          },
          {
            "@type": "Question",
    ...
    <>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({
          "@context": "https://schema.org",
          "@type": "WebPage",
          "name": "Web Design Charlotte NC | 7 Days from $1,500 | FactoryJet",
          "url": "https://factoryjet.com/us/charlotte/web-design/",
          "speakable": {
