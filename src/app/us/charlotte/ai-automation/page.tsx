...
export const metadata: Metadata = {
  ...
  description:
    'FactoryJet builds custom AI workflow automation for Charlotte small businesses — financial services workflows, logistics document processing, healthcare intake, compliance reporting, and CRM sync. Cut 40–65% of manual task time. Starting at $4,000. Free strategy call.',
  openGraph: {
    type: 'website',
    siteName: 'FactoryJet',
    title: 'AI Workflow Automation for Charlotte NC Businesses | FactoryJet',
...
const PRICING_TIERS = [
  {
    ...
    features: [
      ...
      'Full code and automation data ownership',
    ],
  ...
  },
  {
    ...
    features: [
      ...
      'Full code and automation ownership',
    ],
...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer:
      'Three differences: price (60–70% cheaper — India-based engineers serving US businesses for 25+ years), speed (no layers between your brief and the engineer building it — weeks, not quarters), and SMB depth (500+ small business projects since 1999 — we understand what operations look like inside a 20-person Charlotte financial services firm or a regional logistics company, including the compliance and audit requirements those industries carry).',
  },
];
