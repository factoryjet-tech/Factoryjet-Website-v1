...
export const metadata: Metadata = {
  ...
  description: 'FactoryJet builds fast, conversion-focused websites for Denver businesses — from $1,999. 7-day delivery, fixed-price. Next.js, SEO & GA4.',
  alternates: {
  ...
  return (
    ...
    <main className="bg-fj-cream">
      ...
      <ComparisonTable
        eyebrow={"WHY FACTORYJET"}
        headline={"Why Denver Businesses Choose FactoryJet Over Local Agencies"}
        lead={"Denver's web agency market is established. Fruition publishes rates of $5,000–$20,000+ for comparable scope. Webolutions has 20+ years of Colorado B2B experience but does not publish delivery timelines or pricing. FactoryJet's Growth tier ($3,999) delivers the same scope — 10–15 pages, CMS, SEO, analytics — at a fixed, published price, with a 7-day delivery commitment in writing and a Next.js codebase instead of WordPress."}
      ...
      <section className="py-10 bg-[#FAFAF7]">
        <div className="max-w-5xl mx-auto px-6 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            <Link
              href="/us/denver/ecommerce-development/"
        ...
        "mainEntity": [
          {
            ...
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Most Denver small businesses start with the Starter tier ($1,999) for a clean five-page site, or Growth ($3,999) for a blog CMS, lead capture, and e-commerce or booking integration. Custom builds for aerospace suppliers, cannabis operators, or energy firms with complex RFQ or compliance requirements start at $7,500+. Denver agency rates for the same scope typically run $5,000–$20,000+ — FactoryJet delivers at a fixed, published price."
            }
          },
          {
            "@type": "Question",
