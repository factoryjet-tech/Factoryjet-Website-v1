...
const breadcrumbSchema = {
  '@context': 'https://schema.org',
  '@type': 'BreadcrumbList',
  '@id': 'https://factoryjet.com/us/denver/ai-agents#breadcrumb',
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 4, name: 'AI Agents', item: 'https://factoryjet.com/us/denver/ai-agents' },
  ],
};
