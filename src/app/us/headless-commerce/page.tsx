...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: 'https://factoryjet.com/us/headless-commerce',
  ...
  alternates: { canonical: 'https://factoryjet.com/us/headless-commerce' },
...
const BREADCRUMB_SCHEMA = { '@context': 'https://schema.org', '@type': 'BreadcrumbList', itemListElement: [
  ...
  { '@type': 'ListItem', position: 2, name: 'Headless Commerce', item: 'https://factoryjet.com/us/headless-commerce' },
] };
        ...
        <section className="pp-sec tint">
          <div className="pp-wrap">
            ...
            <p style={{ marginTop: '28px', fontSize: '14px', color: 'var(--pp-muted)' }}>
              Related:{' '}
              <Link href="/us/services/shopify-development" style={{ fontWeight: 600, color: 'var(--pp-orange-dark)', textDecoration: 'underline' }}>Shopify development</Link>,{' '}
              <Link href="/us/bigcommerce-development" style={{ fontWeight: 600, color: 'var(--pp-orange-dark)', textDecoration: 'underline' }}>BigCommerce development</Link>, and{' '}
