...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://factoryjet.com/us/raleigh/ai-agents',
...
const breadcrumbSchema = {
  '@context': 'https://schema.org',
  '@type': 'BreadcrumbList',
  '@id': 'https://factoryjet.com/us/raleigh/ai-agents#breadcrumb',
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 4, name: 'AI Agents', item: 'https://factoryjet.com/us/raleigh/ai-agents' },
  ],
};
...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer:
      'The ROI case is direct. A support agent handling 65% of your tickets at $8,000 typically pays for itself in 2–3 months for a team answering 50+ inquiries per day. For Raleigh professional services firms, even automating 30% of intake triage pays for a $3,000 agent in weeks of recovered billable hours. Lead agents that respond in under 5 seconds convert 2–5× better than email follow-up.',
  },
  {
    category: 'pricing',
