...
export const metadata: Metadata = {
  title: 'Shopify Developer Raleigh NC | From $2,999 | FactoryJet',
  description: 'Shopify developer in Raleigh NC: stores live in 7 days from $2,999. Research Triangle e-commerce — Shopify, WooCommerce & AI. 500+ projects. Free audit.',
  openGraph: {
    type: 'website',
    siteName: 'FactoryJet',
    title: 'Shopify Developer Raleigh NC | From $2,999 | FactoryJet',
    description: 'Top-rated Shopify developer in Raleigh, North Carolina: stores live in 7 days from $2,999. Research Triangle e-commerce specialists — Shopify, WooCommerce & AI. 500+ projects, 4.9★. Free audit.',
    url: 'https://factoryjet.com/us/raleigh/ecommerce-development',
    images: [{ url: 'https://factoryjet.com/logo.png', width: 1200, height: 630, alt: 'FactoryJet - Shopify Developer Raleigh' }],
    locale: 'en_US',
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Shopify Developer Raleigh NC | From $2,999 | FactoryJet',
    description: 'Top-rated Shopify developer in Raleigh, NC: stores live in 7 days from $2,999. Research Triangle e-commerce specialists.',
    images: ['https://factoryjet.com/logo.png'],
  },
  alternates: {
    canonical: 'https://factoryjet.com/us/raleigh/ecommerce-development',
    ...
    <>
      ...
      <main className="bg-fj-cream">
        ...
        <StrategicDarkSection
          ...
          lead={
            "Forge Digital Marketing and Kaptiv8 serve Raleigh's marketing needs but don't specialize in Shopify development. Orange Orchard handles PR and some digital work. Kelp Creative does web design but not AI-powered e-commerce. KoMarketing and other national agencies targeting Raleigh charge $10,000–$50,000 with no Research Triangle market knowledge.\n\nFactoryJet delivers in 7 days from $2,999 with deep Raleigh expertise: RTP's tech and life sciences ecosystem, Wake County tax structure, and the Triangle's university-tech consumer profile that's more AI-literate than any other Southeast market."
          }
          pillars={[
            {
            ...
            {
              title: 'Transparent',
              body: 'Fixed pricing on the first call. Shopify from $2,999, WooCommerce from $3,499, headless from $5,999. No discovery fees, no life-sciences-complexity surcharges, no Phase 2 invoices after launch.',
            },
            {
              title: 'Guaranteed',
        ...
        <ComparisonTable
          ...
          lead={
            "Raleigh's agency market focuses on marketing and general web design — few specialize in Shopify e-commerce for the Triangle's tech and life sciences market. National agencies targeting Raleigh charge $10,000–$50,000 with no Research Triangle market knowledge.\n\nFactoryJet delivers a full Shopify store in 7 days from $2,999 — with RTP tech sophistication, life sciences B2B expertise, and Triangle-wide SEO that local agencies simply don't offer."
          }
          columns={[
            { label: 'Their pricing' },
          ...
          rows={[
            {
              ...
              values: [
                '$8,000–$20,000 (marketing-focused, not Shopify specialists)',
            ...
            },
            {
              ...
              values: [
                '$10,000–$50,000 (no Raleigh/Triangle market presence)',
                'From $2,999 fixed price, 7-day delivery',
                "KoMarketing is B2B-focused with no Triangle market knowledge. FactoryJet delivers real Research Triangle expertise — RTP's tech ecosystem, Wake County tax structure, the Triangle's university-tech consumer profile — with 7-day delivery at 50–80% lower cost.",
              ],
            },
          ]}
        />
...
function SchemaScript() {
  return (
    <script
      ...
      dangerouslySetInnerHTML={{ __html: getEcommerceCitySchema('raleigh') }}
    />
  );
}
