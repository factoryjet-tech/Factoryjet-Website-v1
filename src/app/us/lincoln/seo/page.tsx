...
const CANONICAL = 'https://factoryjet.com/us/lincoln/seo';
        ...
        <section className="founder">
          <div className="wrap">
            <div>
              ...
              <p className="fl">Also for Lincoln businesses: <Link href="/us/lincoln/ecommerce-development">ecommerce development in Lincoln</Link> · our <Link href="/us/services/seo">US SEO services</Link> · serving southeast Nebraska statewide</p>
            </div>
            <div className="fcard">
