...
const CANONICAL = 'https://factoryjet.com/us/colorado-springs/seo';
  ...
  '@graph': [
    ...
    },
    {
      ...
      itemListElement: [
        ...
        { '@type': 'ListItem', position: 3, name: 'Colorado Springs', item: 'https://factoryjet.com/us/colorado-springs' },
        ...
        <section className="final-cta">
          <div className="wrap">
            ...
            <p style={{ marginTop: '28px', fontSize: '13px', color: 'rgba(255,255,255,0.6)' }}>
              ...
              <Link href="/us/colorado-springs/web-design" style={{ color: 'rgba(255,255,255,0.8)' }}>web design</Link>
              {' '}and{' '}
              <Link href="/us/services/seo" style={{ color: 'rgba(255,255,255,0.8)' }}>US SEO services</Link>.
            </p>
          </div>
        </section>
