...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://factoryjet.com/us/boise/ecommerce-development',
          ...
          body={
            <>
              ...
              <p>
                ...
                management, and compliant food labeling. Every store ships in 7 days from $2,999
        ...
        <StrategicDarkSection
          ...
          pillars={[
            ...
            },
            {
              ...
              body: "We give you a fixed price before you pay a dollar — and it never changes. No hourly billing, no scope creep, no \"we need another $3K for the homepage.\" What we quote is what you pay. Mode Effect and Crush can't say the same.",
            },
            {
        ...
        <ComparisonTable
          ...
          rows={[
            ...
            },
            {
              feature: 'Crush (Boise)',
              values: [
                '$6,000–$15,000 (full-service branding and digital agency, Shopify is one of many services, 6–10 week timelines)',
                'From $2,999 fixed price, 7-day delivery',
            ...
            },
            {
              ...
              values: [
                '$5,000–$12,000 (marketing and web agency with broad service offering, not Shopify-specialized, 4–8 week timelines)',
                'From $2,999 fixed price, 7-day delivery',
        ...
        <FAQ
          ...
          items={[
            ...
            },
            {
              ...
              answer: "Yes. Every project includes 30 days of post-launch support — bug fixes, adjustments, and questions answered same-day. After that, we offer monthly maintenance plans from $299/month covering theme updates, app updates, speed monitoring, and priority support.",
            },
            {
              category: 'pricing',
              question: 'How much does a Shopify store typically cost in Boise, Idaho?',
              answer: "Local Boise agencies charge $6,000–$25,000 for a Shopify build, with timelines of 6–14 weeks. Freelancers on Upwork run $1,500–$6,000 with highly variable quality. We charge $2,999–$15,999 depending on scope, deliver in 7 days, and back it with a money-back guarantee.",
            },
            {
              category: 'technical',
            ...
            },
            {
              ...
              answer: "Yes — startups and pre-revenue businesses are welcome. Many of our best client relationships started from day zero. We'll be honest about what you need vs. what you don't — a pre-revenue business usually needs our Standard package at $2,999 to validate the product before investing in advanced features.",
            },
            {
              category: 'local',
