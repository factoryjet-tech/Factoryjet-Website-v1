...
const CANONICAL = 'https://factoryjet.com/us/boise/seo';
          ...
          <div className="wrap">
            ...
            <div className="aiwrap">
              <div>
                ...
                <p className="body">This is the quietest land grab in local search. Almost no Boise SEO agency structures sites for AI citation today, which means the businesses that do it now get recommended without a fight. We make your pages quotable, then track your citations in every engine, monthly, so AI visibility becomes a number on your report instead of a mystery. Pair it with our <Link href="/us/services/ai-seo">US AI SEO service</Link> for the deepest coverage.</p>
              </div>
        ...
        <section className="founder">
          <div className="wrap">
            <div>
              ...
              <p className="fl">Also serving: Meridian · Eagle · Nampa · Caldwell · explore <Link href="/us/boise/ecommerce-development">ecommerce development in Boise</Link> and our <Link href="/us/services/seo">US SEO services</Link></p>
            </div>
            <div className="fcard">
