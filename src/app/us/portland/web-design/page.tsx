...
export const metadata: Metadata = {
  ...
  description: 'FactoryJet builds fast, conversion-focused websites for Portland businesses — from $1,999. 7-day delivery, fixed-price and milestone-paid. Next.js, SEO & GA4.',
  alternates: {
  ...
  openGraph: {
    ...
    title: 'Web Design Portland OR | 7 Days from $1,500 | FactoryJet',
    description: 'FactoryJet builds fast, conversion-focused websites for Portland businesses — from $1,999. 7-day delivery, fixed-price and milestone-paid. Next.js, SEO & GA4.',
    url: 'https://factoryjet.com/us/portland/web-design/',
    images: [
      {
      ...
      <section className="py-10 bg-[#FAFAF7]">
        <div className="max-w-5xl mx-auto px-6 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            <Link
              href="/us/portland/ecommerce-development/"
        ...
        "mainEntity": [
          {
            ...
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Most Portland small businesses choose the Starter tier ($1,999) for a clean five-page site, or Growth ($3,999) for a blog CMS and lead capture. Custom builds with e-commerce or AI features start at $7,500+. For context, local Portland agency Gravitate Design publishes a minimum of $10,000. FactoryJet Growth delivers comparable scope at a fixed, published price."
            }
          },
          {
            "@type": "Question",
    ...
    <>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({
          "@context": "https://schema.org",
          "@type": "WebPage",
          "name": "Web Design Portland OR | 7 Days from $1,500 | FactoryJet",
          "url": "https://factoryjet.com/us/portland/web-design/",
          "speakable": {
