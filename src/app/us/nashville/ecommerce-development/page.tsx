...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: 'https://factoryjet.com/us/nashville/ecommerce-development',
  ...
  alternates: {
    canonical: 'https://factoryjet.com/us/nashville/ecommerce-development',
