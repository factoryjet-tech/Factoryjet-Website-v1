...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: 'https://factoryjet.com/charlotte/ai-automation',
    images: [
      {
  ...
  alternates: {
    canonical: 'https://factoryjet.com/charlotte/ai-automation',
...
const webPageSchema = {
  ...
  '@type': 'WebPage',
  '@id': 'https://factoryjet.com/charlotte/ai-automation#webpage',
  url: 'https://factoryjet.com/charlotte/ai-automation',
...
const howToSchema = {
  '@context': 'https://schema.org',
  '@type': 'HowTo',
  name: 'How FactoryJet builds your Charlotte AI automation solution',
...
const breadcrumbSchema = {
  '@context': 'https://schema.org',
  '@type': 'BreadcrumbList',
  '@id': 'https://factoryjet.com/charlotte/ai-automation#breadcrumb',
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 4, name: 'AI Automation', item: 'https://factoryjet.com/charlotte/ai-automation' },
  ],
};
...
const COMPARISON_ROWS = [
  {
    ...
    values: [
      ...
      'Ongoing SaaS fee',
      'Hourly or per-project, variable',
    ],
  },
  {
...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer:
      'The most direct return is from manual hours eliminated. An invoice processing automation handling 100 invoices per week typically pays for itself in 2–3 months based on staff time replaced. Lead follow-up automation that contacts every new lead within 60 seconds typically increases qualified pipeline by 25–40%. Charlotte financial services and logistics clients most often recover the build cost within one quarter.',
  },
  {
    category: 'pricing',
  ...
  },
  {
    ...
    answer:
      'An invoice processing automation handling 100 invoices per week paid for itself in 2–3 months. A professional services firm\'s client onboarding automation reduced onboarding time from 3 days to 4 hours without adding staff. A logistics company reduced manual document processing time by 65% by automating shipping document extraction and carrier sync. We share relevant case studies during a strategy call.',
  },
  {
    category: 'trust',
...
export default function CharlotteAIAutomationPage() {
  return (
    <>
      ...
      />
      <script
        id="charlotte-ai-automation-breadcrumb-schema"
        type="application/ld+json"
      ...
      <main className="bg-fj-cream">
        ...
        <div id="pricing">
          <PricingTiers
            ...
            tiers={PRICING_TIERS}
            footnote="Every project is fixed-price and quoted up front after a discovery call. Monthly retainer options available. You own all automation code and workflow data."
          />
        </div>
