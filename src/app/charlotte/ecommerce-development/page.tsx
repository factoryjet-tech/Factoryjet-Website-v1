...
export const metadata: Metadata = {
  ...
  description:
    'Charlotte ecommerce development agency. Custom Shopify Plus, WooCommerce, and headless commerce stores built for high conversion. Get a fixed quote.',
  alternates: { canonical: CANONICAL },
  openGraph: {
    type: 'website',
    siteName: 'FactoryJet',
    title: 'Ecommerce Development Charlotte NC | Shopify & Custom | FactoryJet',
    description:
      'High-converting Shopify Plus and custom e-commerce storefronts for Charlotte brands. Sub-second speed and ERP integrations.',
    url: CANONICAL,
    images: [{ url: 'https://factoryjet.com/og-default.png', width: 1200, height: 630, alt: 'Ecommerce Development Charlotte NC' }],
    locale: 'en_US',
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Ecommerce Development Charlotte NC | FactoryJet',
    description: 'Custom Shopify Plus and e-commerce development for Charlotte NC brands. Fixed price, senior delivery.',
...
const CHARLOTTE_SECTORS = [
  {
    sector: 'Manufacturing & Industrial Distribution',
    badge: 'I-85 / I-77 Corridor',
    desc: 'Heavy machinery, automotive parts, and industrial supply distributors. Integrated with NetSuite ERP, customer-specific wholesale price lists, tiered quantity breaks, and freight shipping calculators.',
  },
  {
    sector: 'Direct-to-Consumer & Apparel',
    badge: 'South End DTC',
    desc: 'Boutique lifestyle, athleisure, and outdoor brands around South End and Plaza Midwood. Engineered with interactive sizing visualizers, visual bundle builders, and Shop Pay 1-click checkout.',
  },
  {
    sector: 'Medical Supplies & Life Sciences',
    badge: 'Healthcare Commerce',
    desc: 'Medical equipment, dental supplies, and specialized wellness products. Built with compliant B2B approval workflows, recurring replenishment subscriptions, and verified tax exemption rules.',
  },
  {
    sector: 'Specialty Food, Beverage & CPG',
    badge: 'Food & Beverage',
    desc: 'Regional craft beverage, specialty food, and packaged goods producers. Engineered with cold-chain delivery zone rules, subscription management, and multi-location inventory routing.',
  },
];
...
const PAIN_POINTS = [
  {
    ...
    problem: 'Clunky multi-page checkouts force mobile shoppers to manually type credit cards and addresses, causing high drop-off rates.',
  ...
  },
  {
    ...
    problem: 'Out-of-stock items selling online and orders failing to reach warehouse fulfillment software cause costly operational delays.',
...
const FAQ_ITEMS = [
  {
    category: 'platform',
    question: 'Why do you recommend Shopify and Shopify Plus for Charlotte brands?',
    answer:
  ...
  {
    category: 'pricing',
    question: 'How much does custom e-commerce development cost in Charlotte?',
    answer:
  ...
  },
  {
    ...
    question: 'Can you integrate our Charlotte store with our ERP and 3PL warehouse?',
    answer:
...
const SERVICE_SCHEMA = {
  '@context': 'https://schema.org',
  '@type': 'Service',
  name: 'Charlotte Ecommerce Development Services',
  provider: {
    '@type': 'Organization',
    name: 'FactoryJet',
  ...
  description:
    'Custom Shopify Plus and WooCommerce development for Charlotte brands. Sub-second Core Web Vitals, ERP integrations, and 1-click checkout optimization.',
...
const WEBPAGE_SCHEMA = {
  '@context': 'https://schema.org',
  '@type': 'WebPage',
  name: 'Ecommerce Development Charlotte NC | Shopify & Custom | FactoryJet',
  description: 'Custom Shopify Plus, WooCommerce, and headless commerce stores built for high conversion in Charlotte NC.',
  url: CANONICAL,
...
export default function CharlotteEcommercePage() {
  return (
    <>
      ...
      <main className="platpage">
            ...
            <div className="rv-hero-wrap">
              ...
              <div>
                <div className="rv-badge" style={{ marginBottom: '18px' }}>
                  ...
                  <span>Charlotte Ecommerce Development</span>
                </div>

                <h1 style={{ color: '#141414', margin: '0 0 20px', lineHeight: 1.12, letterSpacing: '-0.03em', fontSize: 'clamp(34px, 5.2vw, 56px)' }}>
                  High-Converting Ecommerce Development in Charlotte NC
                </h1>

                <p className="pp-lead" style={{ color: '#494852', maxWidth: '52ch', margin: '0 0 28px', fontSize: 'clamp(16px, 1.8vw, 18.5px)', lineHeight: 1.6 }}>
                  We engineer high-speed Shopify Plus, WooCommerce, and custom headless commerce stores for Charlotte brands. Built for sub-second mobile speed, Shop Pay 1-click checkout, and robust ERP integration.
                </p>

                <div className="rv-actions">
                  <ModalCTAButton label="Get a Fixed-Price Quote" region="us" btnVariant="primary-dark" />
                  <a href="#charlotte-sectors" className="rv-btn-secondary">
              ...
              <div className="rv-curved-frame-1">
                <Image
                  ...
                  alt="Senior ecommerce engineers reviewing multi-channel inventory sync and Shopify Plus store architecture"
                  width={640}
                  height={640}
                  priority
            ...
            <div className="rv-about-grid">
              ...
              <div className="rv-curved-frame-2">
                <Image
                  ...
                  alt="FactoryJet senior ecommerce development team auditing Charlotte custom theme components"
                  width={640}
                  height={640}
                  style={{ width: '100%', height: '100%', objectFit: 'cover', display: 'block' }}
                />
              ...
              <div>
                ...
                <h2 style={{ fontSize: 'clamp(28px, 4vw, 42px)', fontWeight: 800, color: '#141414', letterSpacing: '-0.025em', lineHeight: 1.15, margin: '0 0 14px' }}>
                  Engineered for Maximum Mobile Conversion in Charlotte
                </h2>
        ...
        {/* ── 04. CHARLOTTE COMMERCE SECTORS DIRECTORY ── */}
        <section id="charlotte-sectors" className="pp-sec" style={{ backgroundColor: '#F6F6F9', borderTop: '1px solid #E6E6EC', borderBottom: '1px solid #E6E6EC' }}>
          <div className="pp-wrap">
            <div style={{ textAlign: 'center', maxWidth: '720px', margin: '0 auto 48px' }}>
              ...
              <h2 style={{ fontSize: 'clamp(28px, 4vw, 44px)', fontWeight: 800, color: '#141414', letterSpacing: '-0.025em', margin: 0 }}>
                E-Commerce Solutions Built for Charlotte Industries
              </h2>
              <p className="pp-lead" style={{ marginTop: '12px', color: '#494852' }}>
                From South End direct-to-consumer lifestyle brands to regional industrial distribution:
              </p>
            </div>

            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '20px' }}>
              {CHARLOTTE_SECTORS.map((s) => (
                <div
                  key={s.sector}
                  style={{
                    background: '#FFFFFF',
        ...
        <section className="pp-sec" style={{ backgroundColor: '#FFFFFF' }}>
          <div className="pp-wrap">
            <div style={{ textAlign: 'center', maxWidth: '720px', margin: '0 auto 48px' }}>
              ...
              <h2 style={{ fontSize: 'clamp(28px, 4vw, 44px)', fontWeight: 800, color: '#141414', letterSpacing: '-0.025em', margin: 0 }}>
                Why Charlotte Brands Choose FactoryJet Ecommerce
              </h2>
              <p className="pp-lead" style={{ marginTop: '12px', color: '#494852' }}>
        ...
        <div id="ecommerce-architecture-blueprint">
          <EnterpriseArchitectureBlueprint
            badge="// CHARLOTTE ECOMMERCE ARCHITECTURE BLUEPRINT"
        ...
        <FAQ
          ...
          headline="Frequently Asked Questions About Ecommerce Development in Charlotte"
        ...
        <section className="pp-sec" style={{ backgroundColor: '#141414', color: '#FFFFFF', padding: 'clamp(64px, 10vh, 112px) 0', textAlign: 'center' }}>
          <div className="pp-wrap" style={{ maxWidth: '800px' }}>
            <div className="rv-badge" style={{ background: '#26262B', color: '#FF5622', borderColor: '#3E3E48', marginBottom: '20px' }}>
              ...
              <span>Fixed-Price Charlotte Ecommerce</span>
            </div>
            
            <h2 style={{ fontSize: 'clamp(32px, 5vw, 54px)', fontWeight: 800, color: '#FFFFFF', letterSpacing: '-0.03em', lineHeight: 1.12, margin: '0 0 20px' }}>
              Ready to Upgrade Your Charlotte Online Store?
            </h2>
