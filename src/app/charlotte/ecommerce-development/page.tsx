...
export const metadata: Metadata = {
  ...
  description: "Shopify developer in Charlotte NC: stores live in 7 days, fixed-price. Banking capital e-commerce: Shopify, WooCommerce & AI. 500+ projects. Free audit.",
  openGraph: {
    type: 'website',
    siteName: 'FactoryJet',
    title: 'Top-Rated Shopify Developer Charlotte NC | 7-Day Delivery, Fixed-Price | FactoryJet',
    ...
    <>
      ...
      <main className="bg-fj-cream">
        ...
        <StrategicDarkSection
          ...
          lead={
            "Lyons Den Creative and TradeMark Media handle branding and marketing in Charlotte but don't specialize in Shopify e-commerce. Elevation Web and Brand Fuel do e-commerce but quote 8–16 week timelines at enterprise-level rates. National agencies targeting Charlotte (Thrive, WebFX) charge a steep premium with no Charlotte market knowledge.\n\nFactoryJet delivers in 7 days, fixed-price, with deep Charlotte expertise: the NASCAR merchandise ecosystem, Mecklenburg County tax structure, and the banking corridor's premium consumer profile that national agencies overlook entirely."
          }
          pillars={[
            {
            ...
            {
              title: 'Transparent',
              body: 'Fixed pricing on the first call across Shopify, WooCommerce, and headless builds. No discovery fees, no B2B-complexity surcharges, no Phase 2 invoices after launch.',
            },
            {
              title: 'Guaranteed',
        ...
        <ComparisonTable
          ...
          lead={
            "Charlotte's agency market focuses heavily on marketing and branding, few specialize in Shopify e-commerce. Elevation Web and Brand Fuel do Shopify but charge enterprise-level rates with 8–16 week timelines. National agencies like Thrive charge a steep premium with no Charlotte market knowledge.\n\nFactoryJet delivers a full Shopify store in 7 days, fixed-price, with NASCAR commerce expertise and banking-corridor B2B capabilities that Charlotte agencies simply don't offer."
          }
          columns={[
            { label: 'Their pricing' },
          ...
          rows={[
            {
              ...
              values: [
                'Enterprise-level rates (Shopify-capable, 8–16 week timelines)',
                'Fixed-price · Shopify Standard',
                "Elevation Web builds good Shopify stores but charges mid-market rates with standard timelines. FactoryJet delivers in 7 days, fixed-price, with AI features, NASCAR commerce expertise, and B2B banking-corridor configurations that Elevation Web doesn't offer at this level.",
              ],
            },
            {
              feature: 'Thrive Internet Marketing',
              values: [
                'Hourly rates, no fixed pricing (Fort Worth-based, no Charlotte presence)',
                'Fixed-price · 7-day delivery',
                "Thrive is a Fort Worth digital marketing agency with web development as a side service and no Charlotte market knowledge. FactoryJet delivers in 7 days, fixed-price, with deep Queen City expertise: NASCAR ecosystem, Mecklenburg tax structure, banking corridor consumer profile.",
              ],
            },
          ]}
        />
        ...
        <PricingTiers
          ...
          lead={
            "Charlotte agency rates for a comparable Shopify build run at enterprise-level prices, and national agencies like WebFX quote a steep premium. FactoryJet delivers the same quality at a fraction of the cost: fixed-price, with NASCAR commerce and B2B banking-corridor capabilities, a faster timeline, and a codebase you own outright. Pricing is scoped to your build; the main drivers are product count, integrations, and design complexity, and you get a full quote up front after a free discovery call."
          }
          tiers={[
            {
...
function SchemaScript() {
  return (
    <script
      ...
      dangerouslySetInnerHTML={{ __html: getEcommerceCitySchema('charlotte', FAQ_ITEMS) }}
    />
  );
}
