...
const FAQ_ITEMS = [
  ...
  { category: 'platforms', question: 'What is the best platform for omnichannel commerce?', answer: 'Shopify Plus with POS covers most retail-plus-online brands cleanly. Adobe Commerce suits very large catalogues with complex rules. BigCommerce sits well in the mid-market. Where the requirement is genuinely one engine across many channels, Commerceflo by FactoryJet is built for that. The right answer follows your store count and fulfilment complexity.' },
  ...
  { category: 'connecting', question: 'How do you unify customer loyalty points and gift cards across online and in-store POS?', answer: 'We build unified customer identification middleware using barcode scanning and phone lookups. Loyalty points earned on retail POS purchases instantly credit to the customer’s online account, and digital gift cards or store credit can be redeemed fluidly at physical checkout counters.' },
