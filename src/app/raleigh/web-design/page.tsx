        ...
        "mainEntity": [
          {
            ...
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Pricing is fixed-price and scoped to your build — the main drivers are page count, integrations, and design complexity. Most Raleigh small businesses choose the Starter tier for a clean five-page site, or Growth for a blog CMS and lead capture. Custom builds with e-commerce or AI features are scoped on top. Every project is quoted up front after a free discovery call, so you know the full cost before work starts."
            }
          },
          {
            "@type": "Question",
          ...
          },
          {
            ...
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Forge3 and iFactory are established Raleigh agencies with solid reputations. Neither commits to delivery timelines or fixed pricing in writing. FactoryJet gives you a clear, fixed-price quote up front after a free discovery call, delivers in 7 days in writing, and builds in Next.js rather than WordPress — which means faster load times, no monthly plugin maintenance costs, and a codebase your team can manage without a developer on retainer."
            }
          },
          {
            "@type": "Question",
