...
const SERVICES: Service[] = [
  {
    ...
    imageSide: "right",
    body: [
      "The average UK web design agency still builds on WordPress, charges premium fees for a business website, takes 8–12 weeks to deliver, and hands over a site that scores 60–80 on Google Lighthouse. FactoryJet builds every website on Next.js 15 and Tailwind CSS 4: the same technology stack behind Stripe, Vercel, and Linear, delivering sites that score 90+ on Lighthouse, load in under two seconds, at a fixed price scoped to your build.",
      ...
      "How much does a website cost in the UK? Traditional agencies tend to charge premium fees for both standard and custom builds. FactoryJet works on a fixed-price model scoped to your project, with the main drivers being page count, design depth, and any integrations you need. Every project is quoted up front after a free discovery call, so you know the full cost before work starts. Our pricing is competitive because our AI-augmented development workflow eliminates the inefficiencies that inflate traditional agency costs. And for UK business owners, web design is a legitimate business expense claimable against your corporation tax or income tax with HMRC, reducing the effective cost.",
    ],
  },
  {
    id: "ecommerce",
    ...
    body: [
      ...
      "Shopify charges its own monthly platform subscription and per-transaction card fees on top of any build. Our development pricing is fixed and scoped to your store, with the main drivers being catalogue size, design depth, and the integrations you need, and it typically lands well below what traditional UK Shopify agencies charge. Every project is quoted up front after a free discovery call, so you know the full cost before work starts. Whether you need a new store, a WooCommerce to Shopify migration, a custom Shopify theme, a B2B e-commerce portal, or a headless commerce architecture for maximum speed, we deliver at pricing that makes traditional agencies reconsider their fee structures.",
  ...
  },
  {
    ...
    featured: true,
    body: [
      "The UK has more than 3,000 AI companies, turning over more than £10 billion a year and employing over 60,000 people in AI roles, according to the government's own AI sector study. The growth is real. Adoption inside ordinary businesses is patchier: plenty of UK firms have tried an AI tool, far fewer have wired one into a workflow that runs without somebody watching it. That gap, between AI interest and AI implementation, is where FactoryJet operates. We build one agent with a written job description, connect it to the systems you already run, and prove it works before anyone talks about a second.",
      ...
      "For UK businesses, the barrier to AI adoption has traditionally been cost and complexity. The top barriers cited by UK SMBs are lack of expertise (35%), high costs (30%), and uncertain ROI (25%). We are eliminating all three. Our AI automation services are fixed-price and scoped to the agent you need, with the main drivers being the number of functions, the systems we integrate with, and the depth of automation. Every project is quoted up front after a free discovery call, so you know the full cost before work starts. Our AI integration services connect agents with your existing CRM, ERP, email, and communication tools. And most clients see full ROI within three to six months.",
