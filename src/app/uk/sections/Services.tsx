...
const SERVICES: Service[] = [
  ...
  },
  {
    ...
    body: [
      ...
      "We specialise in Shopify, Shopify Plus, WooCommerce, and headless commerce development. Our builds include UK-specific payment gateway integration (Stripe, PayPal, Klarna, Apple Pay), Royal Mail and DPD shipping configuration, and full e-commerce SEO so your products rank in both Google and AI search results. For UK businesses asking the Shopify vs WooCommerce question: Shopify (5.8 million live sites globally) offers simplicity, reliability, and managed infrastructure out of the box. WooCommerce (4.5 million live sites) provides unlimited customisation on WordPress. We build on both and will recommend what genuinely fits your business model — not what earns us the highest margin.",
      "Shopify pricing in the UK starts from £5–£344 per month for the platform itself, with card processing fees of 1.5–2.2% plus 25p. Our development costs start at £2,000, compared to £8,000–£15,000 from typical UK Shopify agencies. Whether you need a new store, a WooCommerce to Shopify migration, a custom Shopify theme, a B2B e-commerce portal, or a headless commerce architecture for maximum speed, we deliver at pricing that makes traditional UK agencies reconsider their fee structures.",
      ...
      <div style={{ backgroundColor: "#F8FAFC" }}>
        ...
        >
          ...
          >
            ...
            AI-native team, priced 50–60% below the UK agency average, and
