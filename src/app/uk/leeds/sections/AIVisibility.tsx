...
const INFO_CARDS = [
  {
    ...
    description:
      "Full LocalBusiness and Service schema on every page. Your business gets cited when AI systems answer \"who does web design in Leeds?\"",
  },
  {
    badge: "AEO",
      ...
      <div className="mx-auto px-4 sm:px-6 lg:px-8" style={{ maxWidth: "1400px" }}>
        <div className="grid grid-cols-1 lg:grid-cols-[55fr_45fr] gap-12 lg:gap-16 items-start">
          ...
          <div ref={leftRef}>
            ...
            >
              Why AI Search Visibility Is the Biggest Opportunity Leeds
