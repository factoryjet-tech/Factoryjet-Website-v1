            ...
            <div className="lg:sticky lg:top-24">
              <nav aria-label="FAQ categories">
                {CATEGORIES.map((cat, i) => (
                  <a
                    ...
                    href={cat.href}
                    className={[
                      "block py-3 border-b border-gray-200 text-base transition-colors hover:text-[#0052CC]",
                      i === 0
                        ? "border-l-2 border-[#0052CC] pl-3 text-[#0052CC] font-semibold"
                        : "pl-3 text-gray-600",
                    ].join(" ")}
                  >
                    {cat.label}
              ...
              <p className="text-sm text-gray-500 mt-6 leading-relaxed">
                ...
                <a
                  ...
                  className="text-[#0052CC] underline underline-offset-2"
                >
                  Reach out
                </a>{" "}
