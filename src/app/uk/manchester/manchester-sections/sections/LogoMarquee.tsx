...
// ── Logo catalogue ─────────────────────────────────────────────────────────────
const LOGOS = [
  { src: "/images/manchester/logos/logo-tech.svg",          alt: "Technology sector" },
  { src: "/images/manchester/logos/logo-media.svg",         alt: "Media sector" },
  { src: "/images/manchester/logos/logo-finance.svg",       alt: "Finance sector" },
  { src: "/images/manchester/logos/logo-health.svg",        alt: "Health sector" },
  { src: "/images/manchester/logos/logo-manufacturing.svg", alt: "Manufacturing sector" },
  { src: "/images/manchester/logos/logo-retail.svg",        alt: "Retail sector" },
  { src: "/images/manchester/logos/logo-education.svg",     alt: "Education sector" },
  { src: "/images/manchester/logos/logo-logistics.svg",     alt: "Logistics sector" },
  { src: "/images/manchester/logos/logo-legal.svg",         alt: "Legal sector" },
  { src: "/images/manchester/logos/logo-analytics.svg",     alt: "Analytics sector" },
  { src: "/images/manchester/logos/logo-realestate.svg",    alt: "Real estate sector" },
  { src: "/images/manchester/logos/logo-food.svg",          alt: "Food & hospitality sector" },
] as const;
