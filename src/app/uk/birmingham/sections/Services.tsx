...
export default function Services() {
  ...
  // scroll (same timeline, dwell, dots and image scale) is wired by ./ServicesPinFx,
  // which loads GSAP with a dynamic import only at 1024px and wider. Phones, where
  // the panels simply stack, never download or run GSAP for this section.
