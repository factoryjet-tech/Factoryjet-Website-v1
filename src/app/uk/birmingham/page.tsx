...
const CANONICAL = 'https://factoryjet.com/uk/birmingham';
const PAGE_MODIFIED = '2026-08-24';

export const metadata: Metadata = {
  title: 'Web Design Agency Birmingham | Fast Next.js Sites | FactoryJet',
  description:
    'Birmingham web design agency. Custom Next.js websites, sub-second load speeds, mobile conversion flows, and 100% full IP code ownership for Birmingham businesses.',
  alternates: { canonical: CANONICAL },
  openGraph: {
    title: 'Web Design Agency Birmingham | Fast Next.js Sites | FactoryJet',
    description:
      'Custom Next.js web design, e-commerce, and AI search optimization in Birmingham. Sub-second performance and 100% code ownership.',
    url: CANONICAL,
...
const jsonLd = {
  ...
  '@graph': [
    ...
    },
    {
      ...
      url: CANONICAL,
      description: 'Web design, e-commerce, AI agents and AI SEO agency serving Birmingham and the West Midlands.',
      areaServed: {
        '@type': 'City',
        name: 'Birmingham',
      },
    ...
    },
    {
      ...
      url: CANONICAL,
      name: 'Web Design Agency Birmingham | Fast Next.js Sites | FactoryJet',
      ...
      <div className="uk-birmingham-root">
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl mx-auto text-center mb-12">
              ...
              <p className="text-slate-300 mt-4 text-sm leading-relaxed">
                Traditional Birmingham digital agencies sell slow WordPress themes and junior account handlers. FactoryJet delivers deterministic Next.js builds, sub-second performance, and 100% full IP code ownership.
              </p>
            </div>
              ...
              <table className="w-full border-collapse bg-[#1A1A1A] rounded-xl border border-slate-800 text-left text-sm">
                <thead>
                  <tr className="border-b border-slate-800 bg-[#222222]">
                    ...
                    <th className="p-4 font-bold text-slate-400">Traditional Birmingham Agencies</th>
            ...
            <div className="bg-[#1A1A1A] border border-slate-800 rounded-xl p-6">
              <h3 className="text-base font-bold text-white mb-3">Standard Engineering Deliverables on Every Birmingham Build:</h3>
        ...
        <section className="py-12 bg-[#0E0E0E] border-t border-slate-800 text-center">
          <div className="max-w-xl mx-auto px-4">
            <h3 className="text-xl font-bold text-white mb-3">Ready to transform your Birmingham digital presence?</h3>
