...
export const metadata: Metadata = {
  title: "Shopify Developer Portland OR | 7-Day Delivery, Fixed-Price | FactoryJet",
  description: "Top-rated Shopify developer in Portland OR: stores live in 7 days, fixed-price. Oregon has no sales tax. Shopify, WooCommerce & AI. 500+ projects. Free audit.",
  openGraph: {
    type: 'website',
    siteName: 'FactoryJet',
    title: "Shopify Developer Portland OR | 7-Day Delivery, Fixed-Price | FactoryJet",
  ...
  twitter: {
    ...
    title: "Shopify Developer Portland OR | 7-Day Delivery, Fixed-Price | FactoryJet",
    description: "Top-rated Shopify developer in Portland, Oregon: stores live in 7 days, fixed-price. Oregon has NO sales tax — maximize your margins.",
    images: ['https://factoryjet.com/og-default.png'],
  },
  alternates: {
    canonical: 'https://factoryjet.com/portland/ecommerce-development',
    ...
    <>
      ...
      <main className="bg-fj-cream">
        ...
        <ServiceExplanation
          ...
          lead="Portland agencies either charge enterprise-level rates or focus on marketing rather than Shopify development. FactoryJet builds a revenue-generating Shopify store: custom design, Oregon zero-tax configuration (no state tax for OR customers, automated nexus-based collection for out-of-state), AI-powered product discovery, and a Lighthouse 95+ performance score — all in 7 days, fixed-price."
          body={
            <>
              <p>
        ...
        <StrategicDarkSection
          ...
          lead={
            "Instrument (Portland's most prestigious agency) serves Fortune 500 clients at enterprise-level rates. North Studio and Zeal Creative handle brand identity with web development as secondary. PHNX Digital does Shopify but quotes 8–16 week timelines. Caliber Commerce and national agencies ranking for Portland Shopify queries quote multi-month timelines.\n\nFactoryJet delivers in 7 days, fixed-price, with deep Portland market knowledge — Oregon's zero-tax advantage, the outdoor/lifestyle brand ecosystem, and the 'Keep Portland Weird' consumer psychology that drives independent brand loyalty at rates 40% above the national average."
          }
          pillars={[
            {
            ...
            {
              title: 'Transparent',
              body: 'Fixed pricing on the first call, scoped to your build. No discovery fees, no agency-culture surcharges, no Phase 2 invoices after launch.',
            },
            {
              title: 'Guaranteed',
        ...
        <ComparisonTable
          ...
          lead={
            "Portland's agency market skews toward either enterprise (Instrument) or brand identity (North Studio, Zeal Creative). PHNX Digital does Shopify but at enterprise-adjacent timelines. No Portland agency combines 7-day Shopify delivery with AI features and fixed-price scoping.\n\nFactoryJet delivers a full Shopify store in 7 days, fixed-price — with the outdoor brand sophistication and artisan food expertise Portland's independent brands deserve."
          }
          columns={[
            { label: 'Their pricing' },
          ...
          rows={[
            {
              feature: 'Instrument',
              values: [
                'Enterprise-level rates (Fortune 500 enterprise focus only)',
                'Fixed-price · 7-day delivery (Shopify Standard)',
                "Instrument does iconic work for Nike, Google, and Facebook but serves enterprise clients exclusively. FactoryJet serves Portland's independent brand ecosystem: outdoor brands, food artisans, and makers in 7 days, fixed-price, with AI features Instrument doesn't offer in this range.",
              ],
            },
            {
              feature: 'PHNX Digital',
              values: [
                'Enterprise-adjacent rates (Shopify-capable, 8–16 week timelines)',
                'Fixed-price · 7-day delivery',
                "PHNX Digital builds Shopify stores but at timelines and prices designed for larger brands. FactoryJet delivers the same or better Shopify quality in 7 days, fixed-price, with AI-powered features, Oregon zero-tax expertise, and direct engineer access.",
              ],
            },
          ]}
        />
        ...
        <PricingTiers
          ...
          headline="What's Included for Portland E-Commerce Businesses"
          lead={
            "Portland agency rates for a comparable Shopify build run from enterprise-adjacent to full enterprise. FactoryJet delivers the same quality at a fraction of the cost, fixed-price — with Oregon zero-tax configuration, outdoor brand sophistication, and a codebase you own outright. Pricing is scoped to your build; the main drivers are page count, integrations, and design complexity. Every project is quoted up front after a free discovery call, so you know the full cost before work starts. Stores ship in 7 days. No retainer required."
          }
          tiers={[
            {
        ...
        <FAQ
          ...
          items={[
            ...
            },
            {
              ...
              answer:
                "FactoryJet pricing is fixed-price and scoped to your build — the main drivers are page count, integrations, and design complexity. Compared to Portland agencies like PHNX Digital or Instrument, FactoryJet delivers the same quality at a fraction of the cost. Every project is quoted up front after a free discovery call, so you know the full cost before work starts. Every project includes custom design, full development, Oregon tax configuration (zero-tax for OR customers), and 30 days of post-launch support.",
            },
            {
              category: 'local',
            ...
            },
            {
              ...
              answer:
                "Instrument is Portland's most prestigious digital agency — they've done iconic campaigns for Google, Facebook, and Nike. They're excellent, but they serve enterprise Fortune 500 clients at enterprise-level minimums. FactoryJet serves Portland's SMB and growth-stage brands: Shopify stores live in 7 days, fixed-price, with transparent scoping, direct engineer access, and AI-powered features Instrument doesn't offer at any price point in the SMB range.",
            },
            {
              category: 'local',
              question: 'Does my Portland business need Shopify or WooCommerce?',
              answer:
                "For most Portland businesses, Shopify wins — faster launch, lower maintenance cost, better subscription apps for Portland's recurring-revenue brands (coffee, food, apparel), and superior mobile checkout. WooCommerce makes sense if you have a large WordPress site with existing SEO equity or need specific open-source integrations. Both are fixed-price and scoped to your build.",
            },
            {
              category: 'pricing',
