...
export default function FAQ() {
  ...
  return (
    <section
      id="faq"
      aria-label="Frequently asked questions about web design and SEO in Australia"
    ...
    >
      <div className="mx-auto w-full max-w-[1120px] px-6 py-16 sm:px-8 md:py-24">
        ...
        <h2 className="mt-4 max-w-[760px] font-fj-display text-[clamp(24px,3.2vw,38px)] font-bold leading-[1.12] tracking-[-0.02em] text-fj-ink">
          {FAQS.length} questions Australians actually ask about SEO
        </h2>
        ...
        <p className="mt-5 max-w-[720px] font-fj-body text-[16px] leading-[1.7] text-fj-neutral-600">
          ...
          People Also Ask data collected in August 2026. We have not invented any of them,
          including the ones whose honest answer costs us work.
        </p>
