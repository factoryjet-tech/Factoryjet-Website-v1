...
export default function FinalCTA() {
  return (
    <section
      aria-label="Talk to us about your Canberra project"
      className="w-full"
        ...
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-[58%_1fr] lg:gap-16">
          <div>
            ...
            <h2 className="mt-4 font-fj-display text-[clamp(26px,3.4vw,40px)] font-bold leading-[1.12] tracking-[-0.02em] text-white">
              Find out what is actually holding your Canberra site back
            </h2>

            <p className="mt-5 max-w-[600px] font-fj-body text-[16.5px] leading-[1.7] text-[#D9D2CC]">
              Send us the address. We will test it against the WCAG accessibility criteria,
              crawl it for technical faults, and check your Google listing. You get a written
              summary you can act on internally or attach to a tender response. No charge, and
