...
// Leads with the "is this worth doing" question, which is the honest opener for a market
// with real headroom but smaller volumes than Melbourne or Perth.
// Accessibility leads here: it is the question that decides whether a Canberra site is
// fit for purpose, and the one tenders actually ask.
...
export default function FAQ() {
  ...
  return (
    <section
      id="faq"
      aria-label="Frequently asked questions about web design and SEO in Canberra"
    ...
    >
      <div className="mx-auto w-full max-w-[1120px] px-6 py-16 sm:px-8 md:py-24">
        ...
        <h2 className="mt-4 max-w-[760px] font-fj-display text-[clamp(24px,3.2vw,38px)] font-bold leading-[1.12] tracking-[-0.02em] text-fj-ink">
          {FAQS.length} questions Canberra businesses actually ask
        </h2>
        ...
        <p className="mt-5 max-w-[720px] font-fj-body text-[16px] leading-[1.7] text-fj-neutral-600">
          ...
          People Also Ask data collected in August 2026. The accessibility answers describe what
          the standard asks for, not what the law requires of you, which is a question for your
          own legal advice.
        </p>
