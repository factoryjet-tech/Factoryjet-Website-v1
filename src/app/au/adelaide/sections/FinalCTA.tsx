...
export default function FinalCTA() {
  return (
    <section
      aria-label="Talk to us about your Adelaide project"
      className="w-full"
        ...
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-[58%_1fr] lg:gap-16">
          <div>
            ...
            <h2 className="mt-4 font-fj-display text-[clamp(26px,3.4vw,40px)] font-bold leading-[1.12] tracking-[-0.02em] text-white">
              Find out what is actually holding your Adelaide site back
            </h2>

            <p className="mt-5 max-w-[600px] font-fj-body text-[16.5px] leading-[1.7] text-[#D9D2CC]">
              Send us the address. We will crawl the site, check your Google Business Profile,
              and count how many websites link to each business currently holding the Adelaide
              positions you want. You get the real size of the gap in writing, which in this
              city is usually smaller than people expect. No charge, no obligation.
            </p>
            ...
            >
              ...
              <ul className="mt-4 space-y-3">
                {[
                  ...
                  { href: '/au/brisbane', label: 'Web design and SEO in Brisbane' },
