...
const STATS = [
  {
    value: 'Fixed price',
    label: 'scoped to your build, confirmed before work starts',
    microcopy: 'no hourly billing, no scope surprises',
    categoryLabel: 'HOW WE PRICE',
  },
  {
    value: '7 days',
...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer: `Yes. FactoryJet splits project fees into two payments: 50% upfront to begin the project, and 50% on launch day. This is standard across all project tiers. There are no interest charges, no complicated payment schedules. For larger projects, we can discuss milestone-based payment structures. Reach out during your strategy call and we'll find an arrangement that works.`,
    category: 'cost',
  },
    ...
    <>
      ...
      <main>
          ...
          rightSlot={
            <div className="w-full overflow-hidden rounded-2xl border border-fj-neutral-200 bg-white shadow-sm">
              ...
              <div className="border-t border-fj-neutral-100 bg-fj-neutral-50 px-7 py-5">
                ...
                >
                  Fixed price, scoped to your build. Delivered in 7 days. No hourly billing.
                </p>
              </div>
            </div>
          }
        ...
        <BigThreeTrustBlock
          ...
          headline="Custom-designed websites, fixed price scoped to your build. Delivered in 7 days. Milestone-paid."
        />
          ...
          <div className="max-w-6xl mx-auto px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <a href="/blog/nyc-b2b-corporate-web-design-guide-2026" className="block p-5 rounded-lg border border-[#E5E5E0] bg-white hover:border-[#F05A28] transition-colors">
                <p className="text-sm font-semibold text-[#0F0F12] leading-snug">NYC B2B corporate web design: lessons from 2026 builds</p>
              </a>
              <a href="/blog/custom-web-development-vs-wordpress-us-small-business-2026" className="block p-5 rounded-lg border border-[#E5E5E0] bg-white hover:border-[#F05A28] transition-colors">
                <p className="text-sm font-semibold text-[#0F0F12] leading-snug">Custom web development vs WordPress: small business decision guide</p>
              </a>
            </div>
          </div>
        </section>
