...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'custom ecommerce development mumbai',
    'affordable ecommerce development mumbai',
    'ecommerce website cost mumbai',
    'd2c website mumbai',
    'razorpay shopify mumbai',
    'ai ecommerce development mumbai',
    'whatsapp commerce mumbai',
    'fashion ecommerce mumbai',
    'jewellery ecommerce website mumbai',
    'b2b ecommerce mumbai',
  ],
  openGraph: {
    type: 'website',
    siteName: 'FactoryJet',
  ...
  alternates: {
    canonical: 'https://factoryjet.com/services/ecommerce-development/mumbai',
    languages: ecommerceCityAlternatesIN['mumbai'],
  },
  robots: {
    index: true,
    follow: true,
...
const faqSchema = {
  ...
  mainEntity: [
    {
      '@type': 'Question',
      name: 'How long does it take to launch a Mumbai ecommerce store?',
      acceptedAnswer: {
        '@type': 'Answer',
    ...
    {
      '@type': 'Question',
      name: 'How much does ecommerce development cost in Mumbai?',
      acceptedAnswer: {
        '@type': 'Answer',
    ...
    {
      '@type': 'Question',
      name: 'Will my Mumbai ecommerce store rank on Google?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Every store we build includes technical SEO from day one: Product and BreadcrumbList schema for Google Shopping eligibility, optimised title and meta templates, canonical URLs, GST price display, Core Web Vitals green on mobile (LCP under 2.5s, CLS below 0.1), and sitemap submission to Google Search Console. LocalBusiness schema with Mumbai geo-coordinates is included for local search visibility.',
      },
    },
    {
      '@type': 'Question',
      name: 'Who is the best ecommerce development company in Mumbai?',
      acceptedAnswer: { '@type': 'Answer', text: 'For D2C brands and small businesses, FactoryJet makes a strong case: fixed written prices, senior engineers, and stores that launch in weeks. Any ecommerce website development company in Mumbai — or any ecommerce solution company in Mumbai — should pass three checks: who writes the code, is the price fixed, and do you own the store at the end. That is how to find the best ecommerce website development company in Mumbai and the best ecommerce solution company in Mumbai for your catalog.' },
    },
    {
      '@type': 'Question',
      name: 'Should I hire ecommerce developer in Mumbai or use an agency?',
      acceptedAnswer: { '@type': 'Answer', text: 'One developer can build a basic store, but a real shop needs design, payments, shipping, and SEO together. A small senior team covers all of it at a fixed price. If you do hire ecommerce developer in Mumbai directly, check store speed scores from their past work first.' },
    },
],
};
...
const MUMBAI_ECOM_STAGES: ServiceJourneyStage[] = [
  {
    number: '01',
...
const MUMBAI_ECOM_FAQ_CATEGORIES = [
...
const MUMBAI_ECOM_FAQ_ITEMS = [

  /* ── Pricing & Timeline ── */
  {
    category: 'pricing',
    question: 'How long does it take to launch a Mumbai ecommerce store?',
    answer:
      'FactoryJet delivers standard Shopify and WooCommerce stores in 7 business days for Starter and Growth builds. Day 1 is a discovery call to finalise your catalogue, payment preferences, and logistics setup. Days 2–3 are Figma design and mockup approval. Days 3–5 are development and integration. Day 6 is QA and Lighthouse testing. Day 7 is launch. Custom platform and marketplace builds take longer, usually 8 to 16 weeks depending on scope.',
  },
  {
    category: 'pricing',
    question: 'How much does ecommerce development cost in Mumbai?',
    answer:
      "FactoryJet ecommerce projects are fixed-price and scoped to your build. The main cost drivers are your platform (Shopify or WooCommerce vs a custom build), number of products, the payment and shipping integrations you need, and any custom features like subscriptions or B2B pricing. Every project is quoted up front after a free discovery call, so you know the full cost before any work starts. The price is fixed and confirmed in writing — no hourly billing and no scope creep.",
  },
  {
  ...
  {
    category: 'platform',
    question: 'Can you connect my Mumbai store to Amazon India and Flipkart?',
    answer:
  ...
  {
    category: 'india',
    question: 'Can you add Hindi or Marathi language support to my store?',
    answer:
  ...
  {
    category: 'seo',
    question: 'Will my Mumbai ecommerce store rank on Google?',
    answer:
      'Every store we build includes technical SEO from day one: Product and BreadcrumbList schema for Google Shopping eligibility, optimised title and meta templates, canonical URLs to prevent duplicate content (a common Shopify and WooCommerce issue), GST price display, Core Web Vitals green on mobile, and sitemap submission to Google Search Console. LocalBusiness schema with Mumbai geo-coordinates is included for local search visibility.',
  },
  {
    category: 'seo',
  ...
  {
    category: 'seo',
    question: 'Can you optimise an existing Mumbai store that is already slow?',
    answer:
  ...
  {
    category: 'trust',
    question: 'Do you offer post-launch maintenance for Mumbai stores?',
    answer:
  ...
  {
    category: 'pricing',
    question: 'Who is the best ecommerce development company in Mumbai?',
    answer:
      'For D2C brands and small businesses, FactoryJet makes a strong case: fixed written prices, senior engineers, and stores that launch in weeks. Any ecommerce website development company in Mumbai — or any ecommerce solution company in Mumbai — should pass three checks: who writes the code, is the price fixed, and do you own the store at the end. That is how to find the best ecommerce website development company in Mumbai and the best ecommerce solution company in Mumbai for your catalog.',
  },
  {
    category: 'pricing',
    question: 'Should I hire ecommerce developer in Mumbai or use an agency?',
    answer:
      'One developer can build a basic store, but a real shop needs design, payments, shipping, and SEO together. A small senior team covers all of it at a fixed price. If you do hire ecommerce developer in Mumbai directly, check store speed scores from their past work first.',
  },
];
...
const speakableSchema = {
  '@context': 'https://schema.org',
  '@type': 'WebPage',
  '@id': 'https://factoryjet.com/services/ecommerce-development/mumbai#webpage',
  speakable: {
...
export default function MumbaiEcommercePage() {
  return (
    <>
      <script
        id="mumbai-ecom-faq-schema"
        type="application/ld+json"
        dangerouslySetInnerHTML={{ __html: JSON.stringify(faqSchema) }}
      />
      <script
        id="mumbai-ecom-service-schema"
        type="application/ld+json"
        dangerouslySetInnerHTML={{ __html: JSON.stringify(serviceSchema) }}
      />
      <script
        id="mumbai-ecom-local-schema"
        type="application/ld+json"
      ...
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Mumbai', url: 'https://factoryjet.com/services/ecommerce-development/mumbai' },
        ]}
      />
      ...
      <main className="bg-fj-cream">
        ...
        {/* ── 1. HERO ──────────────────────────────────────────────────────── */}
        <Hero
        formSlot={<HeroInlineForm region="in" source="services_ecommerce_development_mumbai_hero" />}
          eyebrow="ECOMMERCE DEVELOPMENT · MUMBAI"
          headline="Mumbai's Most Trusted Ecommerce Agency — Store Live in 7 Days"
          lead="FactoryJet builds Shopify, WooCommerce, and custom D2C stores for Mumbai brands — Razorpay and UPI integrated, GST-compliant, Shiprocket connected, and Lighthouse 90+ before we hand you the keys. 7-day delivery guarantee."
        ...
        <ServiceExplanation
          eyebrow="ECOMMERCE DEVELOPMENT · MUMBAI"
          headline="The Right Platform for Every Mumbai Business Model"
          lead="Mumbai's ecommerce market spans D2C fashion brands in Bandra, B2B exporters in SEEPZ, FMCG distributors in Bhiwandi, and jewellery houses in Zaveri Bazaar. Each needs a different platform strategy. FactoryJet recommends the right one — before we quote."
          body={
            <>
        ...
        <StrategicDarkSection
          ...
          lead="Mumbai ecommerce agencies often charge several times more for a comparable project and take 10 to 20 weeks to deliver, usually without telling you the price upfront. FactoryJet gives you a fixed quote before you speak to us, guarantees 7-day delivery in writing, and builds to Lighthouse 90+ on mobile. The price is fixed and confirmed in writing, and the codebase is yours to keep."
          pillars={[
            {
              icon: '⚡',
              title: '7-day delivery. In writing. Or you do not pay the balance.',
              body: "Mumbai's market moves fast. Waiting 16 weeks for an agency to deliver a store you briefed in April is not a plan — it is a liability. FactoryJet delivers Shopify and WooCommerce stores in 7 days, with the guarantee written into the project agreement. We have delivered on time for 97% of all builds.",
            },
            {
              icon: '📱',
              title: "India's ecommerce is 65% mobile. Most stores are not built for it.",
              body: 'Most Mumbai ecommerce stores are designed on a desktop and adapted down. The result: 0.4% mobile conversion rates on template stores versus 2.1% on properly designed custom builds. FactoryJet designs every store mobile-first at 375px — tap targets, product image sizing, checkout flow, and UPI placement all optimised for the phone your customer actually uses.',
            },
            {
              icon: '📋',
        ...
        <ServiceJourneyRow
          ...
          stages={MUMBAI_ECOM_STAGES}
          closingNote="5 STAGES · 7 DAYS · RAZORPAY + GST + SHIPROCKET · LIGHTHOUSE 90+ · ZERO-DOWNTIME LAUNCH"
        />

        {/* ── 7. CITY CONTEXT ──────────────────────────────────────────────── */}
        <CityContextSection
          eyebrow="MUMBAI ECOMMERCE MARKET"
          headline="Why Mumbai Is India's Most Competitive Ecommerce Market"
          leadParagraphs={[
            "Mumbai drives more ecommerce transactions than any other Indian city. The Bandra-Kurla Complex houses the Indian headquarters of every global logistics, payment, and retail technology company. Andheri East and Goregaon are home to India's largest garment and lifestyle brand operations. Dharavi — often called the world's largest informal manufacturing cluster — is undergoing rapid digital commerce adoption, with thousands of leather goods, textile, and pottery manufacturers launching online stores for the first time.",
            "Mumbai's ecommerce verticals are as diverse as the city itself. Zaveri Bazaar jewellers are building direct-to-consumer Shopify stores with COD and Razorpay Turbo checkout. Fashion brands from Linking Road and Bandra are running omnichannel operations across their own store, Instagram Shop, and Myntra simultaneously. FMCG distributors in Bhiwandi are building B2B portals with tiered dealer pricing and GST-split invoicing. And D2C supplement and beauty brands in Malad and Goregaon are scaling subscription commerce to ₹5 crore annual run rates.",
            "The brands winning in Mumbai's ecommerce market are not the ones with the biggest marketing budgets — they are the ones with the fastest stores, the cleanest checkout experience, and the most India-ready payment stack. FactoryJet has built for all of these verticals and knows exactly what each one needs before the first discovery call.",
          ]}
          stats={[
            {
              value: '₹12.5L Cr',
            ...
            {
              value: '3.5L+',
              label: 'Registered businesses in Mumbai — India\'s densest commercial ecosystem',
          ...
          sectors={[
            {
              ...
              description:
                "Mumbai is India's fashion capital — home to Linking Road, Hill Road, and the largest garment export cluster in Asia at SEEPZ. D2C fashion brands need Shopify stores with AI size recommendations, try-before-you-buy flows, WhatsApp-native lookbooks, and Myntra + Instagram Shop integration. B2B exporters need order management portals with buyer-specific pricing and digital tech-pack uploads.",
              example:
                'D2C fashion brands in Bandra and Andheri, ethnic wear labels, garment exporters in SEEPZ targeting US, EU, and Middle East buyers.',
            },
            {
              name: 'Jewellery & Luxury',
              description:
                "Zaveri Bazaar is India's largest jewellery market and is rapidly going digital. Jewellery ecommerce requires hallmark compliance display, video consultation booking, COD with insured shipping options, and high-trust checkout design. B2B gold and diamond dealers need private catalogues with RTGS payment flows and GST B2B invoicing.",
              example:
                'Jewellery retailers in Zaveri Bazaar and Dhantoli, custom jewellery brands targeting NRI buyers, B2B diamond and gemstone traders.',
            },
            {
              name: 'FMCG & Grocery',
              description:
                "Bhiwandi and Navi Mumbai house thousands of FMCG distributors and manufacturers scaling online. FMCG ecommerce needs FSSAI-compliant labelling, subscription replenishment flows, hyperlocal delivery routing, and retail distributor portals with territory-based pricing.",
              example:
                'FMCG brands in Bhiwandi and Turbhe, direct-to-consumer grocery and health food brands, subscription box companies.',
            },
            {
              name: 'Pharmaceuticals & Health',
              description:
                "Mumbai houses India's largest pharma export cluster in Andheri and Malad. Online pharmacy stores require prescription upload flows, CDSCO-compliant product pages, temperature-sensitive logistics integration, and B2B procurement portals for hospital and clinic buyers.",
              example:
                'Pharmaceutical exporters in MIDC Andheri, OTC health brands, ayurvedic and wellness D2C brands, B2B pharma distributors.',
            },
            {
              name: 'Electronics & Tech',
              description:
                "Lamington Road and SP Road are India's original electronics retail corridors now going digital. Electronics ecommerce requires EMI checkout at the product page level, warranty registration flows, service centre integration, and complex specification filtering for technical buyers.",
              example:
                'Electronics retailers in Lamington Road and SP Road, component suppliers, consumer electronics D2C brands, IT hardware distributors.',
            },
            {
              name: 'Home, Décor & Lifestyle',
              description:
                "Mumbai's premium interior market — Pali Hill, Powai, and Worli — is driving demand for high-AOV home décor ecommerce. These stores need AR product preview, room visualiser integrations, white-glove delivery options, and a product discovery experience designed for considered purchases with ₹10,000+ AOV.",
              example:
                'Home décor brands, furniture companies, art and gifting stores, premium lifestyle brands targeting Mumbai\'s upper-middle and luxury segments.',
            },
          ]}
        />
        ...
        <PortfolioShowcase
          eyebrow="RECENT WORK"
          headline="Mumbai brands we have launched."
          cards={[
            {
              industry: 'Home Décor · Shopify',
              title: 'Belle Maison — Mumbai',
              description:
                'Belle Maison is a premium interior décor brand based in Mumbai. FactoryJet built their Shopify store with a Figma-designed product showcase, Razorpay integration, WhatsApp inquiry flow, and Shiprocket connected on day one. Launched in 7 days.',
        ...
        <FAQ
          ...
          headline="Everything Mumbai Founders Ask Before They Sign"
          lead="The questions we answer on every Mumbai ecommerce discovery call — answered here, without the runaround."
          categories={MUMBAI_ECOM_FAQ_CATEGORIES}
          items={MUMBAI_ECOM_FAQ_ITEMS}
        />
        ...
        <FinalCTA
          ...
          headline="Your Mumbai Ecommerce Store. Live in 7 Days."
