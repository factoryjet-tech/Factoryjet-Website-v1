...
export const metadata: Metadata = {
  ...
  description:
    'Shopify, WooCommerce & AI-native stores for Mumbai brands. From ₹59,999. Razorpay, UPI & COD. GST-compliant. Shiprocket integrated. 7-day delivery.',
  keywords: [
  ...
  openGraph: {
    type: 'website',
    siteName: 'FactoryJet',
    title: 'Ecommerce Development Company in Mumbai | From ₹59,999 | FactoryJet',
    description:
      'Shopify, WooCommerce, D2C, and AI-native ecommerce stores for Mumbai businesses. Razorpay + UPI + COD integrated. GST-compliant. 7-day delivery. From ₹59,999.',
  ...
  twitter: {
    ...
    title: 'Ecommerce Development Mumbai | From ₹59,999 | FactoryJet',
    description:
      'Shopify, WooCommerce & AI ecommerce for Mumbai brands. Razorpay + GST + Shiprocket. From ₹59,999.',
...
const localBusinessSchema = {
  ...
  description:
    'Ecommerce development company serving Mumbai businesses. Shopify, WooCommerce, and custom stores. Razorpay + UPI + COD integrated. GST-compliant. 7-day delivery. From ₹59,999.',
  address: {
    '@type': 'PostalAddress',
    addressLocality: 'Mumbai',
    addressRegion: 'Maharashtra',
    ...
    <>
      ...
      <main className="bg-fj-cream">
        ...
        <Hero
          ...
          lead="FactoryJet builds Shopify, WooCommerce, and custom D2C stores for Mumbai brands — Razorpay and UPI integrated, GST-compliant, Shiprocket connected, and Lighthouse 90+ before we hand you the keys. From ₹59,999. 7-day delivery guarantee."
        ...
        <div id="pricing">
          <PricingTiers
            ...
            headline="Ecommerce Plans for Every Mumbai Business Stage"
            lead="Mumbai agency rates for comparable ecommerce projects run ₹2,00,000–₹10,00,000. FactoryJet Growth (₹99,999) delivers a full-featured Shopify or WooCommerce store with subscriptions, B2B pricing, omnichannel integrations, Razorpay, GST invoicing, and a 7-day delivery guarantee — with a codebase you own outright."
            tiers={[
              {
                name: 'Starter Store',
                priceRange: 'From ₹59,999',
                description:
                  'A professionally designed Shopify or WooCommerce store ready to sell on launch day. The right starting point for D2C brands and Mumbai retailers going online for the first time.',
                features: [
              ...
              },
              {
                ...
                description:
                  'A full-featured store with subscription logic, B2B pricing, a product configurator, or multi-channel inventory sync — for Mumbai brands with more complex selling models.',
                features: [
