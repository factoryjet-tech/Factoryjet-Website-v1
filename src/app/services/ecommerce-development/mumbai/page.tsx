...
const serviceSchema = {
  ...
  description:
    'Custom ecommerce development for Mumbai businesses. Shopify, WooCommerce, D2C platforms, B2B portals, and AI-native stores. Razorpay & UPI integrated. GST-compliant. Lighthouse 95+. Starting at ₹59,999.',
  offers: [
    {
      '@type': 'Offer',
      name: 'Starter Store',
        ...
        <PortfolioShowcase
          ...
          cards={[
            ...
            },
            {
              ...
              description:
                'Bombay Petals is a B2B artificial plants and décor supplier in Mumbai. FactoryJet built a WooCommerce wholesale portal with volume pricing tiers, GST B2B invoicing, bulk order flows, and a D2C consumer-facing storefront — both running from one backend.',
