...
const faqSchema = {
  ...
  mainEntity: [
    ...
    {
      '@type': 'Question',
      name: 'Who is the best ecommerce development company in Hyderabad?',
      acceptedAnswer: { '@type': 'Answer', text: 'For D2C brands and small businesses, FactoryJet makes a strong case: fixed written prices, senior engineers, and stores that launch in weeks. Any ecommerce website development company in Hyderabad — or any ecommerce solution company in Hyderabad — should pass three checks: who writes the code, is the price fixed, and do you own the store at the end. That is how to find the best ecommerce website development company in Hyderabad and the best ecommerce solution company in Hyderabad for your catalog.' },
    },
    {
      '@type': 'Question',
      name: 'Should I hire ecommerce developer in Hyderabad or use an agency?',
      acceptedAnswer: { '@type': 'Answer', text: 'One developer can build a basic store, but a real shop needs design, payments, shipping, and SEO together. A small senior team covers all of it at a fixed price. If you do hire ecommerce developer in Hyderabad directly, check store speed scores from their past work first.' },
    },
],
};
...
const HYDERABAD_ECOM_FAQ_ITEMS = [
  ...
  {
    category: 'pricing',
    question: 'Who is the best ecommerce development company in Hyderabad?',
    answer:
      'For D2C brands and small businesses, FactoryJet makes a strong case: fixed written prices, senior engineers, and stores that launch in weeks. Any ecommerce website development company in Hyderabad — or any ecommerce solution company in Hyderabad — should pass three checks: who writes the code, is the price fixed, and do you own the store at the end. That is how to find the best ecommerce website development company in Hyderabad and the best ecommerce solution company in Hyderabad for your catalog.',
  },
  {
    category: 'pricing',
    question: 'Should I hire ecommerce developer in Hyderabad or use an agency?',
    answer:
      'One developer can build a basic store, but a real shop needs design, payments, shipping, and SEO together. A small senior team covers all of it at a fixed price. If you do hire ecommerce developer in Hyderabad directly, check store speed scores from their past work first.',
  },
];
          ...
          pillars={[
            {
              ...
              body: "Hyderabad's market moves fast. Waiting 16 weeks for an agency to deliver a store you briefed in April is not a plan — it is a liability. FactoryJet delivers Shopify and WooCommerce stores in 7 days, with the guarantee written into the project agreement. We have delivered on time for 97% of all builds.",
            },
            {
              icon: '📱',
