...
export const metadata: Metadata = {
  title: 'Ecommerce Development Company in Lucknow | From ₹59,999 | Shopify, WooCommerce & Custom Stores | FactoryJet',
  description:
  ...
  openGraph: {
    type: 'website',
    siteName: 'FactoryJet',
    title: 'Ecommerce Development Company in Lucknow | From ₹59,999 | FactoryJet',
    description:
      'Shopify, WooCommerce, D2C, and custom ecommerce stores for Lucknow businesses. Razorpay + UPI + COD integrated. GST-compliant. 7-day delivery. From ₹59,999.',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'FactoryJet — Ecommerce Development Company in Lucknow',
      },
    ],
    locale: 'en_IN',
  },
  twitter: {
    ...
    title: 'Ecommerce Development Lucknow | From ₹59,999 | FactoryJet',
    description:
      'Shopify, WooCommerce & custom ecommerce for Lucknow brands. Razorpay + GST + Shiprocket. From ₹59,999.',
...
const serviceSchema = {
  ...
  description:
    'Custom ecommerce development for Lucknow businesses. Shopify, WooCommerce, D2C platforms, B2B portals, and custom stores. Razorpay & UPI integrated. GST-compliant. Lighthouse 95+. Starting at ₹59,999.',
  offers: [
    {
      '@type': 'Offer',
      name: 'Starter Store',
...
const localBusinessSchema = {
  ...
  description:
    'Ecommerce development company serving Lucknow businesses. Shopify, WooCommerce, and custom stores. Razorpay + UPI + COD integrated. GST-compliant. 7-day delivery. From ₹59,999.',
  address: {
    '@type': 'PostalAddress',
    addressLocality: 'Lucknow',
    addressRegion: 'Uttar Pradesh',
    ...
    <>
      ...
      <main className="bg-fj-cream">
        ...
        <Hero
          ...
          lead="FactoryJet builds Shopify, WooCommerce, and custom D2C stores for Lucknow brands — Razorpay and UPI integrated, GST-compliant, Shiprocket connected, and Lighthouse 90+ before we hand you the keys. From ₹59,999. 7-day delivery guarantee."
        ...
        <StrategicDarkSection
          ...
          lead="Lucknow ecommerce agencies typically charge ₹2,00,000–₹10,00,000 for a comparable project and take 10–20 weeks to deliver. FactoryJet publishes all three tiers before you speak to us, guarantees 7-day delivery in writing, and builds to Lighthouse 90+ on mobile. At 50–60% below the Lucknow agency benchmark for the same scope."
          pillars={[
            {
              icon: '⚡',
              title: '7-day delivery. In writing. Or you do not pay the balance.',
              body: "Lucknow's market moves fast. Waiting 16 weeks for an agency to deliver a store you briefed in April is not a plan — it is a liability. FactoryJet delivers Shopify and WooCommerce stores in 7 days, with the guarantee written into the project agreement. We have delivered on time for 97% of all builds since 2005.",
            },
            {
              icon: '📱',
        ...
        <div id="pricing">
          <PricingTiers
            ...
            headline="Ecommerce Plans for Every Lucknow Business Stage"
            lead="Lucknow agency rates for comparable ecommerce projects run ₹2,00,000–₹10,00,000. FactoryJet Growth (₹99,999) delivers a full-featured Shopify or WooCommerce store with subscriptions, B2B pricing, omnichannel integrations, Razorpay, GST invoicing, and a 7-day delivery guarantee — with a codebase you own outright."
            tiers={[
              {
                name: 'Starter Store',
                priceRange: 'From ₹59,999',
                description:
                  'A professionally designed Shopify or WooCommerce store ready to sell on launch day. The right starting point for D2C brands and Lucknow retailers going online for the first time.',
                features: [
              ...
              },
              {
                ...
                description:
                  'A full-featured store with subscription logic, B2B pricing, a product configurator, or multi-channel inventory sync — for Lucknow brands with more complex selling models.',
                features: [
              ...
              },
              {
                ...
                features: [
                  ...
                  'Regional language support (Hindi, Urdu + more)',
