...
const serviceSchema = {
  ...
  description:
    'Custom ecommerce development for Delhi businesses. Shopify, WooCommerce, D2C platforms, B2B portals, and custom stores. Razorpay & UPI integrated. GST-compliant. Lighthouse 95+. Starting at ₹59,999.',
};
    ...
    <>
      ...
      <main className="bg-fj-cream">
        ...
        <StrategicDarkSection
          ...
          lead="Delhi ecommerce agencies typically charge ₹2,00,000–₹10,00,000 for a comparable project and take 10–20 weeks to deliver. FactoryJet publishes all three tiers before you speak to us, guarantees 7-day delivery in writing, and builds to Lighthouse 90+ on mobile. All at a fixed, published price — with the codebase yours to keep."
          pillars={[
            {
              icon: '⚡',
