...
export const metadata: Metadata = {
  title: 'Ecommerce Development Company in Kochi | From ₹59,999 | Shopify, WooCommerce & Custom Stores | FactoryJet',
  description:
  ...
  openGraph: {
    type: 'website',
    siteName: 'FactoryJet',
    title: 'Ecommerce Development Company in Kochi | From ₹59,999 | FactoryJet',
    description:
      'Shopify, WooCommerce, D2C, and custom ecommerce stores for Kochi businesses. Razorpay + UPI + COD integrated. GST-compliant. 7-day delivery. From ₹59,999.',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'FactoryJet — Ecommerce Development Company in Kochi',
      },
    ],
    locale: 'en_IN',
  },
  twitter: {
    ...
    title: 'Ecommerce Development Kochi | From ₹59,999 | FactoryJet',
    description:
      'Shopify, WooCommerce & custom ecommerce for Kochi brands. Razorpay + GST + Shiprocket. From ₹59,999.',
...
const localBusinessSchema = {
  ...
  description:
    'Ecommerce development company serving Kochi businesses. Shopify, WooCommerce, and custom stores. Razorpay + UPI + COD integrated. GST-compliant. 7-day delivery. From ₹59,999.',
  address: {
    '@type': 'PostalAddress',
    addressLocality: 'Kochi',
    addressRegion: 'Kerala',
    ...
    <>
      ...
      <main className="bg-fj-cream">
        ...
        <Hero
          ...
          lead="FactoryJet builds Shopify, WooCommerce, and custom D2C stores for Kochi brands — Razorpay and UPI integrated, GST-compliant, Shiprocket connected, and Lighthouse 90+ before we hand you the keys. From ₹59,999. 7-day delivery guarantee."
        ...
        <div id="pricing">
          <PricingTiers
            ...
            headline="Ecommerce Plans for Every Kochi Business Stage"
            lead="Kochi agency rates for comparable ecommerce projects run ₹2,00,000–₹10,00,000. FactoryJet Growth (₹99,999) delivers a full-featured Shopify or WooCommerce store with subscriptions, B2B pricing, omnichannel integrations, Razorpay, GST invoicing, and a 7-day delivery guarantee — with a codebase you own outright."
            tiers={[
              {
                name: 'Starter Store',
                priceRange: 'From ₹59,999',
                description:
                  'A professionally designed Shopify or WooCommerce store ready to sell on launch day. The right starting point for D2C brands and Kochi retailers going online for the first time.',
                features: [
              ...
              },
              {
                ...
                description:
                  'A full-featured store with subscription logic, B2B pricing, a product configurator, or multi-channel inventory sync — for Kochi brands with more complex selling models.',
                features: [
              ...
              },
              {
                ...
                features: [
                  ...
                  'Regional language support (Malayalam, Hindi + more)',
