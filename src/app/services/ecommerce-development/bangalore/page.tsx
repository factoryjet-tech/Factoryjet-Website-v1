...
export const metadata: Metadata = {
  ...
  description:
    'Shopify & WooCommerce stores for Bangalore brands. From ₹59,999. Razorpay, UPI & COD. GST-compliant. Shiprocket integrated. 7-day delivery guarantee.',
  keywords: [
  ...
  openGraph: {
    type: 'website',
    siteName: 'FactoryJet',
    title: 'Ecommerce Development Company in Bangalore | From ₹59,999 | FactoryJet',
    description:
      'Shopify, WooCommerce, D2C, and custom ecommerce stores for Bangalore businesses. Razorpay + UPI + COD integrated. GST-compliant. 7-day delivery. From ₹59,999.',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'FactoryJet — Ecommerce Development Company in Bangalore',
      },
    ],
    locale: 'en_IN',
  },
  twitter: {
    ...
    title: 'Ecommerce Development Bangalore | From ₹59,999 | FactoryJet',
    description:
      'Shopify, WooCommerce & custom ecommerce for Bangalore brands. Razorpay + GST + Shiprocket. From ₹59,999.',
...
const faqSchema = {
  ...
  mainEntity: [
    {
      '@type': 'Question',
      name: 'How long does it take to launch a Bangalore ecommerce store?',
      acceptedAnswer: {
        '@type': 'Answer',
    ...
    {
      '@type': 'Question',
      name: 'Will my Bangalore ecommerce store rank on Google?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Every store we build includes technical SEO from day one: Product and BreadcrumbList schema for Google Shopping eligibility, optimised title and meta templates, canonical URLs, GST price display, Core Web Vitals green on mobile (LCP under 2.5s, CLS below 0.1), and sitemap submission to Google Search Console. LocalBusiness schema with Bangalore geo-coordinates is included for local search visibility.',
      },
    },
  ],
};
...
const localBusinessSchema = {
  ...
  description:
    'Ecommerce development company serving Bangalore businesses. Shopify, WooCommerce, and custom stores. Razorpay + UPI + COD integrated. GST-compliant. 7-day delivery. From ₹59,999.',
  address: {
    '@type': 'PostalAddress',
    addressLocality: 'Bangalore',
    addressRegion: 'Karnataka',
    ...
    <>
      ...
      <main className="bg-fj-cream">
        ...
        <Hero
          ...
          lead="FactoryJet builds Shopify, WooCommerce, and custom D2C stores for Bangalore brands — Razorpay and UPI integrated, GST-compliant, Shiprocket connected, and Lighthouse 90+ before we hand you the keys. From ₹59,999. 7-day delivery guarantee."
        ...
        <StrategicDarkSection
          ...
          lead="Bangalore ecommerce agencies typically charge ₹2,00,000–₹10,00,000 for a comparable project and take 10–20 weeks to deliver — without publishing their pricing upfront. FactoryJet publishes all three tiers before you speak to us, guarantees 7-day delivery in writing, and builds to Lighthouse 90+ on mobile. At 50–60% below the Bangalore agency benchmark for the same scope."
          pillars={[
            {
              icon: '⚡',
        ...
        <div id="pricing">
          <PricingTiers
            ...
            headline="Ecommerce Plans for Every Bangalore Business Stage"
            lead="Bangalore agency rates for comparable ecommerce projects run ₹2,00,000–₹10,00,000. FactoryJet Growth (₹99,999) delivers a full-featured Shopify or WooCommerce store with subscriptions, B2B pricing, omnichannel integrations, Razorpay, GST invoicing, and a 7-day delivery guarantee — with a codebase you own outright."
            tiers={[
              {
                name: 'Starter Store',
                priceRange: 'From ₹59,999',
                description:
                  'A professionally designed Shopify or WooCommerce store ready to sell on launch day. The right starting point for D2C brands and Bangalore retailers going online for the first time.',
                features: [
              ...
              },
              {
                ...
                description:
                  'A full-featured store with subscription logic, B2B pricing, a product configurator, or multi-channel inventory sync — for Bangalore brands with more complex selling models.',
                features: [
              ...
              },
              {
                ...
                features: [
                  ...
                  'Regional language support (Kannada, Hindi + more)',
