...
const faqSchema = {
  ...
  mainEntity: [
    ...
    {
      '@type': 'Question',
      name: 'Who is the best ecommerce development company in Bangalore?',
    ...
    {
      '@type': 'Question',
      name: 'Should I hire ecommerce developer in Bangalore or use an agency?',
      acceptedAnswer: { '@type': 'Answer', text: 'One developer can build a basic store, but a real shop needs design, payments, shipping, and SEO together. A small senior team covers all of it at a fixed price. If you do hire ecommerce developer in Bangalore directly, check store speed scores from their past work first.' },
    },
],
};
