...
const faqSchema = {
  ...
  mainEntity: [
    ...
    {
      '@type': 'Question',
      name: 'Who is the best ecommerce development company in Jaipur?',
    ...
    {
      '@type': 'Question',
      name: 'Should I hire ecommerce developer in Jaipur or use an agency?',
      acceptedAnswer: { '@type': 'Answer', text: 'One developer can build a basic store, but a real shop needs design, payments, shipping, and SEO together. A small senior team covers all of it at a fixed price. If you do hire ecommerce developer in Jaipur directly, check store speed scores from their past work first.' },
    },
],
};
          ...
          pillars={[
            {
              ...
              body: "Jaipur's market moves fast. Waiting 16 weeks for an agency to deliver a store you briefed in April is not a plan — it is a liability. FactoryJet delivers Shopify and WooCommerce stores in 7 days, with the guarantee written into the project agreement. We have delivered on time for 97% of all builds.",
            },
            {
              icon: '📱',
