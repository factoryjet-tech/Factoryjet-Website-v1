...
const FAQ_ITEMS: ReadonlyArray<FAQItem> = [
  ...
  },
  {
    ...
    answer: 'Yes. FactoryJet executes formal BAAs with every healthcare client prior to connecting any telephony, server infrastructure, or EHR database endpoints. We also ensure that all upstream cloud hosting providers, telephony gateways, and LLM inference providers have executed binding BAAs.',
  },
  {
    category: 'hipaa',
  ...
  },
  {
    ...
    answer: 'We build custom bi-directional API connectors for leading healthcare and dental systems. These include Epic Systems, Cerner (Oracle Health), AthenaHealth, eClinicalWorks, Allscripts (Veradigm), NextGen Healthcare, Kareo, Dentrix, Eaglesoft, Open Dental, Curve Dental, and ChiroTouch.',
  },
  {
    category: 'ehr',
  ...
  },
  {
    ...
    answer: 'We deploy sub-500 millisecond ultra-low latency voice pipelines using dedicated SIP trunking, Deepgram Nova-2 medical speech recognition, and custom human-like voice synthesis. The AI understands medical terminology, patient interruptions, background noise, and natural conversational cadence without awkward robotic pauses.',
  },
  {
    category: 'clinical',
  ...
  },
  {
    ...
    answer: 'A standard custom healthcare AI agent deployment takes four to six weeks from initial scoping to live pilot. This timeline includes telephony routing configuration, EHR API authentication, custom clinical prompt tuning, staff escalation workflows, and rigorous HIPAA penetration testing.',
  },
  {
    category: 'deployment',
  ...
  },
  {
    ...
    answer: 'Yes. FactoryJet builds custom AI infrastructure that you own and operate. All workflow state machines, telephony routing scripts, API integration connectors, and prompt architectures remain your permanent operational assets with zero proprietary vendor lock-in.',
  },
  {
    category: 'deployment',
    question: 'How does our clinical staff monitor call logs and agent performance?',
    answer: 'We provide an administrative operational dashboard that displays real-time call volume, appointment conversion rates, average handle times, triage escalation logs, and audio quality metrics. Practice managers can review de-identified call summaries and refine appointment scheduling rules at any time.',
  },
];
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="p-8 rounded-2xl bg-[#FAFAF7] border border-[#E7DED6]">
                ...
                <div className="text-sm font-bold text-[#14110F] mb-3">
                  Peak Hours Unanswered Call Rate
                </div>
                <p className="text-sm text-[#46403B] leading-relaxed mb-4">
                  Medical group studies establish that over two-thirds of incoming patient phone calls reach busy signals or voicemail during morning peak hours.
                </p>
                <a
                  href="https://www.mgma.com/data/benchmarking-data"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-xs font-mono text-[#F05A28] hover:underline"
                >
                  Source: MGMA Practice Benchmarks &rarr;
                </a>
              </div>
              ...
              <div className="p-8 rounded-2xl bg-[#FAFAF7] border border-[#E7DED6]">
                ...
                <div className="text-sm font-bold text-[#14110F] mb-3">
                  Annual Lost Revenue Per Dental Chair
                </div>
                <p className="text-sm text-[#46403B] leading-relaxed mb-4">
                  Dental practices lose tens of thousands annually per provider chair in uncaptured after-hours hygiene bookings and emergency toothache calls.
                </p>
                <a
              ...
              <div className="p-8 rounded-2xl bg-[#FAFAF7] border border-[#E7DED6]">
                ...
                <p className="text-sm text-[#46403B] leading-relaxed mb-4">
                  EHR-integrated conversational AI agents match provider appointment templates with high clinical precision while cutting front-desk telephone volume by 62%.
                </p>
                <a
                  ...
                  className="text-xs font-mono text-[#F05A28] hover:underline"
                >
                  Source: Journal of Medical Internet Research &rarr;
                </a>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="p-8 rounded-2xl bg-white border border-[#E7DED6] hover:border-[#F05A28]/50 transition-all shadow-sm">
                ...
                <ul className="space-y-2 text-xs font-mono text-[#6E655F]">
                  <li className="flex items-center gap-2">
                    <span className="text-[#F05A28]">&bull;</span> Zero diagnostic hallucinations
                  </li>
                  <li className="flex items-center gap-2">
              ...
              <div className="p-8 rounded-2xl bg-white border border-[#E7DED6] hover:border-[#F05A28]/50 transition-all shadow-sm">
                ...
                <ul className="space-y-2 text-xs font-mono text-[#6E655F]">
                  ...
                  <li className="flex items-center gap-2">
                    <span className="text-[#F05A28]">&bull;</span> SOC 2 Type II compliant hosting
                  </li>
                  <li className="flex items-center gap-2">
            ...
            <div className="space-y-16">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                ...
                <div className="lg:col-span-6">
                  ...
                  <div className="grid grid-cols-2 gap-4 text-xs font-mono text-[#6E655F] pt-4 border-t border-[#E7DED6]">
                    <div>&bull; Dentrix / Eaglesoft Sync</div>
                    <div>&bull; Hygiene Recall Automation</div>
                    <div>&bull; Emergency Triage Paging</div>
                    <div>&bull; Dental PPO Copay Pre-Check</div>
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                <div className="lg:col-span-6 order-2 lg:order-1">
                  ...
                  <div className="grid grid-cols-2 gap-4 text-xs font-mono text-[#6E655F] pt-4 border-t border-[#E7DED6]">
                    <div>&bull; Epic FHIR R4 Integration</div>
                    <div>&bull; Concurrent Call Scaling</div>
                    <div>&bull; Referral Intake Parsing</div>
                    <div>&bull; Clinical Lab Inquiry Routing</div>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                ...
                <div className="lg:col-span-6">
                  ...
                  <div className="grid grid-cols-2 gap-4 text-xs font-mono text-[#6E655F] pt-4 border-t border-[#E7DED6]">
                    <div>&bull; ChiroTouch / Jane App Sync</div>
                    <div>&bull; Treatment Plan Reactivation</div>
                    <div>&bull; Zero Missed Inbound Leads</div>
                    <div>&bull; SMS Paperwork Dispatch</div>
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                <div className="lg:col-span-6 order-2 lg:order-1">
                  ...
                  <div className="grid grid-cols-2 gap-4 text-xs font-mono text-[#6E655F] pt-4 border-t border-[#E7DED6]">
                    <div>&bull; Pre-Op Fasting Protocols</div>
                    <div>&bull; Real-Time Wait-Time Feeds</div>
                    <div>&bull; Post-Op Check Call Automation</div>
                    <div>&bull; Transportation Rule Confirmations</div>
                  </div>
                </div>
                <div className="lg:col-span-6 order-1 lg:order-2">
                  <div className="relative rounded-2xl border border-[#E7DED6] bg-[#FAFAF7] p-2 shadow-lg overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="p-8 rounded-2xl bg-white border border-[#E7DED6]">
                ...
                <h3 className="text-lg font-bold text-[#14110F] mb-2">SOC 2 Type II Compliant Operational Visibility</h3>
                <p className="text-sm text-[#46403B] leading-relaxed">
        ...
        <section className="py-20 bg-[#FFF8F5] border-t border-[#E7DED6]">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white border border-[#F05A28]/30 mb-6">
              <span className="font-mono text-xs text-[#F05A28] font-bold tracking-wide">
                // ZERO MISSED PATIENTS &bull; 100% HIPAA COMPLIANT
              </span>
            </div>
