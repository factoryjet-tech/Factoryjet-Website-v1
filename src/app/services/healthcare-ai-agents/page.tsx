...
const FAQ_ITEMS: ReadonlyArray<FAQItem> = [
  {
    ...
    answer: 'Yes. Every healthcare AI agent we build operates under a direct Business Associate Agreement (BAA). That is a HIPAA contract that makes us legally responsible for the data we touch. Voice audio, patient transcripts, and protected health information (PHI) get encrypted in transit with TLS 1.3, and at rest with AES-256. We run zero data retention on every speech-to-text and LLM endpoint. Patient data is never cached, and never used to train a public model.',
  },
  {
    category: 'hipaa',
  ...
  },
  {
    ...
    answer: 'The AI agent collects the patient\'s insurance carrier name, member ID, group number, and date of birth by voice. It sends an automated 270/271 EDI eligibility check to your clearinghouse, such as Change Healthcare, Waystar, or Availity. Active coverage and copay get confirmed before the appointment is finalized.',
  },
  {
    category: 'ehr',
  ...
  },
  {
    ...
    answer: 'The AI agent never guesses at a diagnosis. When a caller asks a complex clinical question, it explains that it is an automated practice coordinator and shares general practice policy. Then it either transfers the call to a triage nurse or takes a detailed callback message.',
  },
  {
    category: 'clinical',
  ...
  },
  {
    ...
    answer: 'Yes. Dental scheduling has its own rules that general medical scheduling does not. It covers operatory availability, separate hygienist and doctor columns, procedure-specific time blocks, and same-day emergency slots held back from online booking. We configure the agent against your Dentrix, Eaglesoft, or Open Dental appointment book. Those rules come built in, not a generic calendar grid.',
  },
  {
    category: 'hipaa',
    question: 'What happens to call recordings and transcripts after the call ends?',
    answer: 'Under our standard zero-retention setup, raw audio is not stored after the call ends. Only the structured appointment or message data gets written to your EHR. If your practice wants call recordings kept for QA or compliance, we set up encrypted, access-logged storage inside your own BAA-covered cloud. It is never a third-party archive outside your control.',
  },
];
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="p-8 rounded-2xl bg-white border border-[#E7DED6] hover:border-[#F05A28]/50 transition-all shadow-sm">
                ...
                <p className="text-sm text-[#46403B] leading-relaxed mb-4">
                  Self-hosted inside your own private cloud (VPC) environment. Every login goes through role-based access control (RBAC), so front-desk staff and compliance officers see different levels of the same dashboard. Every deployment carries a full Business Associate Agreement (BAA), end-to-end encryption, automated audit logging, and zero vendor training-data retention.
                </p>
                <ul className="space-y-2 text-xs font-mono text-[#6E655F]">
                  <li className="flex items-center gap-2">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <ul className="grid grid-cols-1 md:grid-cols-2 gap-8 list-none">
              ...
              <li className="p-8 rounded-2xl bg-white border border-[#E7DED6]">
                ...
                <p className="text-sm text-[#46403B] leading-relaxed">
                  Our system reads live provider templates, operatory buffers, and appointment rules straight from your EHR through FHIR R4 APIs. When it books a visit, the agent locks that calendar slot right away. Then it creates a new patient record, or matches an existing chart number, and logs the encounter notes directly in your clinical system.
                </p>
              </li>
