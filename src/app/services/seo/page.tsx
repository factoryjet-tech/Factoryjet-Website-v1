...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://factoryjet.com/services/seo',
...
const FAQ_ITEMS: ReadonlyArray<FAQItem> = [
  // ── Pricing & contracts ────────────────────────────────────────────────
  {
    ...
    answer:
      'FactoryJet pricing is fixed and scoped to your goals. The main drivers are how competitive your market is, how many keywords and pages you are targeting, and how much content the plan calls for. We scope every engagement to the work that will actually move your rankings and leads, then quote it up front on a short call so you know the full cost before work starts. The simplest way to get a real figure is to start with a free SEO audit.',
  },
  {
    category: 'pricing',
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 4, name: 'SEO', item: 'https://factoryjet.com/services/seo' },
  ],
};
        ...
        <section className="py-14 md:py-20" style={{ background: CREAM }}>
          <div className="mx-auto max-w-[1180px] px-6 md:px-8">
            ...
            <div className="mt-10 grid grid-cols-1 gap-[18px] sm:grid-cols-2 md:grid-cols-3">
              {[
                { label: 'Local SEO', href: '/services/local-seo', desc: 'Win the Google Map Pack and near-me searches.', accent: false },
                { label: 'E-commerce SEO', href: '/services/ecommerce-seo', desc: 'Rank product and collection pages that convert.', accent: false },
                { label: 'Shopify SEO', href: '/services/shopify-seo', desc: 'Fix duplicate URLs and thin collections, rank your store.', accent: true },
                { label: 'AI SEO', href: '/services/ai-seo', desc: 'Get cited by ChatGPT, Perplexity, and Google AI Overviews.', accent: false },
                { label: 'SEO Audit', href: '/services/seo-audit', desc: 'Free technical site check with a prioritized fix list.', accent: false },
                { label: 'Small Business SEO', href: '/services/small-business-seo', desc: 'Affordable managed SEO for growing local brands.', accent: false },
              ].map((svc) => (
                <Link
                  key={svc.href}
                  href={svc.href}
