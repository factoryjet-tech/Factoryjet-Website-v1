...
const webPageSchema = {
  ...
  '@type': 'WebPage',
  '@id': 'https://factoryjet.com/services/ai-agents#webpage',
  url: 'https://factoryjet.com/services/ai-agents',
...
const howToSchema = {
  '@context': 'https://schema.org',
  '@type': 'HowTo',
  name: 'How FactoryJet builds your AI agent solution',
  description: 'Our process for delivering this work, typically 2 to 12 weeks depending on scope.',
  // Aligned 2026-08-04 to the timeline this page actually states (2 to 12 weeks).
  // 7-day delivery is real for standard website builds, but this page's own
  // process section says 2 to 12 weeks, so P7D contradicted the visible content.
  totalTime: 'P84D',
  step: [
    {
      '@type': 'HowToStep',
