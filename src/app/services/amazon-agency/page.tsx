...
const FAQ_ITEMS: ReadonlyArray<FAQItem> = [
  ...
  { category: 'services', question: 'What is the difference between Amazon Brand Analytics (ABA) and third-party keyword tools?', answer: 'Amazon Brand Analytics provides first-party search query performance data directly from Amazon, showing exact click and conversion shares for the top 3 clicked ASINs per search term. We leverage ABA to identify high-converting keyword opportunities that third-party scrapers miss.' },
