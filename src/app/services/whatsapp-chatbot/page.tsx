...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: 'https://factoryjet.com/services/whatsapp-chatbot/',
    images: [
      {
  ...
  alternates: {
    canonical: 'https://factoryjet.com/services/whatsapp-chatbot/',
  },
  robots: {
    index: true,
    follow: true,
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    },
    {
      ...
      item: 'https://factoryjet.com/services/whatsapp-chatbot/',
    },
  ],
};
...
const speakableSchema = {
  '@context': 'https://schema.org',
  '@type': 'WebPage',
  '@id': 'https://factoryjet.com/services/whatsapp-chatbot/#webpage',
  speakable: {
...
const WHATSAPP_INDUSTRIES = [
  {
    ...
    linkHref: '/services/whatsapp-chatbot/',
  },
  {
    name: 'D2C & Ecommerce',
    description:
    ...
    <>
      ...
      <SiteHeader
        ...
        navLinks={[
          ...
          { label: 'WhatsApp Bot', href: '/services/whatsapp-chatbot/' },
      ...
      <BreadcrumbSchema
        items={[
          ...
          { name: 'WhatsApp Chatbot India', url: 'https://factoryjet.com/services/whatsapp-chatbot/' },
        ]}
      />
