...
const FAQ_ITEMS: ReadonlyArray<FAQItem> = [
  ...
  },
  {
    ...
    answer:
      'The AI SDR responds in sub-60 seconds 24/7/365 across email, SMS, and website chat channels, ensuring prospects are engaged while actively researching your solution and eliminating the typical 42-hour industry average response lag.',
  },
  {
    category: 'basics',
    question: 'What qualification frameworks can the AI SDR execute?',
    answer:
      'We configure the agent to evaluate custom qualification frameworks including BANT (Budget, Authority, Need, Timeline) and MEDDPICC, evaluating company employee size, software tech stack, geographic location, and project urgency before booking a meeting.',
  },
  {
    category: 'basics',
    question: 'Does an AI SDR replace our human Account Executives?',
    answer:
      'No. The AI SDR automates repetitive top-of-funnel administrative tasks: speed-to-lead response, initial qualification questions, objection handling, and scheduling. This delivers high-intent, pre-qualified meetings to experienced Account Executives to conduct deep strategic discovery and close deals.',
  },
  {
    category: 'integrations',
    question: 'Which CRMs does the AI SDR integrate with?',
    answer:
      'We build bi-directional connectors for HubSpot, Salesforce, Pipedrive, and Zoho CRM. The agent logs complete conversation transcripts, updates deal stages, assigns record owners, and populates custom qualification fields automatically.',
  },
  {
    category: 'integrations',
    question: 'Which firmographic data enrichment providers are connected?',
    answer:
      'The agent queries Apollo, Clearbit, Clay, or ZoomInfo via secure API calls upon lead ingestion, retrieving employee counts, annual revenue tiers, industry classifications, and installed technologies before formulating personalized messages.',
  },
  {
    category: 'integrations',
    question: 'How does calendar scheduling and round-robin AE meeting distribution work?',
    answer:
      'The agent integrates with Google Calendar, Microsoft Outlook, Calendly, or Chili Piper. It checks real-time AE availability and routes meetings based on defined territory, account tier, or balanced round-robin rules with zero scheduling friction.',
  },
  {
    category: 'integrations',
    question: 'Can the AI SDR qualify leads over SMS and WhatsApp channels?',
    answer:
      'Yes. For high-velocity B2B verticals and local commercial services, the agent initiates conversational SMS or WhatsApp qualification within seconds of form submission, adhering strictly to TCPA opt-in consent regulations.',
  },
  {
    category: 'cadences',
    question: 'How do you prevent AI sales emails from landing in spam folders?',
    answer:
      'We engineer dedicated secondary domain sending pools configured with strict SPF, DKIM, DMARC, and custom tracking domains. All prospect emails undergo automated deliverability checks to ensure bounce rates remain below 1 percent.',
  },
  {
    category: 'cadences',
    question: 'How does the AI SDR handle multi-touch follow-up cadences?',
    answer:
      'Cadences follow strict operational rules: multi-touch follow-ups (typically 3 to 4 touches over 10 business days) pause immediately upon prospect reply, meeting booking, or explicit opt-out signals, preventing spammy follow-up loops.',
  },
  {
    category: 'cadences',
    question: 'How does the agent respond to complex technical or pricing objections?',
    answer:
      'The agent is grounded in your sales battlecards, whitepapers, case studies, and compliance documentation. It answers standard technical questions accurately and routes custom commercial contract inquiries directly to senior sales leadership.',
  },
  {
    category: 'cadences',
    question: 'Can the agent handle out-of-office replies and reschedule requests?',
    answer:
      'Yes. The agent parses out-of-office return dates to automatically reschedule follow-ups and processes natural language rescheduling requests (e.g., "I am busy today, can we do next Tuesday at 2pm?") seamlessly.',
  },
  {
    category: 'ownership',
    question: 'Who owns the custom AI SDR prompt trees and code infrastructure?',
    answer:
      'You retain 100 percent ownership of the Git repository, custom prompt architectures, API connectors, and evaluation suites. Everything deploys inside your private cloud accounts with zero vendor per-seat licensing fees.',
  },
  {
    category: 'ownership',
    question: 'What is the implementation timeline for a custom AI SDR build?',
    answer:
      'A production-ready AI SDR connecting your lead capture sources, CRM, data enrichment APIs, and calendar tools is fully built, tested, and deployed in 3 to 4 weeks.',
  },
  {
    category: 'ownership',
    question: 'How is the AI SDR evaluated for safety and accuracy prior to launch?',
    answer:
      'We run automated regression evaluation suites across hundreds of historical inbound inquiries and objection scenarios, measuring qualification precision, tone compliance, and tool accuracy before routing live leads.',
  },
  {
    category: 'ownership',
    question: 'How do we schedule a B2B sales automation discovery session?',
    answer:
      'You can schedule a direct 30-minute discovery call with founder Bhavesh Barot. We will review your current lead response workflows, CRM structure, and deliver a fixed-price AI SDR deployment roadmap.',
  },
];
...
const STATS = [
  ...
  { b: '21x Lift', s: 'in lead qualification rates under 5 mins' },
    ...
    <>
      ...
      <main className="pp-page">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="pp-card p-6 bg-white">
                ...
                <p className="text-sm text-[#46403B] mb-4">
                  Harvard Business Review research proves contacting an inbound lead within 5 minutes yields 21 times higher qualification rates than waiting 30 minutes.
                </p>
                <a
                  href="https://hbr.org"
                  target="_blank"
        ...
        <section className="pp-section">
          <div className="pp-container">
            <div className="text-center max-w-3xl mx-auto mb-12">
              <h2 className="pp-h2 text-center">B2B Industry Workflows &amp; Use Cases</h2>
              <p className="text-base text-[#46403B] mt-3">
                Tailored qualification logic engineered for high-intent B2B commercial sectors.
              </p>
            </div>

            <div className="space-y-4 max-w-4xl mx-auto">
              <div className="pp-card p-6 bg-white border border-[#E7DED6]">
                <h3 className="text-lg font-bold text-[#14110F] mb-2">B2B SaaS &amp; Enterprise Software</h3>
                <p className="text-sm text-[#46403B]">
                  Qualifies inbound demo requests against company seat tiers, technical integration requirements, and security compliance standards, booking discovery calls with specialized Account Executives.
                </p>
              </div>

              <div className="pp-card p-6 bg-white border border-[#E7DED6]">
                <h3 className="text-lg font-bold text-[#14110F] mb-2">Industrial Machinery &amp; Manufacturing Equipment</h3>
                <p className="text-sm text-[#46403B]">
                  Ingests RFQ specifications, verifies facility power/capacity constraints, shares PDF specification sheets, and routes pre-qualified engineering quotes to regional sales directors.
                </p>
              </div>

              <div className="pp-card p-6 bg-white border border-[#E7DED6]">
                <h3 className="text-lg font-bold text-[#14110F] mb-2">Wholesale Distribution &amp; Supply Chain</h3>
                <p className="text-sm text-[#46403B]">
                  Evaluates monthly purchasing volume, validates wholesale reseller tax IDs, checks delivery region coverage, and prepares wholesale catalog access for sales team approval.
                </p>
              </div>

              <div className="pp-card p-6 bg-white border border-[#E7DED6]">
                <h3 className="text-lg font-bold text-[#14110F] mb-2">Commercial Construction &amp; Professional Services</h3>
                <p className="text-sm text-[#46403B]">
                  Qualifies project scopes, timelines, square footage, and budget parameters over SMS or email within seconds of ad submission, booking on-site consultation estimates.
                </p>
              </div>

              <div className="pp-card p-6 bg-white border border-[#E7DED6]">
                <h3 className="text-lg font-bold text-[#14110F] mb-2">Financial Lending &amp; Corporate Credit</h3>
                <p className="text-sm text-[#46403B]">
                  Gathers preliminary annual revenue, time-in-business metrics, and funding requirements with strict security compliance, routing pre-screened applications to underwriters.
                </p>
              </div>
            </div>
          </div>
