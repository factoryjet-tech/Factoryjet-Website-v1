...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      'Phoenix web design agency. High-converting Next.js websites, sub-second load times, and custom Figma UI/UX for Arizona businesses.',
    url: CANONICAL,
    images: [{ url: 'https://factoryjet.com/og-default.png', width: 1200, height: 630, alt: 'Phoenix Web Design Agency' }],
    locale: 'en_US',
  },
  twitter: {
...
const DISTRICTS = [
  {
    ...
    query: 'wealth management web design biltmore phoenix',
    focus: 'Wealth Advisory, Private Equity & Commercial Real Estate',
    desc: 'The prestigious financial and legal heart of the Valley. Demands refined editorial typography, interactive portfolio calculators, and SOC2-compliant client portals.',
  },
  {
    corridor: 'Scottsdale Airpark & North Scottsdale',
    query: 'aesthetic medical clinic web design scottsdale',
    focus: 'Aesthetic Medicine, Luxury Hospitality & Defense Tech',
    desc: 'Bustling luxury medical, aviation, and technology nexus. Features high-resolution visual storytelling, patient intake flows, and sub-second edge hosting.',
  },
  {
    corridor: 'Downtown Phoenix & Roosevelt Row',
    query: 'biotech healthcare web design downtown phoenix',
    focus: 'Bio-Science Core, FinTech & Healthcare Innovation',
    desc: 'Fast-growing urban innovation district. Demands clinical-grade scientific design systems, interactive pipeline visualizers, and modern accessibility compliance.',
  },
  {
    corridor: 'Tempe & Silicon Desert Nexus',
    query: 'semiconductor enterprise web design tempe',
    focus: 'Semiconductor Supply, Enterprise SaaS & Microelectronics',
    desc: 'Major university and hardware technology hub. Features technical interactive capability matrices, developer documentation portals, and rapid mobile load times.',
  },
  {
    corridor: 'Chandler & Price Road Corridor',
    query: 'aviation engineering web design chandler',
    focus: 'Autonomous Vehicle Testing, Precision Aviation & Engineering',
    desc: 'High-tech manufacturing center. Requires precision engineering spec tables, AS9100 quality cert showcases, and high-speed commercial RFQ intake forms.',
  },
  {
    corridor: 'Gilbert & East Valley Gateway',
    query: 'clean tech manufacturing web design gilbert',
    focus: 'Advanced Manufacturing, Clean Tech & Regional Logistics',
    desc: 'Thriving East Valley commercial engine. Demands responsive B2B product catalogs, freight calculator integrations, and localized CRM routing.',
  },
];

const INDUSTRY_SHOWCASE = [
  {
    sector: 'Semiconductor Supply, Microelectronics & Silicon Desert Tech',
    ...
    points: [
      ...
      'High-converting commercial quotation workflows connected directly to your CRM',
    ],
  },
  {
    ...
    points: [
      ...
      'Physician and procedure structured JSON-LD schema linking verified board credentials',
    ],
  },
  {
    sector: 'Wealth Advisory, Private Equity & Commercial Real Estate',
  ...
  {
    sector: 'Commercial Construction, Industrial Logistics & Trade Services',
    headline: 'Engineering Commercial Lead Engines for Valley Contractors',
    description:
...
const PAIN_POINTS = [
  {
    ...
    problem: 'Traditional Phoenix agencies build on bloated WordPress templates with 30+ plugins, resulting in sluggish load times, security vulnerabilities, and constant breakages.',
...
const FAQ_ITEMS = [
  {
    category: 'pricing',
    question: 'How much does custom web design cost for a Phoenix business?',
    answer:
  ...
  {
    category: 'local',
    question: 'Do you have experience with Phoenix semiconductor and engineering companies?',
    answer:
      'Yes. We build high-credibility digital experiences for Tempe and Chandler microelectronics manufacturers, aerospace suppliers, and semiconductor vendors requiring technical specification matrices and RFQ portals.',
  },
  {
    category: 'local',
    question: 'Can you design websites tailored for Scottsdale aesthetic clinics and plastic surgeons?',
    answer:
      'Yes. We craft elegant, high-converting digital flagships for cosmetic surgery practices, medical spas, and wellness centers featuring before-and-after galleries and secure intake workflows.',
  },
  {
    category: 'local',
  ...
  {
    category: 'local',
    question: 'Do you design websites tailored for Biltmore wealth advisory and legal practices?',
    answer:
      'Yes. We develop sophisticated digital flagships for private wealth managers, corporate attorneys, and commercial real estate developers featuring practice area silos, executive bio schemas, and client portals.',
  },
  {
    category: 'ownership',
...
const LOCAL_BUSINESS_SCHEMA = {
  ...
  name: 'FactoryJet - Phoenix Web Design Agency',
...
const SERVICE_SCHEMA = {
  ...
  name: 'Phoenix Web Design & Next.js Development',
  provider: {
    '@type': 'Organization',
    name: 'FactoryJet',
  ...
  description:
    'Custom Next.js web design and engineering in Phoenix AZ. Sub-second performance, full IP code ownership, and rapid 7-day delivery for Arizona businesses.',
...
const WEBPAGE_SCHEMA = {
  '@context': 'https://schema.org',
  '@type': 'WebPage',
  name: 'Phoenix Web Design Agency | Custom Next.js & UI/UX | FactoryJet',
  description: 'Phoenix web design agency. High-converting Next.js websites, sub-second load times, and custom Figma UI/UX for Arizona businesses.',
  url: CANONICAL,
...
export default function PhoenixWebDesignPage() {
  return (
    <>
      <script id="phx-web-faq-schema" type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(FAQ_SCHEMA) }} />
      <script id="phx-web-local-schema" type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(LOCAL_BUSINESS_SCHEMA) }} />
      <script id="phx-web-service-schema" type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(SERVICE_SCHEMA) }} />
      <script id="phx-web-webpage-schema" type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(WEBPAGE_SCHEMA) }} />
      <script id="phx-web-breadcrumb-schema" type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(BREADCRUMB_SCHEMA) }} />
      ...
      <main className="platpage">
            ...
            <div className="rv-hero-wrap">
              ...
              <div>
                <div className="rv-badge" style={{ marginBottom: '18px' }}>
                  ...
                  <span>Phoenix Web Design &amp; Full-Stack Engineering</span>
                </div>

                <h1 style={{ color: '#141414', margin: '0 0 20px', lineHeight: 1.12, letterSpacing: '-0.03em', fontSize: 'clamp(34px, 5.2vw, 56px)' }}>
                  Phoenix Web Design Agency for High-Growth Brands
                </h1>

                <p className="pp-lead" style={{ color: '#494852', maxWidth: '52ch', margin: '0 0 28px', fontSize: 'clamp(16px, 1.8vw, 18.5px)', lineHeight: 1.6 }}>
                  Custom Next.js 15 websites, bespoke Figma UI/UX, and sub-second performance engineered for Arizona leaders. 7-day agile delivery with 100% intellectual property code ownership.
                </p>

                <div className="rv-actions">
                  <ModalCTAButton label="Get a Fixed-Price Quote" region="us" btnVariant="primary-dark" />
                  <a href="#phx-web-districts" className="rv-btn-secondary">
            ...
            <div className="rv-about-grid">
              ...
              <div className="rv-curved-frame-2">
                <Image
                  ...
                  alt="FactoryJet senior UI UX designers collaborating on custom Phoenix web design sprint"
                  width={640}
                  height={640}
                  style={{ width: '100%', height: '100%', objectFit: 'cover', display: 'block' }}
                />
              ...
              <div>
                ...
                <h2 style={{ fontSize: 'clamp(28px, 4vw, 42px)', fontWeight: 800, color: '#141414', letterSpacing: '-0.025em', lineHeight: 1.15, margin: '0 0 14px' }}>
                  Web Design Engineered for Valley of the Sun Leaders
                </h2>
        ...
        <section id="phx-web-districts" className="pp-sec" style={{ backgroundColor: '#F6F6F9', borderTop: '1px solid #E6E6EC', borderBottom: '1px solid #E6E6EC' }}>
          <div className="pp-wrap">
            <div style={{ textAlign: 'center', maxWidth: '720px', margin: '0 auto 48px' }}>
              <div className="rv-badge" style={{ marginBottom: '14px' }}>
                ...
                <span>Valley Commercial Corridor Depth</span>
              </div>
              <h2 style={{ fontSize: 'clamp(28px, 4vw, 44px)', fontWeight: 800, color: '#141414', letterSpacing: '-0.025em', margin: 0 }}>
                Tailored Web Design for Phoenix&apos;s Core Sectors
              </h2>
              <p className="pp-lead" style={{ marginTop: '12px', color: '#494852' }}>
                From Silicon Desert tech leaders to Scottsdale aesthetic clinics and Biltmore wealth advisory firms:
              </p>
            </div>
        ...
        <section className="pp-sec" style={{ backgroundColor: '#FFFFFF', padding: 'clamp(64px, 9vh, 104px) 0' }}>
          <div className="pp-wrap">
            <div style={{ textAlign: 'center', maxWidth: '760px', margin: '0 auto 56px' }}>
              ...
              <h2 style={{ fontSize: 'clamp(28px, 4vw, 44px)', fontWeight: 800, color: '#141414', letterSpacing: '-0.025em', margin: 0 }}>
                Specialized Web Architectures for Arizona Brands
              </h2>
              <p className="pp-lead" style={{ marginTop: '12px', color: '#494852' }}>
                Every commercial sector in the Valley demands tailored user flows, design tokens, and performance metrics:
              </p>
            </div>
        ...
        <section className="pp-sec" style={{ backgroundColor: '#F6F6F9', borderTop: '1px solid #E6E6EC', borderBottom: '1px solid #E6E6EC' }}>
          <div className="pp-wrap">
            <div style={{ textAlign: 'center', maxWidth: '720px', margin: '0 auto 48px' }}>
              ...
              <h2 style={{ fontSize: 'clamp(28px, 4vw, 44px)', fontWeight: 800, color: '#141414', letterSpacing: '-0.025em', margin: 0 }}>
                Why Phoenix Leaders Choose FactoryJet Web Design
              </h2>
              <p className="pp-lead" style={{ marginTop: '12px', color: '#494852' }}>
        ...
        <div id="web-design-blueprint">
          <WebDesignArchitectureBlueprint
            badge="// PHOENIX FRONTEND STACK &amp; CORE WEB VITALS BLUEPRINT"
        ...
        <section className="pp-sec" style={{ backgroundColor: '#F6F6F9', borderTop: '1px solid #E6E6EC', borderBottom: '1px solid #E6E6EC' }}>
          <div className="pp-wrap">
            <div style={{ textAlign: 'center', maxWidth: '760px', margin: '0 auto 48px' }}>
              ...
              <h2 style={{ fontSize: 'clamp(28px, 4vw, 44px)', fontWeight: 800, color: '#141414', letterSpacing: '-0.025em', margin: 0 }}>
                Evaluating Phoenix Web Design Agencies: What to Ask
              </h2>
              <p className="pp-lead" style={{ marginTop: '12px', color: '#494852' }}>
        ...
        <WebDesignValueCalculator city="Phoenix" region="us" />

        {/* ── 10. SEARCHABLE CATEGORIZED FAQ SECTION ── */}
        <FAQ
          eyebrow="PHOENIX WEB DESIGN INTELLIGENCE"
          headline="Frequently Asked Questions About Web Design in Phoenix AZ"
          lead="Direct, plain English answers to what Phoenix business owners and marketing leaders ask about website design and engineering:"
        ...
        <section className="pp-sec" style={{ backgroundColor: '#141414', color: '#FFFFFF', padding: 'clamp(64px, 10vh, 112px) 0', textAlign: 'center' }}>
          <div className="pp-wrap" style={{ maxWidth: '800px' }}>
            ...
            <h2 style={{ fontSize: 'clamp(32px, 5vw, 54px)', fontWeight: 800, color: '#FFFFFF', letterSpacing: '-0.03em', lineHeight: 1.12, margin: '0 0 20px' }}>
              Ready to Upgrade Your Phoenix Web Presence?
            </h2>
