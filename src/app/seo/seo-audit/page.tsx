...
const AUDIT_FAQ_ITEMS = [
  ...
  { category: 'pricing', question: 'How much does a full SEO audit cost, and what if I want you to fix things?', answer: 'The first check is free. A full deep audit and the work to fix the problems after it are paid, and we tell you the price before you commit. If you want us to handle the ongoing work, we scope a monthly plan to your site and tell you the price after a free check. There is no long contract. You pay month to month and can stop with 30 days notice.' },
  ...
  { category: 'after', question: 'Can your team fix the problems the audit finds?', answer: 'Yes. We can take the to-do list and fix the problems for you, from speed and technical issues to content and links. If you want us to handle the ongoing work, we scope a monthly plan to your site, month to month, with 30 days notice to stop. We tell you the price first.' },
  ...
  return (
    <>
      ...
      <Breadcrumbs items={[
        ...
        <BigThreeTrustBlock variant="statement" eyebrow="BY THE NUMBERS" headline="India's Trusted SEO Audit Agency, 500+ Sites, 4.9 Google Review Rating" />
