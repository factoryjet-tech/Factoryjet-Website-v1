...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      'Expert SEO services in Hyderabad, local SEO, technical SEO, pharma & IT B2B SEO, and ecommerce SEO. 500+ businesses, 4.9-star Google rating. No long contracts.',
  ...
  return (
    <div className="w-full overflow-hidden rounded-2xl border border-fj-neutral-200 bg-white shadow-sm">
      <div className="flex items-center justify-between border-b border-fj-neutral-100 px-5 py-3.5">
        ...
        <span className="inline-flex items-center gap-1 rounded-full px-2.5 py-0.5 font-fj-mono text-[10px] font-bold" style={{ background: '#B23E13', color: '#fff' }}>4,290+ / mo</span>
      </div>
  ...
  return (
    <>
      ...
      <Breadcrumbs items={[{ name: 'Home', url: 'https://factoryjet.com' }, { name: 'SEO', url: 'https://factoryjet.com/seo' }, { name: 'Hyderabad', url: 'https://factoryjet.com/seo/hyderabad' }]} />
        ...
        <BigThreeTrustBlock variant="statement" eyebrow="WHY HYDERABAD BUSINESSES TRUST US" headline="India's Trusted SEO Company, 500+ Sites Ranked, 4.9 Google Review Rating, 12+ Years Building" />
        ...
        <section className="relative overflow-hidden bg-fj-cream py-14 md:py-20">
          ...
          <div className="relative mx-auto max-w-3xl px-6 text-center">
            ...
            <p className="mx-auto mt-4 max-w-2xl font-fj-body text-fj-neutral-600" style={{ fontSize: '1.0625rem', lineHeight: 1.6 }}>
              We are building Hyderabad-specific case studies. Our broader track record, 500+ businesses, 4.9-star average on Google, uses the same fundamentals we bring to every Hyderabad engagement. Pharma, IT, local services: the process is the same, the results are documented.
            </p>
