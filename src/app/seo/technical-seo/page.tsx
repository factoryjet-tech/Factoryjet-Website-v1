...
const TECH_FAQ_ITEMS = [
  { category: 'pricing', question: 'How much do technical SEO services cost in India?', answer: 'We do not sell fixed packages. We look at what your site needs and only charge for work that helps Google read and trust your site. The price depends on how competitive your market is and how much work your site needs, so we give you an exact price after a free check. There is no long contract. You pay month to month and can stop with 30 days notice.' },
  ...
  return (
    <>
      ...
      <Breadcrumbs items={[
        ...
        <BigThreeTrustBlock variant="statement" eyebrow="BY THE NUMBERS" headline="India's Trusted Technical SEO Agency, 500+ Sites, 4.9 Google Review Rating" />
