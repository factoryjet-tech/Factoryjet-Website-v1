...
const ROUTES = [
  ...
  { slug: 'woocommerce-to-shopify', live: false, from: 'WooCommerce', to: 'Shopify', d: 'Usually driven by plugin fragility, hosting and security maintenance, or a checkout that will not convert. The catalog moves cleanly; the plugin stack is where the real scoping work sits.' },
  { slug: 'squarespace-to-shopify', live: false, from: 'Squarespace', to: 'Shopify', d: 'A store that outgrew a website builder. Straightforward data, but URL structures differ sharply, so redirect mapping decides whether traffic survives.' },
