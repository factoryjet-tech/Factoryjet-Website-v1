...
const STAT_CARDS = [
  ...
  { num: '95+', title: 'Mobile Lighthouse Score', desc: 'Sub-second mobile loading speeds engineered for high conversion rates across Cook County.', icon: '🚀' },
  { num: '500+', title: 'Websites Launched', desc: 'Custom web platforms delivered across healthcare, manufacturing, law, and B2B.', icon: '🏢' },
...
const DISTRICTS = [
  {
    corridor: 'The Loop & Financial District',
    query: 'chicago corporate law web design',
    focus: 'Corporate Legal, Private Equity & Commercial Real Estate',
    desc: 'Dense corporate center along LaSalle and Michigan Avenue. Executive decision makers evaluate typography polish, partner credentials, and instant page speeds before scheduling a consultation.',
  },
  {
    corridor: 'Fulton Market & West Loop',
    query: 'tech startup website design chicago',
    focus: 'Technology Startups, Venture Capital & Modern Hospitality Flagships',
    desc: 'Rapidly expanding commercial innovation district. Tech firms and culinary flagships require custom interactive brand systems, sub-second asset rendering, and frictionless booking flows.',
  },
  {
    corridor: 'River North & Magnificent Mile',
    query: 'architecture firm website river north',
    focus: 'Architecture Studios, Luxury Retail & Specialty Medical Practices',
    desc: 'Creative agency and design epicenter. High-resolution project portfolios, editorial typography, and smooth responsive animations project world-class design standards.',
  },
  {
    corridor: 'Schaumburg & Northwest Tech Corridor',
    query: 'industrial automation web design schaumburg',
    focus: 'Industrial Automation, Software & Regional Insurance Headquarters',
    desc: 'Commercial technology hub along the I-90 corridor. B2B enterprise procurement demands structured product matrices, downloadable technical whitepapers, and clear RFQ routing.',
  },
  {
    corridor: 'Oak Brook & East-West Tollway',
    query: 'b2b corporate website oak brook',
    focus: 'Enterprise Headquarters, Professional Services & Medical Centers',
    desc: 'Major corporate suburban campus corridor. Requires deep multi-departmental content architectures, secure client login portals, and enterprise-grade accessibility compliance.',
  },
  {
    corridor: 'O’Hare Logistics Corridor & Elk Grove Village',
    query: 'freight logistics web design elk grove',
    focus: 'Freight Forwarding, Warehousing, Supply Chain & Precision Fabrication',
    desc: 'The nation’s largest consolidated industrial park. Fast load speeds, equipment spec sheets, carrier tracking integrations, and rapid quote calculators capture high-value contracts.',
  },
];

const INDUSTRY_SHOWCASE = [
  {
    sector: 'Manufacturing, Supply Chain & Freight Logistics',
    headline: 'Engineering Digital Authority for Midwest Industrial Giants',
    description:
  ...
  {
    sector: 'Healthcare Systems, Medical Devices & Specialty Clinics',
    headline: 'High-Trust Patient & Provider Digital Experiences',
    description:
  ...
  {
    sector: 'Corporate Law, Litigation & Financial Advisory',
    headline: 'Projecting Institutional Stature for Loop & River North Practices',
    description:
  ...
  {
    sector: 'Hospitality Groups, Dining Flagships & Commercial Venues',
    headline: 'Immersive Visual Storytelling for West Loop & Fulton Market Venues',
    description:
    ...
    points: [
      ...
      'Automated local business schema capturing weekend dining traffic and private events',
    ],
  },
];
...
const PAIN_POINTS = [
  {
    ...
    problem: 'Traditional Chicago agencies install bloated multi-purpose themes loaded with 35+ unmaintained plugins that cause 4 to 6 second load times and frequent security breaches.',
...
const ROADMAP_STEPS = [
  {
    ...
    desc: 'We analyze your Chicago market competitors, map conversion pathways, and design a custom desktop and mobile prototype in Figma.',
...
const FAQ_CATEGORIES = [
  ...
  { key: 'local', label: 'Chicago Market Focus' },
...
const FAQ_ITEMS = [
  {
    category: 'pricing',
    question: 'How much does a custom Chicago web design project cost?',
    answer:
  ...
  {
    category: 'local',
    question: 'Can you design websites for Chicago healthcare and dental practices?',
    answer:
      'Yes. We build modern, HIPAA-aware websites for healthcare clinics, dental groups, and med spas across Greater Chicago, featuring doctor bio directories, insurance plan listings, and frictionless appointment booking integrations.',
  },
  {
    category: 'local',
    question: 'Can you integrate e-commerce capabilities into our Chicago business site?',
    answer:
  ...
  {
    category: 'local',
    question: 'How does your web design optimize for local Chicago search rankings?',
    answer:
      'We embed structured LocalBusiness JSON-LD schema, configure Google Analytics 4 conversion tracking, optimize Core Web Vitals, and architect localized service area landing pages for Chicago, Naperville, Schaumburg, Oak Brook, and Evanston.',
  },
  {
    category: 'ownership',
...
const LOCAL_BUSINESS_SCHEMA = {
  ...
  name: 'FactoryJet - Chicago Web Design Agency',
...
const SERVICE_SCHEMA = {
  ...
  name: 'Chicago Web Design & Next.js Development',
  provider: {
    '@type': 'Organization',
  ...
  description:
    'Senior engineering-led custom Next.js web design, sub-second page performance, mobile conversion optimization, and full IP ownership for Chicago businesses.',
  areaServed: [
    { '@type': 'City', name: 'Chicago' },
...
const WEBPAGE_SCHEMA = {
  '@context': 'https://schema.org',
  '@type': 'WebPage',
  '@id': 'https://factoryjet.com/chicago/web-design#webpage',
  name: 'Chicago Web Design Agency | Fast Next.js Sites | FactoryJet',
  description: 'Custom Next.js websites, sub-second load speeds, and full code ownership for Chicago IL businesses.',
  url: CANONICAL,
...
export default function ChicagoWebDesignPage() {
  return (
    <>
      ...
      <script id="chi-service-schema" type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(SERVICE_SCHEMA) }} />
      <script id="chi-webpage-schema" type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(WEBPAGE_SCHEMA) }} />
      ...
      <main className="platpage">
            ...
            <div className="rv-hero-wrap">
              ...
              <div>
                <div className="rv-badge" style={{ marginBottom: '18px' }}>
                  ...
                  <span>Chicago Web Design &amp; Frontend Engineering</span>
                </div>

                <h1 style={{ color: '#141414', margin: '0 0 20px', lineHeight: 1.12, letterSpacing: '-0.03em', fontSize: 'clamp(34px, 5.2vw, 56px)' }}>
                  Chicago Web Design Agency for Growing Brands
                </h1>
                ...
                <div style={{ background: '#F6F6F9', borderLeft: '3px solid #FF5622', padding: '14px 18px', borderRadius: '0 12px 12px 0', marginBottom: '28px', maxWidth: '52ch' }}>
                  <p style={{ fontSize: '13.5px', color: '#141414', lineHeight: 1.55, margin: 0, fontWeight: 500 }}>
                    <strong style={{ color: '#FF5622' }}>Executive Brief:</strong> FactoryJet engineers custom, type-safe Next.js websites for Chicago businesses: sub-second mobile page loads, high-converting Figma UX wireframes, structured Schema.org entity graphs, dedicated 7-day sprint delivery, and 100% full intellectual property code ownership with zero monthly vendor lock-in.
                  </p>
                </div>

                <div className="rv-actions">
                  <ModalCTAButton label="Get a Fixed-Price Quote" region="us" btnVariant="primary-dark" />
                  <a href="#chi-districts" className="rv-btn-secondary">
            ...
            <div className="rv-about-grid">
              ...
              <div className="rv-curved-frame-2">
                <Image
                  ...
                  alt="FactoryJet senior frontend engineers building custom Next.js web solutions in Chicago"
                  width={640}
                  height={640}
                  style={{ width: '100%', height: '100%', objectFit: 'cover', display: 'block' }}
                />
              ...
              <div>
                ...
                <h2 style={{ fontSize: 'clamp(28px, 4vw, 42px)', fontWeight: 800, color: '#141414', letterSpacing: '-0.025em', lineHeight: 1.15, margin: '0 0 14px' }}>
                  Websites Built for Chicago&apos;s High-Value Sectors
                </h2>

                <p className="pp-lead" style={{ color: '#494852', margin: '0 0 28px', fontSize: '16px', lineHeight: 1.6 }}>
                  From global logistics providers to precision manufacturers and law firms, Chicago businesses need sites that project engineering authority and convert high-ticket decision-makers.
                </p>
        ...
        {/* ── 04. CHICAGO DISTRICTS & INDUSTRY DIRECTORY ── */}
        <section id="chi-districts" className="pp-sec" style={{ backgroundColor: '#F6F6F9', borderTop: '1px solid #E6E6EC', borderBottom: '1px solid #E6E6EC' }}>
          <div className="pp-wrap">
            <div style={{ textAlign: 'center', maxWidth: '720px', margin: '0 auto 48px' }}>
              <div className="rv-badge" style={{ marginBottom: '14px' }}>
                ...
                <span>Chicago Industry Depth</span>
              </div>
              <h2 style={{ fontSize: 'clamp(28px, 4vw, 44px)', fontWeight: 800, color: '#141414', letterSpacing: '-0.025em', margin: 0 }}>
                Tailored Web Design for Chicago&apos;s Core Sectors
              </h2>
              <p className="pp-lead" style={{ marginTop: '12px', color: '#494852' }}>
                From Downtown law firms to Fulton Market tech startups and O’Hare logistics hubs:
              </p>
            </div>
        ...
        <section className="pp-sec" style={{ backgroundColor: '#FFFFFF', padding: 'clamp(64px, 9vh, 104px) 0' }}>
          <div className="pp-wrap">
            <div style={{ textAlign: 'center', maxWidth: '760px', margin: '0 auto 56px' }}>
              ...
              <h2 style={{ fontSize: 'clamp(28px, 4vw, 44px)', fontWeight: 800, color: '#141414', letterSpacing: '-0.025em', margin: 0 }}>
                Specialized Web Architectures for Chicago Businesses
              </h2>
              <p className="pp-lead" style={{ marginTop: '12px', color: '#494852' }}>
                Every commercial sector in Chicago demands tailored user experiences, technical credibility, and conversion paths:
              </p>
            </div>
        ...
        <section className="pp-sec" style={{ backgroundColor: '#F6F6F9', borderTop: '1px solid #E6E6EC', borderBottom: '1px solid #E6E6EC' }}>
          <div className="pp-wrap">
            <div style={{ textAlign: 'center', maxWidth: '720px', margin: '0 auto 48px' }}>
              ...
              <h2 style={{ fontSize: 'clamp(28px, 4vw, 44px)', fontWeight: 800, color: '#141414', letterSpacing: '-0.025em', margin: 0 }}>
                Why Chicago Companies Choose FactoryJet Web Design
              </h2>
              <p className="pp-lead" style={{ marginTop: '12px', color: '#494852' }}>
        ...
        <section className="pp-sec" style={{ backgroundColor: '#FFFFFF', padding: '48px 0 16px' }}>
          <div className="pp-wrap">
            <RegionalBenchmarkCard city="Chicago" vertical="web-design" />
          </div>
        </section>
        ...
        <section className="pp-sec" style={{ backgroundColor: '#F6F6F9', borderTop: '1px solid #E6E6EC', borderBottom: '1px solid #E6E6EC' }}>
          <div className="pp-wrap">
            <div style={{ textAlign: 'center', maxWidth: '760px', margin: '0 auto 48px' }}>
              ...
              <h2 style={{ fontSize: 'clamp(28px, 4vw, 44px)', fontWeight: 800, color: '#141414', letterSpacing: '-0.025em', margin: 0 }}>
                Evaluating Chicago Web Design Agencies: What to Ask
              </h2>
              <p className="pp-lead" style={{ marginTop: '12px', color: '#494852' }}>
        ...
        <WebDesignValueCalculator city="Chicago" region="us" />

        {/* ── 10. SEARCHABLE CATEGORIZED FAQ SECTION ── */}
        <FAQ
          eyebrow="CHICAGO WEB DESIGN INTELLIGENCE"
          headline="Frequently Asked Questions About Web Design in Chicago IL"
          lead="Direct, plain English answers to what Chicago business owners and marketing leaders ask about website projects:"
        ...
        <section className="pp-sec" style={{ backgroundColor: '#141414', color: '#FFFFFF', padding: 'clamp(64px, 10vh, 112px) 0', textAlign: 'center' }}>
          <div className="pp-wrap" style={{ maxWidth: '800px' }}>
            ...
            <h2 style={{ fontSize: 'clamp(32px, 5vw, 54px)', fontWeight: 800, color: '#FFFFFF', letterSpacing: '-0.03em', lineHeight: 1.12, margin: '0 0 20px' }}>
              Ready to Upgrade Your Chicago Business Website?
            </h2>
            ...
            <p style={{ marginTop: '28px', fontSize: '13.5px', color: '#8E8E9F' }}>
              Related services: <Link href="/chicago/seo" style={{ color: '#FF5622', textDecoration: 'underline' }}>Chicago SEO agency</Link>, <Link href="/chicago/ecommerce-development" style={{ color: '#FF5622', textDecoration: 'underline' }}>Chicago ecommerce development</Link>, <Link href="/services/web-design" style={{ color: '#FF5622', textDecoration: 'underline' }}>Web design services</Link>, and <Link href="/services/ai-agent-development" style={{ color: '#FF5622', textDecoration: 'underline' }}>AI agent development</Link>.
            </p>
          </div>
        </section>
      </main>
