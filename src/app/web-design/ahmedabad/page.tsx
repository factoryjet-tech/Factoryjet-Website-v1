...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    title: 'Web Design Company in Ahmedabad | FactoryJet',
    description:
      'Website design company in Ahmedabad. 7-day delivery. Next.js, SEO, GA4 included.',
...
const faqSchema = {
  ...
  mainEntity: [
    ...
    {
      '@type': 'Question',
      name: 'Who is the best web design agency in Ahmedabad?',
      acceptedAnswer: { '@type': 'Answer', text: 'For small businesses, FactoryJet makes a strong case as the best web design company in Ahmedabad: custom websites in 7 days, 100/100 Google speed scores, and a fixed written price. Any website design company in Ahmedabad you compare should pass three checks: live websites you can test, speed scores you can verify, and a price that does not grow mid-project. That is the honest way to pick the best website design company in Ahmedabad.' },
    },
    {
      '@type': 'Question',
      name: 'Should I hire web designer in Ahmedabad or use an agency?',
      acceptedAnswer: { '@type': 'Answer', text: 'A freelancer can be right for a tiny one-page job. For a business website, a small senior team is usually faster and safer: design, code, SEO, and support in one place, at a fixed price. If you do hire web designer in Ahmedabad directly, agree the scope and price in writing first.' },
    },
],
};
...
const AMD_FAQ_ITEMS = [
  ...
  {
    category: 'pricing',
    question: 'Who is the best web design agency in Ahmedabad?',
    answer:
      'For small businesses, FactoryJet makes a strong case as the best web design company in Ahmedabad: custom websites in 7 days, 100/100 Google speed scores, and a fixed written price. Any website design company in Ahmedabad you compare should pass three checks: live websites you can test, speed scores you can verify, and a price that does not grow mid-project. That is the honest way to pick the best website design company in Ahmedabad.',
  },
  {
    category: 'pricing',
    question: 'Should I hire web designer in Ahmedabad or use an agency?',
    answer:
      'A freelancer can be right for a tiny one-page job. For a business website, a small senior team is usually faster and safer: design, code, SEO, and support in one place, at a fixed price. If you do hire web designer in Ahmedabad directly, agree the scope and price in writing first.',
  },
];
  ...
  return (
    <>
      ...
      <main className="bg-fj-cream">
        ...
        <WebDesignCityLinksIN currentCity="ahmedabad" />
