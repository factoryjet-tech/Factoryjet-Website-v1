...
export const metadata: Metadata = {
  ...
  description:
    'Web design company in Noida for IT firms, media companies & D2C startups. Fast, custom websites with 7-day delivery. Serving Sector 62, Sector 18, Film City & Noida Expressway.',
  keywords: [
  ...
  return (
    <>
      ...
      <Breadcrumbs items={[
        ...
        <WebDesignCityLinksIN currentCity="noida" />
