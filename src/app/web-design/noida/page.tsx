...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    title: 'Web Design Company in Noida | FactoryJet',
    description:
      'Website design company in Noida. 7-day delivery. Next.js, SEO, GA4 included.',
...
const NOIDA_FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer:
      "Noida and Delhi NCR web agencies typically charge ₹1,20,000–₹4,00,000 for a comparable project and deliver in 6–16 weeks. FactoryJet gives you a fixed-price quote before you commit, guarantees 7-day delivery in writing, and builds in Next.js rather than WordPress. Faster website, shorter timeline, codebase you own — at a fixed, published price.",
  },
  ...
  {
    category: 'pricing',
    question: 'Who is the best web design agency in Noida?',
    answer:
      'For small businesses, FactoryJet makes a strong case as the best web design company in Noida: custom websites in 7 days, 100/100 Google speed scores, and a fixed written price. Any website design company in Noida you compare should pass three checks: live websites you can test, speed scores you can verify, and a price that does not grow mid-project. That is the honest way to pick the best website design company in Noida.',
  },
  {
    category: 'pricing',
    question: 'Should I hire web designer in Noida or use an agency?',
    answer:
...
const NOIDA_COMPARISON_ROWS = [
  {
    ...
    values: ['Get a Quote', '₹1,20,000–₹4,00,000', '₹10,000–₹60,000', '₹0–₹15,000 (you build it)'],
  },
  {
    ...
    <>
      ...
      <main className="bg-fj-cream">
        ...
        <StrategicDarkSection
          ...
          lead="Noida and Delhi NCR web agencies typically charge ₹1,20,000–₹4,00,000 for a comparable project and take 6–16 weeks to deliver. FactoryJet gives you a fixed-price quote before you commit, guarantees 7-day delivery in writing, and builds in Next.js rather than WordPress — faster load times, a codebase you own outright. Pricing is fixed and agreed upfront — no surprises."
          pillars={[
            {
              icon: '⚡',
