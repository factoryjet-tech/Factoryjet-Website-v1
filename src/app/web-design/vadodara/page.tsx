...
export const metadata: Metadata = {
  ...
  description:
    'Web design company in Vadodara for chemical exporters, engineering firms, and B2B manufacturers. Fast, custom websites with 7-day delivery. Serving GIDC Makarpura, Waghodia & Savli.',
  keywords: [
...
const faqSchema = {
  '@context': 'https://schema.org',
  '@type': 'FAQPage',
  mainEntity: VDR_FAQ_ITEMS.map((item) => ({
    '@type': 'Question',
    name: item.question,
  ...
  return (
    <>
      ...
      <Breadcrumbs items={[
        ...
        <WebDesignCityLinksIN currentCity="vadodara" />
