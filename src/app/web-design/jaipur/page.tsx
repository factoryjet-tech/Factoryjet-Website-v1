...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'affordable web design Jaipur',
    'professional website design Jaipur',
    'web design Malviya Nagar',
    'web design C-Scheme',
    'jewellery website design Jaipur',
    'handicraft website design Jaipur',
    'tourism website design Jaipur',
    'Next.js web development Jaipur',
    'web design agency Jaipur',
    'Jaipur Pink City website design',
  ],
  openGraph: {
    type: 'website',
    siteName: 'FactoryJet',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'FactoryJet Web Design Services in Jaipur',
      },
    ],
    locale: 'en_IN',
  },
  ...
  alternates: {
    canonical: 'https://factoryjet.com/web-design/jaipur',
    languages: webDesignCityAlternatesIN['jaipur'],
  },
  robots: {
    index: true,
    follow: true,
...
const faqSchema = {
  ...
  mainEntity: [
    {
      '@type': 'Question',
      name: 'How much does a website cost for a business in Jaipur?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: "FactoryJet's web design for Jaipur businesses starts at ₹29,999 for a 5-page Starter site. The Growth tier (₹80,000) covers 10–15 pages, a blog CMS, lead-capture forms, and GA4 analytics. Custom builds start at ₹1,50,000. Jaipur agency rates for comparable scope typically run ₹80,000–₹2,50,000.",
      },
    },
    {
      '@type': 'Question',
      name: 'How long does it take to build a website in Jaipur?',
      acceptedAnswer: {
        '@type': 'Answer',
    ...
    {
      '@type': 'Question',
      name: 'Do you build websites for jewellery exporters and handicraft businesses in Jaipur?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes — jewellery exporters, handicraft manufacturers, and Jaipuri textile businesses are a core client profile for us in Jaipur. We build B2B websites optimised for international buyer research: product catalog with gemstone specifications, export credentials, certifications display, and inquiry forms targeting buyers in the US, EU, and UAE.',
      },
    },
    {
      '@type': 'Question',
      name: 'Will my Jaipur business website rank on Google?',
      acceptedAnswer: {
        '@type': 'Answer',
    ...
    {
      '@type': 'Question',
      name: 'Who is the best web design agency in Jaipur?',
      acceptedAnswer: { '@type': 'Answer', text: 'For small businesses, FactoryJet makes a strong case as the best web design company in Jaipur: custom websites in 7 days, 100/100 Google speed scores, and a fixed written price. Any website design company in Jaipur you compare should pass three checks: live websites you can test, speed scores you can verify, and a price that does not grow mid-project. That is the honest way to pick the best website design company in Jaipur.' },
    },
    {
      '@type': 'Question',
      name: 'Should I hire web designer in Jaipur or use an agency?',
      acceptedAnswer: { '@type': 'Answer', text: 'A freelancer can be right for a tiny one-page job. For a business website, a small senior team is usually faster and safer: design, code, SEO, and support in one place, at a fixed price. If you do hire web designer in Jaipur directly, agree the scope and price in writing first.' },
    },
],
};
...
const JPR_JOURNEY_STAGES: ServiceJourneyStage[] = [
  {
    number: '01',
...
const JPR_FAQ_ITEMS = [
  ...
  {
    category: 'pricing',
    question: 'How much does a website cost for a business in Jaipur?',
    answer:
      "FactoryJet's web design for Jaipur businesses starts at ₹29,999 for a 5-page Starter site. The Growth tier (₹80,000) covers 10–15 pages, a blog CMS, lead-capture forms, and GA4 analytics. Custom builds start at ₹1,50,000. Jaipur agency rates for comparable scope typically run ₹80,000–₹2,50,000.",
  },
  {
    category: 'pricing',
  ...
  {
    category: 'support',
    question: 'Do you offer ongoing retainer services for Jaipur businesses?',
    answer:
  ...
  {
    category: 'pricing',
    question: 'Do you offer payment plans for Jaipur businesses?',
    answer:
      'Yes. We offer 50% upfront and 50% on launch for all tiers. For Custom builds above ₹1,50,000, milestone-based payment in three parts is available. We do not require full payment before starting work.',
  },

  // Money-query coverage, added 2026-06-11
  {
    category: 'pricing',
    question: 'Who is the best web design agency in Jaipur?',
    answer:
      'For small businesses, FactoryJet makes a strong case as the best web design company in Jaipur: custom websites in 7 days, 100/100 Google speed scores, and a fixed written price. Any website design company in Jaipur you compare should pass three checks: live websites you can test, speed scores you can verify, and a price that does not grow mid-project. That is the honest way to pick the best website design company in Jaipur.',
  },
  {
    category: 'pricing',
    question: 'Should I hire web designer in Jaipur or use an agency?',
    answer:
      'A freelancer can be right for a tiny one-page job. For a business website, a small senior team is usually faster and safer: design, code, SEO, and support in one place, at a fixed price. If you do hire web designer in Jaipur directly, agree the scope and price in writing first.',
  },
];

const JPR_COMPARISON_COLUMNS = [
...
const JPR_COMPARISON_ROWS = [
  ...
  },
  {
    ...
    values: [
      <CompareIcon key="fj" kind="yes" />,
      <CompareIcon key="ja" kind="partial" />,
      <CompareIcon key="fr" kind="partial" />,
      <CompareIcon key="tp" kind="no" />,
    ],
  },
...
const howToSchema = {
  '@context': 'https://schema.org',
  '@type': 'HowTo',
  '@id': `https://factoryjet.com/web-design/jaipur#howto`,
  name: `How FactoryJet builds your Jaipur website in 7 days`,
  description: `Our 7-day process for delivering a professional, AI-powered website for Jaipur businesses.`,
  estimatedCost: {
    '@type': 'MonetaryAmount',
    currency: 'INR',
    minValue: '29999',
      ...
      <main className="bg-fj-cream">
          ...
          body={
            <>
              <p>
                ...
                production capacity, GJEPC membership, past international clients, and a
                frictionless RFQ form. We build these sites with authority-first architecture,
              ...
              <p>
                For Malviya Nagar&apos;s IT companies and startups, the website needs
                product-led architecture, investor credibility signals, and fast iteration
                capability. Every FactoryJet Jaipur project covers discovery, Figma
                prototyping, Next.js development, SEO, GA4, and a 30-day support window.
                You leave with a codebase you own, a design system you keep, and a site
                ...
                {[
                  {
                    ...
                    area: 'Sitapura · Johri Bazaar · Sanganer',
                    colour: '#F05A28',
                  },
                  {
                    type: 'Tourism & Hospitality',
                    need: 'Booking engine + multilingual + gallery',
                    area: 'Amer Road · Pink City · Rambagh',
                    colour: '#0F0F12',
                  },
                  {
                    type: 'IT / D2C / Startup',
                    need: 'Product-led + speed + conversion',
                    area: 'Malviya Nagar · C-Scheme · Vaishali Nagar',
                    colour: '#8B5CF6',
                  },
                ].map((row) => (
          ...
          pillars={[
            {
              ...
              body: "Jaipur's jewellery export seasons and tourism peaks don't wait for a 10-week web project. FactoryJet delivers in 7 days, with the guarantee written into the project agreement. We have delivered on time on 97% of all projects since 2005.",
            },
            {
              icon: '🏗️',
        ...
        <ComparisonTable
          ...
          pullQuote={{
            stat: '₹29,999',
            caption:
              'starting price — same Figma-first design, Next.js engineering, technical SEO, and Lighthouse audit as a ₹1,50,000 Jaipur agency project.',
          }}
          columns={JPR_COMPARISON_COLUMNS}
          rows={JPR_COMPARISON_ROWS}
          footer="Prices reflect typical Jaipur market ranges as of 2025. FactoryJet fixed-price contracts available for all tiers."
        />
        ...
        <IndustriesGrid variant="cards"
          ...
          sectors={[
            ...
            },
            {
              name: 'IT & Startups',
              description:
                "Malviya Nagar is Jaipur's established IT hub, home to software development companies, digital agencies, and a growing community of SaaS and fintech startups. Rajasthan's iStart programme has registered 10,000+ startups, with Jaipur at the centre. Startup websites need product-led architecture, investor credibility signals, demo request flows, and performance built for rapid iteration.",
              example:
                "IT companies, SaaS startups, and fintech founders in Malviya Nagar and C-Scheme building for national and international markets.",
            },
            {
              name: 'Retail & D2C',
              description:
                "Jaipur's retail ecosystem spans MI Road's high-street brands, C-Scheme's premium commercial zone, and Vaishali Nagar's growing residential retail. D2C brands selling Jaipur crafts, fashion, home décor, and food products need mobile-first e-commerce, Razorpay checkout, Shiprocket integration, and SEO built for domestic and NRI buyers.",
              example:
                'Retail brands, D2C founders, and fashion labels in Jaipur targeting domestic consumers and NRI buyers across the US, UK, and UAE.',
            },
            {
