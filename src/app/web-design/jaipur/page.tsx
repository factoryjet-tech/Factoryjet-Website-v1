...
const JPR_FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer:
      'Yes. We offer 50% upfront and 50% on launch. For larger custom builds, milestone-based payment in three parts is available. We do not require full payment before starting work.',
  },
  ...
  return (
    <>
      ...
      <main className="bg-fj-cream">
          ...
          pillars={[
            {
              ...
              body: "Jaipur's jewellery export seasons and tourism peaks don't wait for a 10-week web project. FactoryJet delivers in 7 days, with the guarantee written into the project agreement. We have delivered on time on 97% of all projects.",
            },
            {
              icon: '🏗️',
        ...
        <WebDesignCityLinksIN currentCity="jaipur" />
