...
const faqSchema = {
  ...
  mainEntity: [
    ...
    {
      '@type': 'Question',
      name: 'Who is the best web design agency in Hyderabad?',
      acceptedAnswer: { '@type': 'Answer', text: 'For small businesses, FactoryJet makes a strong case as the best web design company in Hyderabad: custom websites in 7 days, 100/100 Google speed scores, and a fixed written price. Any website design company in Hyderabad you compare should pass three checks: live websites you can test, speed scores you can verify, and a price that does not grow mid-project. That is the honest way to pick the best website design company in Hyderabad.' },
    },
    {
      '@type': 'Question',
      name: 'Should I hire web designer in Hyderabad or use an agency?',
      acceptedAnswer: { '@type': 'Answer', text: 'A freelancer can be right for a tiny one-page job. For a business website, a small senior team is usually faster and safer: design, code, SEO, and support in one place, at a fixed price. If you do hire web designer in Hyderabad directly, agree the scope and price in writing first.' },
    },
],
};
...
const HYD_FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer:
      "Hyderabad web agencies typically charge ₹1,25,000–₹3,50,000 for a comparable project and deliver in 8–16 weeks. FactoryJet gives you a fixed-price quote before you commit, guarantees 7-day delivery in writing, and builds in Next.js rather than WordPress. Faster site, shorter timeline, codebase you own — at a fixed, published price.",
  },
...
const HYD_COMPARISON_ROWS = [
  {
    ...
    values: ['Get a Quote', '₹1,25,000–₹3,50,000', '₹15,000–₹80,000', '₹0–₹15,000 (you build it)'],
  },
  {
