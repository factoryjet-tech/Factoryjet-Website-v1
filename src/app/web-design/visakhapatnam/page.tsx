...
const faqSchema = {
  ...
  mainEntity: [
    ...
    {
      '@type': 'Question',
      name: 'Who is the best web design agency in Visakhapatnam?',
      acceptedAnswer: { '@type': 'Answer', text: 'For small businesses, FactoryJet makes a strong case as the best web design company in Visakhapatnam: custom websites in 7 days, 100/100 Google speed scores, and a fixed written price. Any website design company in Visakhapatnam you compare should pass three checks: live websites you can test, speed scores you can verify, and a price that does not grow mid-project. That is the honest way to pick the best website design company in Visakhapatnam.' },
    },
    {
      '@type': 'Question',
      name: 'Should I hire web designer in Visakhapatnam or use an agency?',
      acceptedAnswer: { '@type': 'Answer', text: 'A freelancer can be right for a tiny one-page job. For a business website, a small senior team is usually faster and safer: design, code, SEO, and support in one place, at a fixed price. If you do hire web designer in Visakhapatnam directly, agree the scope and price in writing first.' },
    },
],
};
