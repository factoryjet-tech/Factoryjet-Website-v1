...
export const metadata: Metadata = {
  ...
  description:
    'Web design company in Kochi for IT firms, tourism businesses, exporters & startups. Fast, custom websites with 7-day delivery. Serving Infopark, Kakkanad, MG Road & Fort Kochi.',
  keywords: [
...
const faqSchema = {
  '@context': 'https://schema.org',
  '@type': 'FAQPage',
  mainEntity: KOCHI_FAQ_ITEMS.map((item) => ({
    '@type': 'Question',
    name: item.question,
  ...
  return (
    <>
      ...
      <Breadcrumbs items={[
        ...
        <WebDesignCityLinksIN currentCity="kochi" />
