...
const STAT_CARDS = [
  { num: 'Top 3', title: 'Google Maps Ranking SLA', desc: 'Engineered for dominance in Google Local 3-Pack across high-value Boise and Meridian corridors.', icon: '📍' },
...
const INDUSTRY_SHOWCASE = [
  {
    sector: 'Healthcare, Orthopedic Surgery & Specialty Clinics',
  ...
  {
    sector: 'Commercial Construction, Roofing & Electrical Services',
  ...
  {
    sector: 'Legal Practices, Estate Planning & Commercial Litigation',
  ...
  {
    sector: 'High-End Outdoor Hospitality, Guides & Adventure Tourism',
...
const PAIN_POINTS = [
  ...
  },
  {
    ...
    problem: 'Big-box marketing agencies assign junior coordinators who do not understand Boise unique municipal boundaries, Treasure Valley corridors, or industry specifics.',
    solution: 'You work directly with senior local SEO technical engineers who execute hyper-local geo-targeting tailored to Idaho commercial realities.',
  },
  {
    num: '04',
...
const ROADMAP_STEPS = [
  ...
  },
  {
    ...
    deliverables: ['Hyper-local corridor landing pages (Downtown, Meridian, Eagle, Nampa)', 'Custom JSON-LD schema graphs (LocalBusiness, Service, Physician, LegalService)', 'Internal contextual link graph distributing domain authority', 'Service area boundary definition in Google Maps API'],
  },
  {
    phase: 'Phase 03',
    title: 'High-Authority Regional Citations & Review Velocity Engine',
    desc: 'We build authoritative local citations across regional Treasure Valley chambers, industry trade directories, and deploy automated review generation workflows.',
    deliverables: ['Tier-1 citation distribution across Apple Maps, Bing, Yelp, and YellowPages', 'Regional Boise business directory and chamber of commerce listings', 'Automated SMS and email review generation campaign deployment', 'Review response protocol and Google Maps attribute updates'],
  },
  {
    phase: 'Phase 04',
...
const FAQ_ITEMS = [
  {
    category: 'pricing',
    question: 'How much does local SEO cost for a Boise ID business?',
    answer:
  ...
  {
    category: 'timeline',
    question: 'How quickly can a Boise business rank in the Google Maps 3-Pack?',
    answer:
  ...
  {
    category: 'local',
    question: 'Do you have experience with Boise medical and dental practices?',
    answer:
      'Yes. We optimize local search footprints for surgical practices, dental implant specialists, and wellness clinics operating across Boise, Meridian, and Eagle.',
  },
  {
    category: 'local',
    question: 'Can you optimize commercial contractors competing across the Treasure Valley?',
    answer:
      'Yes. We engineer comprehensive Service Area Business profiles and commercial contracting silos targeting Boise, Nampa, Caldwell, and surrounding counties.',
  },
  {
    category: 'local',
    question: 'How do you target multiple Treasure Valley cities without keyword cannibalization?',
    answer:
  ...
  {
    category: 'local',
    question: 'Can you help outdoor recreation and adventure hospitality brands?',
    answer:
      'Yes. We optimize local search profiles, tourist attraction schemas, and map listings for outfitters, guides, and hospitality resorts across southwest Idaho.',
  },
  {
    category: 'deliverables',
    question: 'What reports and dashboards will our team receive each month?',
    answer:
      'You receive access to a real-time geo-grid local rank tracking dashboard showing exact keyword positions across every Boise neighborhood, plus monthly conversion summaries detailing call volume and lead inquiries.',
  },
  {
    category: 'deliverables',
...
const WEBPAGE_SCHEMA = {
  '@context': 'https://schema.org',
  '@type': 'WebPage',
  name: 'Boise Local SEO Agency | Search & AI Visibility | FactoryJet',
  description: 'Boise local SEO agency. Dominate Google Maps 3-Pack, organic rankings, and AI search citations across Downtown, Meridian, Eagle, and Treasure Valley.',
  url: CANONICAL,
...
export default function BoiseSeoPage() {
  return (
    <>
      <script id="boise-seo-faq-schema" type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(FAQ_SCHEMA) }} />
      <script id="boise-seo-local-schema" type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(LOCAL_BUSINESS_SCHEMA) }} />
      <script id="boise-seo-service-schema" type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(SERVICE_SCHEMA) }} />
      <script id="boise-seo-webpage-schema" type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(WEBPAGE_SCHEMA) }} />
      <script id="boise-seo-breadcrumb-schema" type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(BREADCRUMB_SCHEMA) }} />
      ...
      <main className="platpage">
            ...
            <div className="rv-hero-wrap">
              ...
              <div>
                <div className="rv-badge" style={{ marginBottom: '18px' }}>
                  ...
                  <span>Boise Local SEO &amp; Google Maps Engineering</span>
                </div>

                <h1 style={{ color: '#141414', margin: '0 0 20px', lineHeight: 1.12, letterSpacing: '-0.03em', fontSize: 'clamp(34px, 5.2vw, 56px)' }}>
                  Boise Local SEO Agency for Market Leaders
                </h1>

                <p className="pp-lead" style={{ color: '#494852', maxWidth: '52ch', margin: '0 0 28px', fontSize: 'clamp(16px, 1.8vw, 18.5px)', lineHeight: 1.6 }}>
                  Dominate the Google Maps 3-Pack, capture high-intent search queries, and secure AI answer citations across Boise and the Treasure Valley.
                </p>

                <div className="rv-actions">
                  <ModalCTAButton label="Get a Free Local SEO Audit" region="us" btnVariant="primary-dark" modalVariant="seo" />
                  <a href="#boise-seo-districts" className="rv-btn-secondary">
            ...
            <div className="rv-about-grid">
              ...
              <div className="rv-curved-frame-2">
                <Image
                  ...
                  alt="FactoryJet senior SEO engineers optimizing Boise local entity knowledge graph"
                  width={640}
                  height={640}
                  style={{ width: '100%', height: '100%', objectFit: 'cover', display: 'block' }}
                />
              ...
              <div>
                ...
                <h2 style={{ fontSize: 'clamp(28px, 4vw, 42px)', fontWeight: 800, color: '#141414', letterSpacing: '-0.025em', lineHeight: 1.15, margin: '0 0 14px' }}>
                  Local Search Engineered for Idaho Leaders
                </h2>

                <p className="pp-lead" style={{ color: '#494852', margin: '0 0 28px', fontSize: '16px', lineHeight: 1.6 }}>
                  From Downtown Boise legal practices to Meridian medical enclaves and Nampa contracting specialists, we build high-converting search architectures that capture Idaho buyers.
                </p>
        ...
        <section id="boise-seo-districts" className="pp-sec" style={{ backgroundColor: '#F6F6F9', borderTop: '1px solid #E6E6EC', borderBottom: '1px solid #E6E6EC' }}>
          <div className="pp-wrap">
            <div style={{ textAlign: 'center', maxWidth: '720px', margin: '0 auto 48px' }}>
              ...
              <h2 style={{ fontSize: 'clamp(28px, 4vw, 44px)', fontWeight: 800, color: '#141414', letterSpacing: '-0.025em', margin: 0 }}>
                Tailored Local Search Optimization for Idaho Sectors
              </h2>
              <p className="pp-lead" style={{ marginTop: '12px', color: '#494852' }}>
                From Downtown Boise practices to Meridian healthcare enclaves and Nampa commercial contractors:
              </p>
            </div>
        ...
        <section className="pp-sec" style={{ backgroundColor: '#FFFFFF', padding: 'clamp(64px, 9vh, 104px) 0' }}>
          <div className="pp-wrap">
            <div style={{ textAlign: 'center', maxWidth: '760px', margin: '0 auto 56px' }}>
              ...
              <h2 style={{ fontSize: 'clamp(28px, 4vw, 44px)', fontWeight: 800, color: '#141414', letterSpacing: '-0.025em', margin: 0 }}>
                Specialized Local SEO Strategies for Idaho Brands
              </h2>
              <p className="pp-lead" style={{ marginTop: '12px', color: '#494852' }}>
                Every commercial sector across the Treasure Valley demands tailored schema models, citation graphs, and map optimization:
              </p>
            </div>
        ...
        <section className="pp-sec" style={{ backgroundColor: '#F6F6F9', borderTop: '1px solid #E6E6EC', borderBottom: '1px solid #E6E6EC' }}>
          <div className="pp-wrap">
            <div style={{ textAlign: 'center', maxWidth: '720px', margin: '0 auto 48px' }}>
              ...
              <h2 style={{ fontSize: 'clamp(28px, 4vw, 44px)', fontWeight: 800, color: '#141414', letterSpacing: '-0.025em', margin: 0 }}>
                Why Boise Leaders Choose FactoryJet Local SEO
              </h2>
              <p className="pp-lead" style={{ marginTop: '12px', color: '#494852' }}>
        ...
        <div id="local-seo-blueprint">
          ...
          <div className="pp-wrap">
            <RegionalBenchmarkCard city="Boise" vertical="seo" />
          </div>
        </section>

        <LocalSeoArchitectureBlueprint
            badge="// BOISE LOCAL SEARCH &amp; AI RANKING BLUEPRINT"
            title="4-Layer Local SEO Stack: Google Maps to AI Overviews"
            subtitle="Explore how GBP API optimization, multi-directory citation syncing, structured schema graphs, and AI citation crawlers work together to dominate Boise local search."
            city="Boise"
        ...
        <section className="pp-sec" style={{ backgroundColor: '#F6F6F9', borderTop: '1px solid #E6E6EC', borderBottom: '1px solid #E6E6EC' }}>
          <div className="pp-wrap">
            <div style={{ textAlign: 'center', maxWidth: '760px', margin: '0 auto 48px' }}>
              ...
              <h2 style={{ fontSize: 'clamp(28px, 4vw, 44px)', fontWeight: 800, color: '#141414', letterSpacing: '-0.025em', margin: 0 }}>
                Evaluating Boise SEO Agencies: What to Ask
              </h2>
              <p className="pp-lead" style={{ marginTop: '12px', color: '#494852' }}>
        ...
        <LocalSeoOpportunityEstimator city="Boise" region="us" />

        {/* ── 10. SEARCHABLE CATEGORIZED FAQ SECTION ── */}
        <FAQ
          eyebrow="BOISE LOCAL SEARCH INTELLIGENCE"
          headline="Frequently Asked Questions About Local SEO in Boise ID"
          lead="Direct, plain English answers to what Idaho business owners and marketing leaders ask about Google Maps 3-Pack and search visibility:"
        ...
        <section style={{ background: '#F6F6F9', borderTop: '1px solid #E6E6EC', padding: '48px 0' }}>
          <div className="pp-wrap">
            <SeoCityLinksUS currentCity="boise" />
          </div>
        </section>
        ...
        <section className="pp-sec" style={{ backgroundColor: '#141414', color: '#FFFFFF', padding: 'clamp(64px, 10vh, 112px) 0', textAlign: 'center' }}>
          <div className="pp-wrap" style={{ maxWidth: '800px' }}>
            ...
            <h2 style={{ fontSize: 'clamp(32px, 5vw, 54px)', fontWeight: 800, color: '#FFFFFF', letterSpacing: '-0.03em', lineHeight: 1.12, margin: '0 0 20px' }}>
              Ready to Dominate Boise Local Search?
            </h2>
