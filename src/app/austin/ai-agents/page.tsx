...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: 'https://factoryjet.com/austin/ai-agents',
    images: [
      {
  ...
  alternates: {
    canonical: 'https://factoryjet.com/austin/ai-agents',
...
const webPageSchema = {
  ...
  '@type': 'WebPage',
  '@id': 'https://factoryjet.com/austin/ai-agents#webpage',
  url: 'https://factoryjet.com/austin/ai-agents',
...
const howToSchema = {
  '@context': 'https://schema.org',
  '@type': 'HowTo',
  name: 'How FactoryJet builds your Austin AI agent solution',
...
const breadcrumbSchema = {
  '@context': 'https://schema.org',
  '@type': 'BreadcrumbList',
  '@id': 'https://factoryjet.com/austin/ai-agents#breadcrumb',
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 4, name: 'AI Agents', item: 'https://factoryjet.com/austin/ai-agents' },
  ],
};
...
const COMPARISON_ROWS = [
  {
    ...
    values: [
      ...
      'Enterprise-level project rates',
...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer:
      'The ROI case is direct. A support agent handling 65% of your tickets typically pays for itself in 2–3 months for a team answering 50+ tickets per day. A lead agent responding to website visitors in under 5 seconds vs. waiting hours for a human see 2–5× higher lead-to-demo conversion. Austin restaurant and real estate clients typically recover the full build cost within 60–90 days from bookings captured after hours.',
  },
  {
    category: 'pricing',
