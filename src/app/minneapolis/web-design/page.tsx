...
export const metadata: Metadata = {
  title: 'Minneapolis Web Design Agency | Custom Next.js & UI/UX | FactoryJet',
  description:
            ...
            <div className="rv-about-grid">
              ...
              <div>
                ...
                <p className="pp-lead" style={{ color: '#494852', margin: '0 0 28px', fontSize: '16px', lineHeight: 1.6 }}>
                  From Medical Alley biomedical device giants in Plymouth to Downtown Minneapolis corporate law firms and Eden Prairie cloud software providers, we build high-converting web applications that elevate your brand equity.
                </p>
