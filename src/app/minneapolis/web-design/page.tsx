...
const CANONICAL = 'https://factoryjet.com/minneapolis/web-design';

export const metadata: Metadata = {
  title: 'Best Minneapolis Web Design Agency | Top Next.js Sites | FactoryJet',
  description:
    'Best Minneapolis web design agency. Top custom Next.js websites, sub-second load times, and custom Figma UI/UX for Minnesota businesses.',
  ...
  openGraph: {
    ...
    title: 'Best Minneapolis Web Design Agency | Top Next.js Sites | FactoryJet',
    description:
      'Minneapolis web design agency. High-converting Next.js websites, sub-second load times, and custom Figma UI/UX for Minnesota businesses.',
    url: CANONICAL,
    images: [{ url: 'https://factoryjet.com/og-default.png', width: 1200, height: 630, alt: 'Minneapolis Web Design Agency' }],
    locale: 'en_US',
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Best Minneapolis Web Design Agency | Top Next.js Sites | FactoryJet',
    description: 'Custom Next.js web design and engineering in Minneapolis MN. Sub-second performance, full IP code ownership, 7-day delivery.',
...
const DISTRICTS = [
  {
    ...
    query: 'fintech creative studio web design north loop minneapolis',
    focus: 'Fintech Platforms, Venture Capital & Creative Studios',
    desc: 'The vibrant design, tech, and urban innovation spine. Demands high-speed corporate flagships, interactive portfolio visualizers, and sub-second edge hosting.',
  },
  {
    corridor: 'Plymouth & West Metro MedTech Corridor',
    query: 'medical device healthcare medtech web design plymouth mn',
    focus: 'Medical Device Innovators, Clinical Hardware & Healthcare Systems',
    desc: 'The global Medical Alley heartland. Demands clinical-grade scientific design systems, interactive 3D device visualizers, and sub-second edge hosting.',
  },
  {
    corridor: 'Bloomington & I-494 Corporate Spine',
    query: 'fortune 500 corporate headquarters web design bloomington mn',
    focus: 'Fortune 500 Headquarters, Financial Services & Advisory',
    desc: 'Major corporate and financial headquarters corridor. Demands refined editorial typography, SOC2-compliant client portals, and enterprise security.',
  },
  {
    corridor: 'St. Paul Capital & Riverfront',
    query: 'enterprise government higher education web design st paul',
    focus: 'Government Affairs, Higher Education & Enterprise Nonprofits',
    desc: 'Historic seat of Minnesota government and higher education. Features multi-department directory architectures, accessibility compliance, and public portals.',
  },
  {
    corridor: 'Eden Prairie & Southwest Tech Nexus',
    query: 'enterprise cloud software logistics web design eden prairie',
    focus: 'Enterprise Cloud Software, Telematics & Logistics Platforms',
    desc: 'High-growth technology and supply chain software corridor. Demands developer documentation hubs, interactive demo environments, and sub-second edge speeds.',
  },
  {
    corridor: 'Northeast Arts & Commercial District',
    query: 'architecture craft beverage d2c web design northeast minneapolis',
    focus: 'Architecture Firms, Craft Beverage & Direct-to-Consumer Brands',
    desc: 'Historic creative arts and craft industrial corridor. Features tactile editorial layouts, interactive video hero modules, and smooth micro-animations.',
  },
];

const INDUSTRY_SHOWCASE = [
  {
    sector: 'Medical Alley, MedTech Devices & Clinical Diagnostic Systems',
    headline: 'Clinical-Grade Digital Flagships for Minnesota MedTech Leaders',
    description:
  ...
  {
    sector: 'Corporate Litigation, Commercial Real Estate & Financial Services',
    headline: 'Sophisticated Digital Flagships for Downtown Minneapolis & St. Paul Firms',
    description:
  ...
  {
    sector: 'Enterprise Cloud Software, Telematics & Supply Chain Tech',
  ...
  {
    sector: 'Precision Manufacturing, Heavy Automation & Clean Energy',
    headline: 'Engineering Commercial Lead Engines for Minnesota Industrial Leaders',
    description:
  ...
  {
    sector: 'Bloomington & I-494 Fortune 500 Headquarters & Financial Services',
  ...
  {
    sector: 'North Loop & St. Paul Creative Agencies, Architecture & FinTech Studios',
    headline: 'Tactile Digital Experiences for Twin Cities Creative & FinTech Leaders',
    description:
...
const PAIN_POINTS = [
  {
    ...
    problem: 'Traditional Minneapolis agencies build on bloated WordPress templates with 30+ plugins, resulting in sluggish load times, security vulnerabilities, and constant breakages.',
...
const FAQ_CATEGORIES = [
  ...
  { key: 'local', label: 'Minneapolis Focus' },
...
const FAQ_ITEMS = [
  {
    category: 'pricing',
    question: 'How much does custom web design cost for a Minneapolis business?',
    answer:
  ...
  {
    category: 'local',
    question: 'Do you have experience with Minnesota Medical Alley and MedTech companies?',
    answer:
      'Yes. We build high-credibility digital experiences for Medical Alley biomedical device manufacturers, clinical diagnostic laboratories, and healthcare platforms requiring interactive 3D models and clinical trial recruitment hubs.',
  },
  {
    category: 'local',
    question: 'Can you design websites tailored for Downtown Minneapolis legal and corporate firms?',
    answer:
      'Yes. We develop sophisticated digital flagships for corporate trial attorneys, private wealth advisors, and commercial real estate firms featuring practice area silos, executive bio schemas, and client portals.',
  },
  {
    category: 'local',
  ...
  {
    category: 'local',
    question: 'Do you design ecommerce and catalog websites for Minnesota retail and outdoor brands?',
    answer:
      'Yes. We engineer high-converting digital storefronts and product visualizers for outdoor recreation, winter sports, and consumer goods companies across the Twin Cities.',
  },
  {
    category: 'ownership',
  ...
  {
    category: 'technical',
    question: 'Why do Twin Cities enterprise businesses and healthcare platforms choose custom Next.js over WordPress templates?',
    answer:
  ...
  {
    category: 'medtech',
    question: 'How do you design clinical and 3D device visualizer web applications for Medical Alley medtech innovators?',
    answer:
      'We engineer clinical-grade digital flagships with interactive 3D medical device visualizers, clinical trial enrollment portals, gated healthcare partner data rooms, and FDA compliance documentation search to convey scientific authority to clinicians and hospital procurement teams.',
  },
  {
    category: 'performance',
    question: 'How do you guarantee sub-500ms page load speeds and 100/100 Core Web Vitals across Minnesota and the Upper Midwest?',
    answer:
  ...
  },
  {
    ...
    question: 'How do you structure custom Figma UI/UX design systems for corporate brands in Minneapolis and St. Paul?',
    answer:
  ...
  },
  {
    ...
    question: 'What ADA accessibility standards and WCAG 2.1 AA compliance protocols do you build into Minnesota websites?',
    answer:
  ...
  },
  {
    ...
    question: 'How do you handle frictionless CRM and automated lead routing for commercial service firms in Downtown Minneapolis?',
    answer:
...
const SERVICE_SCHEMA = {
  ...
  name: 'Minneapolis Web Design & Next.js Development',
  provider: {
    '@type': 'Organization',
    name: 'FactoryJet',
  ...
  description:
    'Custom Next.js web design and engineering in Minneapolis MN. Sub-second performance, full IP code ownership, and rapid 7-day delivery for Minnesota businesses.',
...
const WEBPAGE_SCHEMA = {
  '@context': 'https://schema.org',
  '@type': 'WebPage',
  name: 'Minneapolis Web Design Agency | Custom Next.js & UI/UX | FactoryJet',
  description: 'Minneapolis web design agency. High-converting Next.js websites, sub-second load times, and custom Figma UI/UX for Minnesota businesses.',
  url: CANONICAL,
...
export default function MinneapolisWebDesignPage() {
  return (
    <>
      <script id="mpls-web-faq-schema" type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(FAQ_SCHEMA) }} />
      <script id="mpls-web-local-schema" type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(LOCAL_BUSINESS_SCHEMA) }} />
      <script id="mpls-web-service-schema" type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(SERVICE_SCHEMA) }} />
      <script id="mpls-web-webpage-schema" type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(WEBPAGE_SCHEMA) }} />
      <script id="mpls-web-breadcrumb-schema" type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(BREADCRUMB_SCHEMA) }} />
      ...
      <main className="platpage">
            ...
            <div className="rv-hero-wrap">
              ...
              <div>
                <div className="rv-badge" style={{ marginBottom: '18px' }}>
                  ...
                  <span>Minneapolis Web Design &amp; Full-Stack Engineering</span>
                </div>

                <h1 style={{ color: '#141414', margin: '0 0 20px', lineHeight: 1.12, letterSpacing: '-0.03em', fontSize: 'clamp(34px, 5.2vw, 56px)' }}>
                  Minneapolis Web Design Agency for High-Growth Brands
                </h1>

                <p className="pp-lead" style={{ color: '#494852', maxWidth: '52ch', margin: '0 0 28px', fontSize: 'clamp(16px, 1.8vw, 18.5px)', lineHeight: 1.6 }}>
                  Custom Next.js 15 websites, bespoke Figma UI/UX, and sub-second performance engineered for Minnesota leaders. 7-day agile delivery with 100% intellectual property code ownership.
                </p>

                <div className="rv-actions">
                  <ModalCTAButton label="Get a Fixed-Price Quote" region="us" btnVariant="primary-dark" />
                  <a href="#mpls-web-districts" className="rv-btn-secondary">
            ...
            <div className="rv-about-grid">
              ...
              <div className="rv-curved-frame-2">
                <Image
                  ...
                  alt="FactoryJet senior UI UX designers collaborating on custom Minneapolis web design sprint"
                  width={640}
                  height={640}
                  style={{ width: '100%', height: '100%', objectFit: 'cover', display: 'block' }}
                />
              ...
              <div>
                ...
                <h2 style={{ fontSize: 'clamp(28px, 4vw, 42px)', fontWeight: 800, color: '#141414', letterSpacing: '-0.025em', lineHeight: 1.15, margin: '0 0 14px' }}>
                  Web Design Engineered for Twin Cities Market Leaders
                </h2>

                <p className="pp-lead" style={{ color: '#494852', margin: '0 0 28px', fontSize: '16px', lineHeight: 1.6 }}>
                  From Medical Alley biomedical device giants in Plymouth to Downtown Minneapolis corporate law firms and Eden Prairie cloud software providers, we build high-converting web applications that accelerate your commercial growth.
                </p>
        ...
        <section id="mpls-web-districts" className="pp-sec" style={{ backgroundColor: '#F6F6F9', borderTop: '1px solid #E6E6EC', borderBottom: '1px solid #E6E6EC' }}>
          <div className="pp-wrap">
            <div style={{ textAlign: 'center', maxWidth: '720px', margin: '0 auto 48px' }}>
              ...
              <h2 style={{ fontSize: 'clamp(28px, 4vw, 44px)', fontWeight: 800, color: '#141414', letterSpacing: '-0.025em', margin: 0 }}>
                Tailored Web Design for Minnesota&apos;s Core Sectors
              </h2>
              <p className="pp-lead" style={{ marginTop: '12px', color: '#494852' }}>
                From Medical Alley innovators to Downtown corporate law and Eden Prairie enterprise tech:
              </p>
            </div>
        ...
        <section className="pp-sec" style={{ backgroundColor: '#FFFFFF', padding: 'clamp(64px, 9vh, 104px) 0' }}>
          <div className="pp-wrap">
            <div style={{ textAlign: 'center', maxWidth: '760px', margin: '0 auto 56px' }}>
              ...
              <h2 style={{ fontSize: 'clamp(28px, 4vw, 44px)', fontWeight: 800, color: '#141414', letterSpacing: '-0.025em', margin: 0 }}>
                Specialized Web Architectures for Minnesota Brands
              </h2>
              <p className="pp-lead" style={{ marginTop: '12px', color: '#494852' }}>
                Every commercial sector in the Twin Cities metro demands tailored user flows, design tokens, and performance metrics:
              </p>
            </div>
        ...
        <section className="pp-sec" style={{ backgroundColor: '#F6F6F9', borderTop: '1px solid #E6E6EC', borderBottom: '1px solid #E6E6EC' }}>
          <div className="pp-wrap">
            <div style={{ textAlign: 'center', maxWidth: '720px', margin: '0 auto 48px' }}>
              ...
              <h2 style={{ fontSize: 'clamp(28px, 4vw, 44px)', fontWeight: 800, color: '#141414', letterSpacing: '-0.025em', margin: 0 }}>
                Why Minneapolis Leaders Choose FactoryJet Web Design
              </h2>
              <p className="pp-lead" style={{ marginTop: '12px', color: '#494852' }}>
        ...
        <div id="web-design-blueprint">
          <WebDesignArchitectureBlueprint
            badge="// MINNEAPOLIS FRONTEND STACK &amp; CORE WEB VITALS BLUEPRINT"
        ...
        <section className="pp-sec" style={{ backgroundColor: '#F6F6F9', borderTop: '1px solid #E6E6EC', borderBottom: '1px solid #E6E6EC' }}>
          <div className="pp-wrap">
            <div style={{ textAlign: 'center', maxWidth: '760px', margin: '0 auto 48px' }}>
              ...
              <h2 style={{ fontSize: 'clamp(28px, 4vw, 44px)', fontWeight: 800, color: '#141414', letterSpacing: '-0.025em', margin: 0 }}>
                Evaluating Minneapolis Web Design Agencies: What to Ask
              </h2>
              <p className="pp-lead" style={{ marginTop: '12px', color: '#494852' }}>
        ...
        <WebDesignValueCalculator city="Minneapolis" region="us" />

        {/* ── 10. SEARCHABLE CATEGORIZED FAQ SECTION ── */}
        <FAQ
          eyebrow="MINNEAPOLIS WEB DESIGN INTELLIGENCE"
          headline="Frequently Asked Questions About Web Design in Minneapolis MN"
          lead="Direct, plain English answers to what Twin Cities business owners and marketing leaders ask about website design and engineering:"
        ...
        <section style={{ background: '#F6F6F9', borderTop: '1px solid #E6E6EC', padding: '48px 0' }}>
          <div className="pp-wrap">
            <WebDesignCityLinksUS currentCity="minneapolis" />
          </div>
        </section>
        ...
        <section className="pp-sec" style={{ backgroundColor: '#141414', color: '#FFFFFF', padding: 'clamp(64px, 10vh, 112px) 0', textAlign: 'center' }}>
          <div className="pp-wrap" style={{ maxWidth: '800px' }}>
            ...
            <h2 style={{ fontSize: 'clamp(32px, 5vw, 54px)', fontWeight: 800, color: '#FFFFFF', letterSpacing: '-0.03em', lineHeight: 1.12, margin: '0 0 20px' }}>
              Ready to Upgrade Your Twin Cities Web Presence?
            </h2>
