    ...
    <section className="bg-white py-16 md:py-24">
      <div className="max-w-7xl mx-auto px-5 sm:px-8">
        ...
        <div className="text-center mt-10">
          <button
            onClick={handleCTA}
            className="inline-flex items-center gap-2 px-8 py-4 bg-[#0052CC] hover:bg-[#003d99] text-white font-bold rounded-lg transition-all duration-200 shadow-lg shadow-[#0052CC]/20 cursor-pointer"
          >
