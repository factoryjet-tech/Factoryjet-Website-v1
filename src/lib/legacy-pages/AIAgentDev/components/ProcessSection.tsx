    ...
    <section className="bg-[#0a0f1c] py-16 md:py-24">
      <div className="max-w-7xl mx-auto px-5 sm:px-8">
        ...
        <div className="text-center mt-10">
          <button
            onClick={handleCTA}
            className="inline-flex items-center gap-2 px-8 py-4 bg-[#FF6B35] hover:bg-[#e55a25] text-white font-bold rounded-lg transition-all duration-200 shadow-lg shadow-[#FF6B35]/20 cursor-pointer"
          >
