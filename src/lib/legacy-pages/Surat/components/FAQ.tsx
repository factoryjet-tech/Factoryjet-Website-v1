...
const FAQ: React.FC = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: 'Absolutely! We serve Surat businesses directly. Visit our office or we\'ll come to you. Most clients prefer a mix of in-person kickoff + WhatsApp updates.',
    },
    {
      question: 'Do you work with businesses outside Surat?',
      answer: 'Yes! We serve clients across Gujarat and India. But our core strength is Surat & Gujarat (Ahmedabad, Vadodara, Rajkot). Local businesses get priority support.',
    },
    {
    ...
    },
    {
      ...
      answer: 'Yes, every site includes basic SEO + Google My Business setup. For serious ranking (like "best textile company Surat"), we have dedicated SEO packages.',
    },
    {
      question: "What's included in AMC (maintenance)?",
      answer: 'Security updates, backups, uptime monitoring, and content updates. Starts at ₹2,999/month. Most Surat businesses choose Standard at ₹4,999 for WhatsApp support.',
    },
    {
      ...
      <div className="container mx-auto px-4 md:px-6 max-w-3xl">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold text-jet-navy font-heading">
            Questions Surat Business Owners Ask
          </h2>
        </motion.div>
