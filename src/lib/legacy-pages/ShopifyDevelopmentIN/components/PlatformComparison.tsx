        ...
        <div className="cmp-visual reveal">
          ...
          <div className="cmp-upgrade-card reveal reveal-d1">
            ...
            <div className="cmp-signals">
              <div className="cmp-signal"><svg viewBox="0 0 24 24"><polyline points="20 6 9 17 4 12"/></svg><span>Monthly revenue consistently exceeds <strong>₹66,40,000 to ₹83,00,000/month</strong></span></div>
