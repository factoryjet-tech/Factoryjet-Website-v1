...
export default function ShopifyDevelopmentPage() {
  ...
  const shopifyFaqSchema = {
    ...
    mainEntity: [
      ...
      { "@type": "Question", name: "What makes FactoryJet different from other Shopify agencies?", acceptedAnswer: { "@type": "Answer", text: "FactoryJet combines AI-native development, deep Shopify expertise, and enterprise-grade execution. 120+ Shopify and Shopify Plus stores delivered, part of 523 websites delivered for 500+ clients globally, clients across 9 countries, at a fixed, published price, built-in SEO, AEO, and GEO optimization." } },
