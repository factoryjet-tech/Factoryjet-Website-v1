...
const sitemapData: SitemapSection[] = [
  ...
  },
  {
    ...
    links: [
      ...
      { name: 'Case Studies', path: '/case-studies', description: 'Real success stories from our clients' },
    ],
  },
  {
    title: 'Locations',
    icon: MapPin,
    links: [
      { name: 'Mumbai', path: '/web-design/mumbai', description: 'Web design services in Mumbai' },
      { name: 'Pune', path: '/web-design/pune', description: 'Web design services in Pune' },
      { name: 'Bangalore', path: '/web-design/bangalore', description: 'Web design services in Bangalore' },
      { name: 'Delhi NCR', path: '/web-design/delhi', description: 'Web design services in Delhi NCR' },
      { name: 'Chennai', path: '/web-design/chennai', description: 'Web design services in Chennai' },
      { name: 'Hyderabad', path: '/web-design/hyderabad', description: 'Web design services in Hyderabad' },
      { name: 'Ahmedabad', path: '/web-design/ahmedabad', description: 'Web design services in Ahmedabad' },
      { name: 'Surat', path: '/web-design/surat', description: 'Web design services in Surat' },
      { name: 'Madurai', path: '/web-design/madurai', description: 'Web design services in Madurai' },
    ],
  },
  {
    title: 'Legal',
    icon: Scale,
    links: [
      { name: 'Terms of Service', path: '/terms-and-conditions', description: 'Terms and conditions for using our services' },
      { name: 'Privacy Policy', path: '/privacy-policy', description: 'How we protect and use your data' },
    ],
  },
];
