...
export const post: BlogPost = {
  ...
  faqs: [
    ...
    },
    {
      ...
      a: "A professional 5-page website should take 7–21 days with a modern agency. Charlotte local agencies typically quote 8–14 weeks. FactoryJet delivers 5-page Charlotte small business sites in 7 days using a productized parallel process. Key dependency: client readiness. Show up to kickoff with your logo, brand colors, copy, and key images, and 7-day delivery is consistently achievable. Businesses that are still finalizing copy after kickoff should expect a 2–4 week extension.",
    },
    {
      q: 'Why should a Charlotte small business consider FactoryJet over a local agency?',
      a: "Consider FactoryJet if your priorities are: Lighthouse 100/100 performance (we guarantee it on every project), 7-day delivery, full technical SEO included, WCAG 2.2 compliance, and a starting price of $1,999 — about 70% less than a comparable Charlotte local agency. We've served 500+ US businesses since 1999 with named US client references available. If you need weekly in-person meetings, a local Charlotte agency is the better fit. For everything else — FactoryJet delivers. Get a free quote at factoryjet.com/contact.",
    },
  ],
  content: (
    <>
      <div className="bg-gray-50 p-6 rounded-lg mb-8 border">
        ...
        <ul className="list-disc pl-5 space-y-1 text-blue-700">
          <li>Charlotte's SMB Web Design Landscape in 2026</li>
          <li>Finance and Professional Services Web Design</li>
          <li>Healthcare and Wellness Requirements</li>
          <li>Real Estate and Construction Web Design</li>
          <li>Local SEO for Charlotte Businesses</li>
          <li>What Charlotte Agencies Charge</li>
          <li>Performance Standards Every Charlotte Business Should Demand</li>
          <li>What FactoryJet Delivers for Charlotte SMBs</li>
        </ul>
      </div>
      ...
      <p className="mb-4">
        Charlotte's finance and professional services SMBs operate in a credibility economy: prospective clients research online before they call. A website that looks dated, loads slowly, or lacks structured information about credentials, services, and client results will lose those prospects to competitors before contact.
      </p>
      <p className="mb-4">
      ...
      <h2 className="text-2xl font-bold mt-8 mb-4">What Charlotte Agencies Charge</h2>
        ...
        <table className="min-w-full border-collapse border border-gray-300">
          ...
          <tbody>
            <tr className="bg-white">
              <td className="border p-3">Top Charlotte agencies</td>
              <td className="border p-3">$10,000–$18,000</td>
              <td className="border p-3">$18,000–$35,000</td>
              <td className="border p-3">10–18 weeks</td>
            </tr>
            <tr className="bg-gray-50">
              <td className="border p-3">Mid-market Charlotte agencies</td>
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 mt-8">
        <h3 className="text-lg font-bold mb-2 text-blue-900">Charlotte SMB Web Design Checklist</h3>
        <p className="text-blue-800 mb-3">Before hiring any Charlotte web design agency, confirm:</p>
        <ul className="list-disc pl-5 space-y-1 text-blue-800">
          <li>Lighthouse mobile Performance 90+ on a live client site you ran yourself</li>
          <li>WCAG 2.2 Level AA compliance included in base price</li>
          <li>LocalBusiness schema markup included</li>
          <li>Fixed-price contract with itemized scope</li>
          <li>Full code ownership at project completion</li>
          <li>Named US client references you can call independently</li>
        </ul>
      </div>
    </>
  ),
