...
export const post: BlogPost = {
  ...
  excerpt: "Building an online store in 2026 means choosing between Shopify (£29–£384/mo), WooCommerce (£50–£200/mo hosting + plugins), or custom custom headless B2B platforms for complex B2B workflows. UK SMBs need PCI DSS compliance, GDPR-ready checkout, and mobile-first design to compete.",
  ...
  keyTakeaways: [
    ...
    "Custom custom headless B2B platforms suit B2B businesses needing quote workflows, trade accounts, and Net 30/60/90 payment terms that off-the-shelf solutions can't handle.",
    ...
    "FactoryJet builds UK e-commerce stores for £2,000–£8,000 with 2–4 week delivery, at a fixed, transparent price, including GDPR compliance and Lighthouse 92+ performance.",
  ],
  faqs: [
    ...
    { q: "Do I need a custom e-commerce platform or is Shopify enough?", a: "Shopify handles 90% of B2C retail needs. Go custom if you require B2B quote workflows, multi-tier pricing, trade account management, Net 30/60/90 payment terms, or complex inventory across warehouses. GPSUK in Staines uses a custom B2B e-commerce platform for Request for Quote workflows, artwork upload, and print-preview visualisation—features Shopify can't replicate without £10,000+ in app costs and custom development." },
