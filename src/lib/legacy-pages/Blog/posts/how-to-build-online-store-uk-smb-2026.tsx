...
export const post: BlogPost = {
  ...
  keyTakeaways: [
    ...
    "FactoryJet builds UK e-commerce stores for £2,000–£8,000 with 2–4 week delivery, at a fixed, published price, including GDPR compliance and Lighthouse 92+ performance.",
  ],
  faqs: [
