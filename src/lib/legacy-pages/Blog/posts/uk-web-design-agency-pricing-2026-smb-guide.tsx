...
export const post: BlogPost = {
  ...
  keyTakeaways: [
    ...
    "Offshore partners like FactoryJet deliver UK-standard builds at £1,500–£8,000 (at a fixed, transparent price) with 2-4 week turnaround and Lighthouse 92+ performance.",
  ...
  faqs: [
    ...
    { q: "Can offshore agencies match UK quality standards for web design?", a: "Yes, top offshore agencies like FactoryJet (Bengaluru HQ, serving UK SMBs) deliver Lighthouse 92+ performance, WCAG 2.1 AA accessibility, and UK data protection compliance at a fixed, transparent price. Key is verifying real client references (e.g., GPSUK in Staines), checking live portfolio sites, and ensuring UK business hours overlap for communication." },
