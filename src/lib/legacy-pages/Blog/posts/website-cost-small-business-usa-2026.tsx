...
export const post: BlogPost = {
  ...
  faqs: [
    ...
    },
    {
      ...
      a: "Use Wix if: your budget is under $500, you're testing a business concept, you have time to build and maintain it yourself, and SEO isn't a priority. Hire an agency if: you need Google search visibility, your brand requires credibility with B2B buyers, you sell products online, or your time is worth more than $50/hour. Wix sites rarely rank competitively for commercial keywords because their technical SEO architecture (JavaScript rendering, limited structured data, shared hosting) can't match a properly optimized Next.js or WordPress build.",
    },
    {
  ...
  content: (
    <>
        ...
        <table className="min-w-full border-collapse border border-gray-300">
          <thead className="bg-gray-800 text-white">
            <tr>
              ...
              <th className="p-3 border text-left">Upfront Cost</th>
              <th className="p-3 border text-left">Monthly Cost</th>
              <th className="p-3 border text-left">Timeline</th>
              <th className="p-3 border text-left">SEO Ceiling</th>
            </tr>
          </thead>
          <tbody>
            ...
            <tr className="bg-gray-50">
              <td className="border p-3">Freelancer</td>
            ...
            <tr className="bg-white">
              <td className="border p-3">US Domestic Agency</td>
      ...
      <h2 className="text-2xl font-bold mt-8 mb-4">Tier 3: US Domestic Agencies ($8,000–$25,000)</h2>
      <p className="mb-4">
        ...
        <table className="min-w-full border-collapse border border-gray-300">
          <thead className="bg-gray-800 text-white">
            <tr>
              ...
              <th className="p-3 border text-left">Agency Build Cost</th>
              <th className="p-3 border text-left">Monthly Platform Fee</th>
          ...
          <tbody>
            ...
            <tr className="bg-white">
              <td className="border p-3">Headless / Next.js Commerce</td>
      ...
      <p className="mb-4">
        <strong>Copywriting:</strong> Most agencies quote design and development, not copy. Professional copywriting runs $100–$350 per page. A five-page site adds $500–$1,750 if you can't write your own content. Always ask whether copy is included in the quote, or whether you need to supply it.
      </p>
      <p className="mb-4">
        <strong>Stock photography:</strong> Hero images, team photos, and service illustrations can add $300–$2,000 if not included. Some agencies license images; others add them to the scope after kickoff. Clarify upfront whether the quote includes licensed imagery.
      </p>
      <p className="mb-4">
        <strong>Logo and brand assets:</strong> Agencies frequently quote websites assuming you have a vector logo and brand colors. If you don't, logo design adds $500–$2,500. Some agencies bundle basic brand kits; most don't.
      </p>
      <p className="mb-4">
        <strong>Revision overruns:</strong> Contracts with "unlimited revisions" clauses often define revisions so narrowly that any meaningful change triggers a change order. Request a contract that specifies exactly what constitutes a revision (e.g., "two rounds of design feedback per page") versus new work billed hourly.
      </p>
      <p className="mb-4">
        ...
        <table className="min-w-full border-collapse border border-gray-300">
          <thead className="bg-gray-800 text-white">
            <tr>
              ...
              <th className="p-3 border text-left">DIY</th>
              <th className="p-3 border text-left">Freelancer</th>
              <th className="p-3 border text-left">Agency Plan</th>
            </tr>
          </thead>
          <tbody>
            <tr className="bg-white">
              <td className="border p-3">Hosting</td>
              <td className="border p-3">$23–$65 (builder)</td>
              <td className="border p-3">$20–$60</td>
              <td className="border p-3">Included</td>
            </tr>
            <tr className="bg-gray-50">
              <td className="border p-3">Security monitoring</td>
              <td className="border p-3">$0 (no coverage)</td>
              <td className="border p-3">$15–$40</td>
              <td className="border p-3">Included</td>
            </tr>
            <tr className="bg-white">
              <td className="border p-3">CMS/plugin updates</td>
              <td className="border p-3">Manual (your time)</td>
            ...
            <tr className="bg-gray-50">
              ...
              <td className="border p-3">$50–$150/hr</td>
              <td className="border p-3">1–2 hrs/month</td>
            </tr>
            <tr className="bg-white">
              <td className="border p-3"><strong>Total monthly</strong></td>
              <td className="border p-3"><strong>$23–$65 + your time</strong></td>
              <td className="border p-3"><strong>$135–$350+</strong></td>
              <td className="border p-3"><strong>$99–$299 (all-in)</strong></td>
            </tr>
          </tbody>
        </table>
      </div>
      ...
      <h2 className="text-2xl font-bold mt-8 mb-4">How to Compare Quotes Line by Line</h2>
      <p className="mb-4">
