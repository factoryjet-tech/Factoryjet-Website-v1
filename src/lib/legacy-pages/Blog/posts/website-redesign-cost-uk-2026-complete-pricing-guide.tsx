...
export const post: BlogPost = {
  ...
  keyTakeaways: [
    ...
    "GPSUK in Staines rebuilt their B2B promotional products platform on Commerceflo for under £6,000, gaining request-for-quote workflows and trade account management that increased average order value by 35%.",
  ],
  faqs: [
        ...
        <table className="min-w-full border-collapse border border-gray-300">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td className="border p-3">Shopify / WooCommerce / Commerceflo</td>
