...
export const post: BlogPost = {
  ...
  faqs: [
    { q: "What's the average cost to redesign a business website in the UK in 2026?", a: "UK SMB website redesigns range £1,500-£8,000 depending on complexity, platform choice, and AI feature integration. A 10-page Next.js site with AI chatbot typically costs £3,500-£5,000, while full e-commerce redesigns with AI personalisation run £5,000-£8,000. FactoryJet delivers these projects at a fixed, transparent price with 2-4 week turnaround." },
