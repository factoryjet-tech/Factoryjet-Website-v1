...
export const post: BlogPost = {
  ...
  keyTakeaways: [
    ...
    'AI SEO cost in UK runs roughly £550–£6,000/month. Only 3 of the 10 agencies publish pricing: Convert Digital (£550–£6,000/mo), Reposition (£750–£3,000/mo bands), and FactoryJet ($2,499 audit; retainers from $1,999/mo).',
  ...
  faqs: [
    ...
    },
    {
      ...
      a: 'AI SEO cost in UK runs roughly £550–£6,000 per month. Verified published prices: Convert Digital £550–£6,000/mo with AI SEO in every tier, Reposition £750–£3,000/mo packages, FactoryJet $2,499 one-time audit plus retainers from $1,999/mo. Most UK specialists (Found, Blue Array, Varn, GA Agency, Passion Digital) do not publish pricing — ask for the number in writing before any discovery call.',
    },
    {
    ...
    },
    {
      ...
      a: 'LLM SEO is the same discipline as AI SEO/GEO under a different label. Found (with its Luminr LLM-tracking platform) and Passion Digital (LLM Performance Tracking sub-service) are the strongest at measurement; FactoryJet is the strongest at SMB delivery with published pricing.',
    },
    {
    ...
    },
    {
      ...
      a: 'Generative engine optimization cost in UK typically lands inside normal AI SEO retainers — £550–£6,000/mo at published-price agencies. If you are asking how much does generative engine optimization cost in UK as a separate line item, be cautious: GEO and AI SEO are one workflow, and an agency quoting both separately is billing twice for the same work.',
    },
    {
      q: 'What is AI SEO?',
    ...
    {
      q: 'What about AI SEO for businesses outside London — Glasgow, Manchester, Brighton?',
  ...
  content: (
    <>
      ...
      <p className="mb-4">
        ...
        competitors with their actual strengths — including where they beat us.
      </p>
        ...
        <table className="min-w-full border-collapse border border-gray-300">
          ...
          <tbody>
            <tr className="bg-white">
              ...
              <td className="p-3 border font-semibold">Yes — $2,499 audit; from $1,999/mo</td>
              <td className="p-3 border">SMBs &amp; ecommerce wanting published pricing</td>
            </tr>
      ...
      <p className="mb-4">
        Only three of ten publish prices. Keep that in mind when you compare quotes — opacity is the
      ...
      <p className="mb-4">
        We build and optimize for AI search the way we build websites: senior engineers, fixed
        published pricing, no annual lock-in. Every retainer covers both Google and the four major
        AI engines — ChatGPT, Perplexity, Claude, and Gemini — plus Google AI Overviews, with
        per-engine citation counts reported monthly.
      </p>
      <p className="mb-4">
        <strong>Why we rank ourselves first for SMBs:</strong> published pricing ($2,499 one-time AI
        visibility audit; Growth retainer from $1,999/mo; Scale from $4,999/mo), month-to-month
        ...
        <table className="min-w-full border-collapse border border-gray-300">
          ...
          <tbody>
            ...
            <tr className="bg-gray-50">
              ...
              <td className="p-3 border">Reposition packages; FactoryJet Growth ($1,999/mo ≈ £1,575)</td>
            </tr>
            <tr className="bg-white">
              <td className="p-3 border font-semibold">Mid-market</td>
              <td className="p-3 border">£2,500–£6,000</td>
              <td className="p-3 border">Convert Digital Gold–Bespoke; FactoryJet Scale (from $4,999/mo)</td>
            </tr>
            <tr className="bg-gray-50">
      ...
      <p className="mb-4">
        One-time audits: FactoryJet&apos;s AI visibility audit is $2,499 (published); The SEO Works
        offers a free entry-level LLM audit; Varn&apos;s AI Visibility Framework is quoted on
        request. And on generative engine optimization cost in UK specifically: GEO is not a
        separate product — it should live inside the retainer, not on top of it.
      </p>
      ...
      <div className="bg-orange-50 border border-orange-200 p-5 rounded-lg my-8">
        ...
        <p className="text-orange-800 mb-3">
          Bhavesh runs every discovery call himself. Start with a 30-minute call or the $2,499 AI
