...
export const post: BlogPost = {
  ...
  faqs: [
    ...
    { q: "How do I optimise WooCommerce product pages for UK search intent?", a: "Use British spelling and terminology throughout product titles, descriptions, and meta tags. Research what UK shoppers actually search — 'trainers' outperforms 'sneakers' 8:1 in UK Google data. Include VAT-inclusive pricing in schema markup. Add UK delivery timeframes and costs prominently. Reference British sizing standards (UK 8, not US 10). Mention payment methods popular in Britain like Klarna, Clearpay, and PayPal Pay in 3." },
        ...
        <table className="min-w-full border-collapse border border-gray-300">
          ...
          <tbody>
            ...
            <tr className="bg-gray-100 font-bold">
              ...
              <td className="border p-3">Faster than 95% of UK WooCommerce sites</td>
            </tr>
          </tbody>
        </table>
      </div>
