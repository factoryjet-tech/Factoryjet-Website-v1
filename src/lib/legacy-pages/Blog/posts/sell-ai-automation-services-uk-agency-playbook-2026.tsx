...
export const post: BlogPost = {
  ...
  title: "How to Sell AI Automation Services in 2026: The UK Agency Playbook (12+ Years Refined)",
    ...
    <>
      <div className="bg-gray-50 p-6 rounded-lg mb-8 border">
        ...
        <ul className="list-disc pl-5 space-y-1 text-blue-700">
          ...
          <li>The FactoryJet AI Automation Sales Playbook: 12+ Years Distilled</li>
        </ul>
      </div>
      ...
      <h2 className="text-2xl font-bold mt-8 mb-4">The FactoryJet AI Automation Sales Playbook: 12+ Years Distilled</h2>
