...
export const post: BlogPost = {
  ...
  content: (
    <>
      ...
      <p className="mb-6">➡ Ready to work with an agency that delivers? <a href="/us/services/web-design" className="text-blue-600 underline hover:text-blue-800 transition-colors">FactoryJet web design for US small businesses</a> — from $1,999, delivered in 7 days, Lighthouse 100/100. Or explore our <a href="/us/" className="text-blue-600 underline hover:text-blue-800 transition-colors">full range of US services</a>.</p>
