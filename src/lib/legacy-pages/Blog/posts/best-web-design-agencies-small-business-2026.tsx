...
export const post: BlogPost = {
  ...
  excerpt: "Small businesses in 2026 can access enterprise-grade web design—AI chatbots, headless CMS, 90+ Lighthouse scores—at 50-60% below traditional agency rates. The key is finding agencies that combine offshore efficiency with UK/US market expertise.",
  ...
  meta: {
    title: "8 Best Web Design Agencies for Small Business in 2026",
