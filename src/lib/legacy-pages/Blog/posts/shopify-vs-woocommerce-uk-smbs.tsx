...
export const post: BlogPost = {
  ...
  content: (
    <>
      ...
      <p className="mb-6">➡ We build both: <a href="/services/shopify-development" className="text-blue-600 underline hover:text-blue-800 transition-colors">Shopify stores from $2,499</a> and <a href="/services/web-design" className="text-blue-600 underline hover:text-blue-800 transition-colors">custom websites from $1,999</a> — both delivered in 7 days for US small businesses.</p>
