...
export const post: BlogPost = {
  ...
  keyTakeaways: [
    "UK e-commerce agency pricing ranges £2,000–£25,000 for SMB projects; offshore-supported agencies like FactoryJet deliver at a fixed, transparent price while maintaining UK project management.",
  ...
  content: (
    <>
      ...
      <h2 className="text-2xl font-bold mt-8 mb-4">How FactoryJet Delivers UK-Standard E-Commerce at a Fixed, Published Price</h2>
