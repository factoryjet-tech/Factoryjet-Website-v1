...
export const post: BlogPost = {
  ...
  faqs: [
    ...
    { q: "Which platform is easier to maintain: Shopify or WooCommerce?", a: "Shopify is easier, updates, security, and hosting are managed. WooCommerce requires monthly plugin updates, security monitoring, and hosting management. FactoryJet offers WooCommerce maintenance from £99/month covering updates, backups, security scans, and uptime monitoring, making WooCommerce as hands-off as Shopify. Which tier fits depends on store size, so we confirm it on a call." },
  ],
  content: (
    <>
