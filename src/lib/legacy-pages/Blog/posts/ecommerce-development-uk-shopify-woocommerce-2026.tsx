...
export const post: BlogPost = {
  ...
  faqs: [
    ...
    { q: "Which platform is better for B2B e-commerce in the UK?", a: "WooCommerce is better for B2B. It supports custom pricing per customer, quote requests, Net 30/60/90 payment terms, and tiered pricing out-of-the-box or via plugins like WooCommerce Wholesale Suite. Shopify requires Shopify Plus (£1,600+/month) for equivalent B2B features. FactoryJet built GPSUK's B2B platform on Commerceflo with RFQ workflows, trade accounts, and artwork upload—capabilities difficult to replicate on standard Shopify." },
    ...
    <>
      <div className="bg-gray-50 p-6 rounded-lg mb-8 border">
        ...
        <ul className="list-disc pl-5 space-y-1 text-blue-700">
          ...
          <li>Real UK Case Study: B2B E-Commerce on Commerceflo</li>
      ...
      <h2 className="text-2xl font-bold mt-8 mb-4">Real UK Case Study: B2B E-Commerce on Commerceflo</h2>
