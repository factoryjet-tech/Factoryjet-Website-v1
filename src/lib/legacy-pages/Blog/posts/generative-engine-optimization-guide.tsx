...
export const post: BlogPost = {
  ...
  content: (
    <>
      ...
      <p className="mb-4">If you would rather see the delivery scope than the theory, our <a href="/services/generative-engine-optimization" className="text-orange-600 underline">AI search optimization services</a> page sets out the engagement stage by stage: what gets audited first, what gets restructured, and which engines get measured each month.</p>
