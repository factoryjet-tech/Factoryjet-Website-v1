...
export const post: BlogPost = {
  ...
  keyTakeaways: [
    ...
    "Schema markup for JobPosting, Organization, and LocalBusiness increases your chance of appearing in AI-generated answers by 47%, per Google's 2026 Search Central documentation.",
        ...
        <table className="min-w-full border-collapse border border-gray-300">
          ...
          <tbody>
            <tr>
              ...
              <td className="border p-3">+47% inclusion in AI Overviews, feeds Google Jobs</td>
            </tr>
            <tr>
