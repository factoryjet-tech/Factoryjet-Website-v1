...
const CITIES = {
  boise: {
    ...
    stats: [{ num: "845K+", label: "Boise Metro Population" }, { num: "7.83%", label: "YoY Small Business Growth — Highest in US" }, { num: "3 Weeks", label: "Average Store Launch Time" }],
  ...
  chattanooga: {
    ...
    hero: { badge: "⚡ E-Commerce & AI Development in Chattanooga, TN", h1: "Chattanooga E-Commerce Development — Gig-Speed Stores for Gig City", sub: "Custom online stores and AI solutions for the city with America's fastest internet. Shopify, WooCommerce, and headless builds — launched in weeks, built to convert Chattanooga's 10.7M annual visitors." },
  ...
  fargo: {
    ...
    stats: [{ num: "24,229", label: "Small Businesses in Fargo-Moorhead" }, { num: "180%", label: "Economy Growth Over 20 Years" }, { num: "21 Days", label: "Typical Store Launch Timeline" }],
    ...
    <div className="fj-root">
      ...
      <main id="main-content">
        ...
        <FadeIn><section className="fj-section fj-dark" aria-labelledby="process-heading"><div className="fj-container">
          ...
          <h2 id="process-heading" className="fj-h2" style={{color:"#fff"}}>From Idea to Revenue in 3 Weeks</h2>
