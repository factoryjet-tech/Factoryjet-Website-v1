  ...
  const services = [
    {
      ...
      description: 'Custom, mobile-responsive websites built for Bangalore businesses. From corporate sites to landing pages, we deliver in 4 weeks flat.',
      features: [
    ...
    },
    {
      ...
      description: 'Full-featured online stores with UPI, Razorpay, and all Indian payment gateways. Start selling to Bangalore and all of India.',
      features: [
  ...
  const miniFeatures = [
    {
      ...
      description: 'Go live faster than any Delhi agency. Guaranteed.',
    },
    {
      icon: CreditCard,
    ...
    },
    {
      ...
      description: 'Local support. Meet us in Bangalore. WhatsApp anytime.',
    },
  ];
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        ...
        >
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-jet-navy font-heading mb-4">
            Everything Bangalore SMBs Need to Grow Online
          </h2>
