  ...
  const steps = [
    {
      ...
      duration: '15 min',
      description: "We understand your Bangalore business, goals, and competition. Get a clear roadmap—no jargon, no pressure.",
    ...
    },
    {
      ...
      duration: 'Week 1-2',
      description: "See your website before we build it. Revisions within agreed scope until you love it. We share progress via WhatsApp daily.",
      badge: 'Revisions Included',
    ...
    },
    {
      ...
      duration: 'Week 3-4',
      description: "Go live with full training. We don't disappear—ongoing support from our Bangalore team whenever you need.",
