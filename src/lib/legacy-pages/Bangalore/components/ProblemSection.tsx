  ...
  const problems = [
    {
      ...
      description: 'Every day without a proper website, Bangalore businesses like yours lose customers to competitors with modern, mobile-friendly stores. 60%+ of your customers search on mobile first.',
      span: 'lg:col-span-2',
      color: 'text-red-500',
    },
    {
      ...
      description: "That Wix site you built? It's slow on Indian networks, doesn't support UPI/Razorpay, has zero local SEO, and isn't optimized for Karnataka customers.",
      span: '',
      color: 'text-yellow-500',
    },
    {
      icon: Banknote,
      title: 'Big Agencies Overcharge Bangalore SMBs',
      description: "Delhi agencies charge ₹5+ lakhs for basic websites. Then take 3-6 months to deliver. You need results now, not next year.",
      span: '',
      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        >
          <h2 className="text-2xl md:text-4xl font-bold text-jet-navy font-heading max-w-4xl mx-auto">
            Is Your Website Costing You Sales? Bangalore Businesses Lose ₹50,000+ Monthly to Poor Websites.
          </h2>
        </motion.div>
        ...
        >
          <p className="text-lg text-jet-navy max-w-3xl mx-auto">
            There's a better way. <span className="font-bold">FactoryJet</span> delivers world-class websites for Bangalore businesses—in <span className="font-bold text-jet-blue">4 weeks</span>, at prices that make sense.
          </p>
        </motion.div>
      </div>
    </section>
