  ...
  const differentiators = [
    {
      ...
      description: 'Meet us in Pune. WhatsApp anytime. Real humans, not bots.',
    ...
    },
    {
      ...
      description: 'Most Mumbai agencies take 3-6 months. We deliver in 4 weeks flat.',
      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold text-jet-navy font-heading mb-4">
            Why 200+ Pune Businesses Choose FactoryJet
          </h2>
