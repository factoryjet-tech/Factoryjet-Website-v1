...
const Services: React.FC = () => {
  const services = [
    {
      ...
      description: 'Custom, mobile-responsive websites built for Pune businesses. From corporate sites to landing pages, we deliver in 4 weeks flat.',
      features: [
    ...
    },
    {
      ...
      description: 'Full-featured online stores with UPI, Razorpay, and all Indian payment gateways. Start selling to Pune and all of India.',
      features: [
  ...
  const miniFeatures = [
    ...
    {
      icon: Users,
      title: 'Pune-Based Team',
      description: 'Local support. Meet us in Pune. WhatsApp anytime.',
    },
  ];
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        ...
        >
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-jet-navy font-heading mb-4">
            Everything Pune SMBs Need to Grow Online
          </h2>
