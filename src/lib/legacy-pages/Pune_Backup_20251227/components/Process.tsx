  ...
  const steps = [
    {
      ...
      duration: '15 min',
      description: "We understand your Pune business, goals, and competition. Get a clear roadmap—no jargon, no pressure.",
    ...
    },
    {
      ...
      duration: 'Week 3-4',
      description: "Go live with full training. We don't disappear—ongoing support from our Pune team whenever you need.",
