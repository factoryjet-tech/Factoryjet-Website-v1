        ...
        <div className="grid md:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-4 text-slate-400">
              ...
              <li><Link href="/us/services/ai-chatbot" onClick={() => trackNavigation('AI Chatbot', '/us/services/ai-chatbot', 'footer')} className="hover:text-[#FF6B35] transition-colors">AI Chatbot</Link></li>
              <li><Link href="/us/services/ai-sales-agent" onClick={() => trackNavigation('AI Sales Agent', '/us/services/ai-sales-agent', 'footer')} className="hover:text-[#FF6B35] transition-colors">AI Sales Agent</Link></li>
              <li><Link href="/us/services/ai-customer-support" onClick={() => trackNavigation('AI Customer Support', '/us/services/ai-customer-support', 'footer')} className="hover:text-[#FF6B35] transition-colors">AI Customer Support</Link></li>
              <li><Link href="/us/services/ai-voice-agent" onClick={() => trackNavigation('AI Voice Agent', '/us/services/ai-voice-agent', 'footer')} className="hover:text-[#FF6B35] transition-colors">AI Voice Agent</Link></li>
