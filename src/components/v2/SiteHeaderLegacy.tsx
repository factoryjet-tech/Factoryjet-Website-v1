...
/**
 * SiteHeaderLegacy (2026-09-25): the pre-mega-menu header, kept byte-for-byte
 * from SiteHeader.tsx for the two locales that still use its menus: India ('in')
 * and UAE ('uae'). SiteHeader loads this file with next/dynamic ONLY for those
 * locales, so US, UK and AU visitors no longer download ~1,500 lines of menus
 * they never see. Retire it when India and UAE move to the mega menu.
 */
...
const LOCALE_CONFIG = {
  ...
  in: {
    ...
    pricingHref:     '/pricing',
    aboutHref:       '/about',
    featuredHeadline:'7-Day Delivery',
...
export default function SiteHeaderLegacy({
  locale = 'us',
  logoText = 'FactoryJet',
  logoHref = '/',
  cta,
