  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto max-w-[1200px] px-4 sm:px-6 lg:px-8">
        ...
        {/* ── 45-SECOND ENTERPRISE ARCHITECTURE WALKTHROUGH VIDEO EMBED WITH VIDEOOBJECT SCHEMA ── */}
        <div className="mt-12 rounded-3xl bg-[#141414] border border-[#2E2E33] p-6 sm:p-8 text-white relative overflow-hidden shadow-2xl">
          <script
            ...
            dangerouslySetInnerHTML={{
              __html: JSON.stringify({
                ...
                '@type': 'VideoObject',
                name: `${legacySource} to ${targetStack} Enterprise Architecture Walkthrough`,
                description: `A 45-second technical architecture walkthrough demonstrating zero-downtime cutover pipelines, ERP delta synchronization (NetSuite, SAP), and sub-second checkout performance on Shopify Plus.`,
                thumbnailUrl: ['https://factoryjet.com/og-default.png'],
                uploadDate: '2026-08-24T08:00:00Z',
                duration: 'PT45S',
                contentUrl: 'https://factoryjet.com/videos/enterprise-architecture-walkthrough.mp4',
                embedUrl: 'https://factoryjet.com/embed/enterprise-architecture-walkthrough',
                publisher: {
                  '@type': 'Organization',
                  name: 'FactoryJet',
          ...
          <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6 pb-6 border-b border-[#2E2E33]">
            <div>
              ...
              <h3 className="text-xl sm:text-2xl font-bold tracking-tight text-white">
                Inside Our Zero-Downtime Enterprise Cutover Pipeline
              </h3>
              <p className="text-xs sm:text-sm text-gray-400 mt-1 max-w-xl">
                Watch how real-time order queuing, ERP inventory delta sync, and 301 SEO preservation execute with zero lost sales.
              </p>
            </div>
          ...
          <div className="mt-6 rounded-2xl bg-[#0A0A0C] border border-[#232328] p-5 sm:p-6 relative overflow-hidden">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-center">
              <div className="md:col-span-2 space-y-3">
                <div className="flex items-center gap-3 text-xs font-mono text-emerald-400">
                  ...
                  <span>EVENT STREAM: Real-Time Order &amp; ERP Delta [112ms]</span>
                </div>
                <div className="font-mono text-xs text-gray-300 bg-[#121216] p-3.5 rounded-xl border border-gray-800 overflow-x-auto leading-relaxed">
                  <span className="text-purple-400">EVENT</span> orders/create <span className="text-emerald-400">200 SYNCED</span> (112ms)<br />
                  <span className="text-gray-500">├──</span> Destination: <span className="text-yellow-300">NetSuite ERP General Ledger</span><br />
                  <span className="text-gray-500">├──</span> Performance: <span className="text-emerald-400">Checkout LCP 0.78s · 0 lost orders</span><br />
                  <span className="text-gray-500">└──</span> SEO Safeguard: <span className="text-blue-400">100% 301 Exact-Match Path Redirects</span>
                </div>
              </div>
            ...
            <div className="mt-5 pt-4 border-t border-gray-800/80 flex items-center gap-4">
              ...
              <span className="text-xs font-mono text-emerald-400">✓ 99.99% Uptime Verified</span>
            </div>
          </div>
        </div>
