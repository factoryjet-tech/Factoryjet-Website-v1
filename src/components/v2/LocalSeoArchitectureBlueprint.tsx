...
export default function LocalSeoArchitectureBlueprint({
  ...
  // Perf (2026-09-26): the auto-advance timers below re-render this whole
  // component every 50 ms. They used to start at hydration and run for the
  // life of the page even while the section was far off screen (about 25 DOM
  // mutations a second on /uk/liverpool and every US city SEO page). They now
  // run only while the section is on screen and the tab is visible, the same
  // fix WebDesignArchitectureBlueprint got. What a reader sees is unchanged.
