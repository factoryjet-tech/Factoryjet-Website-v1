#!/usr/bin/env python3
"""PHASE B — do we rank / get cited, on the terms that ACTUALLY have India volume?
...
BRAND, LOC = "factoryjet", 2356
RUNS = 3  # repeats per LLM, to turn a coin-flip into a rate

TARGETS = [
    ("top web development company in india",                 1000, "web_design"),
    ("best web design company in india",                      590, "web_design"),
    ("best web development company in india",                 480, "web_design"),
    ("best web design company delhi",                         590, "web_design"),
    ("top web development company bangalore",                 480, "web_design"),
    ("best ecommerce website development company in india",   110, "ecommerce"),
    ("top shopify development company in india",              110, "ecommerce"),
    ("best ecommerce seo agency",                             110, "ecommerce"),
    ("ai seo agency",                                         720, "ai_seo"),
    ("top ai agency",                                         210, "ai_agents"),
    ("best ai seo tool",                                      140, "ai_seo"),
    ("top seo agency in india",                              3600, "seo"),
    ("best seo agency",                                      1600, "seo"),
    ("best seo company in noida",                            1600, "seo"),
    ("best seo company mumbai",                              1000, "seo"),
    ("best digital marketing agency in india",               5400, "digital_mkt"),
    ("top digital marketing agency in india",                1900, "digital_mkt"),
    ("what is generative engine optimization",                 320, "question"),
    ("will ai replace seo",                                     30, "question"),
]
...
if __name__ == "__main__":
    ...
    jobs = [(kw, llm, m, i) for kw, _, _ in TARGETS for llm, m in LLMS for i in range(RUNS)]
    ...
    json.dump({"serp": serp, "llm": llm_res, "runs": RUNS,
              ...
              open(os.path.join(HERE, "data", "rank_matrix.json"), "w"), indent=1)
    print(f"\ncost=${cost:.3f}  json=data/rank_matrix.json")
